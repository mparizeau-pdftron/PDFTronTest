...
app.get("/annotations", (req, res) => {
  handleAnnotation(req, res, (dir) => {
    const xfdfFile = req.query.did
      ? path.resolve(dir, `${req.query.did}.xfdf`)
      : path.resolve(dir, "default.xfdf");
...
app.post("/annotations", (req, res) => {
  handleAnnotation(req, res, (dir) => {
    const xfdfFile = req.body.did
      ? path.resolve(dir, `${req.body.did}.xfdf`)
      : path.resolve(dir, "default.xfdf");
    try {
