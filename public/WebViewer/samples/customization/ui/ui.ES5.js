!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Wt = function(t, n) {
          return Dt(t, (n = b(n, !0))) ? h(2, t[n]) : V(t, n);
        },
        Ut = function(t, n, r) {
          return !(Dt(t, (n = b(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((U.f = Wt), (W.f = Ut)),
      ...
      v(Gt, Ct),
        p(Gt, yt, Ct.values),
        v(Gt, { slice: Rt, set: Bt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        At(Gt, 'buffer', 'b'),
        At(Gt, 'byteOffset', 'o'),
        At(Gt, 'byteLength', 'l'),
        At(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? It(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (I && (S = s(I.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (S = function(t) {
        ...
        o && (G(S, 'byteLength', '_l'), G(x, 'buffer', '_b'), G(x, 'byteLength', '_l'), G(x, 'byteOffset', '_o')),
        f(x[m], {
          getInt8: function(t) {
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, B) && t[B][n] && (t[B][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, B) || N(t, B, E(1, {})), (t[B][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(U, t) && !i(G, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, B) && this[B][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(U, n) || i(G, n))) {
          var r = j(t, n);
          return !r || !i(U, n) || (i(t, B) && t[B][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == B || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, B) && i(this[B], t) && (this[B][t] = !1), q(this, t, E(1, r));
            };
      ...
      var n = t.UI,
        ...
        a = function() {
          r(function(t) {
            var n = t.getItems(),
              r = n.splice(2, 18);
            r.reverse(), t.update([].concat(n.slice(0, 2), r, n.slice(2)));
          });
        },
        s = function(t, n) {
          t.target.checked ? e([n]) : o([n]);
        };
      NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach),
        HTMLCollection && !HTMLCollection.prototype.forEach && (HTMLCollection.prototype.forEach = Array.prototype.forEach),
        document.getElementsByName('header').forEach(function(t) {
          t.onchange = function() {
            a();
          };
        }),
        (document.getElementById('ribbons').onchange = function(t) {
          t.target.checked ? i([f.Ribbons]) : u([f.Ribbons]);
        }),
        (document.getElementById('text-selection').onchange = function(t) {
          t.target.checked ? i([f.TextSelection]) : u([f.TextSelection]);
        }),
        (document.getElementById('annotations').onchange = function(t) {
          t.target.checked ? i([f.Annotations]) : u([f.Annotations]);
        }),
        (document.getElementById('notes-panel').onchange = function(t) {
          t.target.checked ? i([f.NotesPanel]) : u([f.NotesPanel]);
        }),
        (document.getElementById('file-picker').onchange = function(t) {
          t.target.checked ? i([f.FilePicker]) : u([f.FilePicker]);
        }),
        (document.getElementById('print').onchange = function(t) {
          t.target.checked ? i([f.Print]) : u([f.Print]);
        }),
        (document.getElementById('download').onchange = function(t) {
          t.target.checked ? i([f.Download]) : u([f.Download]);
        }),
        (document.getElementById('view-controls').onchange = function(t) {
          s(t, 'viewControlsButton');
        }),
        (document.getElementById('search').onchange = function(t) {
          s(t, 'searchButton');
        }),
        (document.getElementById('pan-tool').onchange = function(t) {
          s(t, 'panToolButton');
        }),
        (document.getElementById('page-nav').onchange = function(t) {
          s(t, 'pageNavOverlay');
        }),
        (document.getElementById('default').onchange = function(t) {
          t.target.checked && a();
        }),
        (document.getElementById('reverse').onchange = function(t) {
          t.target.checked && a();
        }),
        document.getElementsByName('theme').forEach(function(t) {
          t.onchange = function(t) {
            'light' === t.target.id && t.target.checked ? c('light') : c('dark');
          };
        });
    });
  },
