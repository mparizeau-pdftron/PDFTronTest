!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Bt = function(t, n) {
          return Dt(t, (n = b(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Ut = function(t, n, r) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : x('values'), keys: g ? F : x('keys'), entries: M }), d)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    d(S, 'ArrayBuffer'), d(x, 'DataView'), c(x[m], u.VIEW, !0), (n.ArrayBuffer = S), (n.DataView = x);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === G && i(U, t) && !i(V, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(m, p ? h : h.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, g);
              else {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', webviewerServerURL: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/form1.pdf' }, document.getElementById('viewer')).then(
      function(t) {
        samplesSetup(t);
        var n = t.Core,
          r = n.documentViewer,
          e = n.annotationManager,
          o = n.Annotations;
        r.addEventListener('documentLoaded', function() {
          var t = r.getPageCount(),
            n = o.WidgetAnnotation.getCustomStyles,
            i = o.WidgetAnnotation.getContainerCustomStyles,
            u = function(t) {
              return t instanceof o.TextWidgetAnnotation
                ? 'f1-1' === t.fieldName
                  ? { 'background-color': 'lightgreen' }
                  : { 'background-color': 'lightblue', color: 'brown' }
                : t instanceof o.PushButtonWidgetAnnotation
                ? { 'background-color': 'red', color: 'white' }
                : void 0;
            },
            c = function(t) {
              if (t instanceof o.WidgetAnnotation) return { border: '2px solid green' };
            };
          document.getElementById('form').onchange = function(r) {
            'custom' === r.target.id
              ? ((o.WidgetAnnotation.getCustomStyles = u), (o.WidgetAnnotation.getContainerCustomStyles = c))
              : ((o.WidgetAnnotation.getCustomStyles = n), (o.WidgetAnnotation.getContainerCustomStyles = i));
            for (var f = 0; f < t; f++) e.drawAnnotations(f + 1, null, !0);
          };
        });
      }
    );
