!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
  ...
  function(t, n) {
    ...
    var r = document.getElementById('flipbook'),
      e = document.getElementById('loading-message');
    e.innerHTML = 'Preparing document...';
    var o = { l: window.sampleL };
    Core.createDocument('https://pdftron.s3.amazonaws.com/downloads/pl/Cheetahs.pdf', o).then(function(t) {
      var n = t.getPageInfo(1),
        ...
        s = a.height,
        l = a.width;
      ((s * o) / i) * 2 < l ? (l = ((s * o) / i) * 2) : (s = ((l / o) * i) / 2);
      for (
        var h = function(n) {
            c.push(
              new Promise(function(r) {
                var o = n + 1;
                return t.requirePage(o).then(function() {
                  return t.loadCanvasAsync({
                    pageNumber: o,
                    drawComplete: function(t, n) {
                      f.push({ index: n, canvas: t }), (e.innerHTML = 'Loading page canvas... ('.concat(f.length, '/').concat(u, ')')), r();
                    },
                    isInternalRender: !0,
                  });
                });
      ...
      Promise.all(c).then(function() {
        r.removeChild(e),
          (r.style.margin = '60px 0px 0px auto'),
          f
            .sort(function(t, n) {
              return t.index - n.index;
            })
            .forEach(function(t) {
              return r.appendChild(t.canvas);
            }),
          $('#flipbook').turn({ width: l, height: s }),
          setTimeout(function() {
            $('#flipbook').turn('next');
          }, 500),
