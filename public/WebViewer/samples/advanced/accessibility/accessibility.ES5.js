!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? It(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
  ...
  function(t, n) {
    ...
    var u = function() {
      ...
      c = function() {
        for (var t = 0; t < speechSynthesis.getVoices().length; t++) {
          var n = speechSynthesis.getVoices()[t],
            r = document.createElement('option');
          (r.textContent = ''.concat(n.voiceURI, '-').concat(n.lang)), (r.value = t), document.getElementById('voice').appendChild(r);
        }
      };
    if (
      (WebViewer({ path: '../../../lib', initialDoc: '../../../samples/files/cheetahs.pdf', accessibleMode: !0 }, document.getElementById('viewer')).then(function(t) {
        samplesSetup(t);
        var n,
          f = t.Core.documentViewer,
          a = t.UI.iframeWindow.document,
          s = function() {
            speechSynthesis.cancel(),
              ...
              (n = setInterval(function() {
                var t,
                  u,
                  c,
                  s = ((t = f.getCurrentPage()), (u = a.getElementById('pageText'.concat(t))) ? u.innerText : null);
                s &&
                  ((c = new SpeechSynthesisUtterance(s)),
                  r && (c.voice = speechSynthesis.getVoices()[r]),
                  (c.pitch = e),
                  (c.rate = o),
                  (c.volume = i),
                  speechSynthesis.speaking ? speechSynthesis.resume() : speechSynthesis.speak(c),
                  clearInterval(n));
              }, 200));
          };
        f.addEventListener('documentLoaded', function() {
          var t = document.getElementById('play'),
            n = document.getElementById('pause');
          a.addEventListener('keydown', function(t) {
            ('Tab' !== t.key && 9 !== t.keycode) || speechSynthesis.cancel(), ('p' !== t.key && 80 !== t.keycode) || s();
          }),
            window.speechSynthesis.getVoices().length ? c() : (window.speechSynthesis.onvoiceschanged = c),
            (t.onclick = s),
            (n.onclick = u);
        });
      }),
      ...
      for (var f = document.getElementsByTagName('aside')[0]; f.firstChild; ) f.removeChild(f.firstChild);
      var a = document.createTextNode('This demo is not compatible with IE11. Please open the demo in a different browser or '),
        s = document.createElement('a'),
        l = document.createTextNode('go back to samples');
      s.setAttribute('href', '../'), s.setAttribute('target', '_self'), f.appendChild(a), s.appendChild(l), f.appendChild(s);
    }
    var h = document.getElementById('voice'),
      p = document.getElementById('pitch'),
      v = document.getElementById('rate'),
      y = document.getElementById('volume');
    (h.onchange = function(t) {
      speechSynthesis.cancel(), (r = t.target.value);
    }),
      (p.onchange = function(t) {
        speechSynthesis.cancel(), (e = t.target.value / 50);
      }),
      (v.onchange = function(t) {
        speechSynthesis.cancel(), (o = t.target.value / 10);
      }),
      (y.onchange = function(t) {
        speechSynthesis.cancel(), (i = t.target.value / 100);
      });
  },
]);
