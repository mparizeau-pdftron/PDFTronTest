!(function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      nt = function(t) {
        for (var n, r = t === V, e = T(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
  ...
  function(t, n) {
    window.normalizePointToZeroRotationSpace = function(t, n, r, e) {
      var o,
        i = t;
      return (
        1 === n && (i = { x: r - (o = t).y, y: o.x }),
        2 === n &&
          (i = (function(t, n, r) {
            return { x: n - t.x, y: r - t.y };
          })(t, r, e)),
        3 === n &&
          (i = (function(t, n, r) {
