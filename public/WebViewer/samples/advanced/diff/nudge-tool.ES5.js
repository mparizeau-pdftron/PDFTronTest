!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ft = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = It(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Mt = function() {
        ...
        Lt = function() {
          return vt.apply(jt ? ht.call(At(this)) : At(this), arguments);
        },
        Rt = {
          ...
          filter: function(t) {
            return Nt(this, J(At(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          subarray: function(t, n) {
            var r = At(this),
              e = r.length,
              o = m(t, e);
            return new (j(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Ct = function(t, n) {
          return Nt(this, ht.call(At(this), t, n));
        },
        kt = function(t) {
          At(this);
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: Ct, set: kt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        Tt(Bt, 'buffer', 'b'),
        Tt(Bt, 'byteOffset', 'o'),
        Tt(Bt, 'byteLength', 'l'),
        Tt(Bt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Pt(v, r) : Ft.call(v, r);
                  (i = r), (h = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              Z(m !== Function.prototype ? I(y).concat(I(m)) : I(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        I = A || x(y),
        N = y ? (_ ? x('entries') : I) : void 0,
        P = ('Array' == n && E.entries) || A;
      if (
        (P && (S = s(P.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          A &&
          'values' !== A.name &&
          ((O = !0),
        ...
        if (((m = { values: _ ? I : x('values'), keys: d ? I : x('keys'), entries: N }), g)) for (b in m) b in E || i(E, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function L(t, n, r) {
      ...
      for (
        (t = A(t)) != t || t === O
          ...
          : ((e = N(P(t) / T)),
            t * (i = I(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + a >= 1 ? s / i : s * I(2, 1 - a)) * i >= 2 && (e++, (i /= 2)),
            e + a >= f ? ((o = 0), (e = f)) : e + a >= 1 ? ((o = (t * i - 1) * I(2, n)), (e += a)) : ((o = t * I(2, a - 1) * I(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[M]) throw _(b);
      for (var c = t[F]._b, f = u + t[j], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
      ...
      (S = function(t) {
        ...
        o && (B(S, 'byteLength', '_l'), B(x, 'buffer', '_b'), B(x, 'byteLength', '_l'), B(x, 'byteOffset', '_o')),
        f(x[m], {
          getInt8: function(t) {
    ...
    var e,
      ...
      F = !!(function() {
        try {
          ...
          return (N || 'function' == typeof PromiseRejectionEvent) && t.then(P) instanceof n && 0 !== A.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      M = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && C(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = M(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
      ...
      L = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                N ? O.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = N || R(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      C = function(t) {
        g.call(f, function() {
          var n;
          N ? O.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      k = function(t) {
        var n = this;
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, k) || M(t, k, O(1, {})), (t[k][n] = !0)), q(t, n, r)) : M(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
        for (var r, e = g((n = w(n))), o = 0, i = e.length; i > o; ) Z(t, (r = e[o++]), n[r]);
        return t;
      },
      X = function(t) {
        var n = W.call(this, (t = _(t, !0)));
        return !(this === G && i(V, t) && !i(B, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, k) && this[k][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(V, n) || i(B, n))) {
          var r = F(t, n);
          return !r || !i(V, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = j(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == k || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
    ...
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, k) && i(this[k], t) && (this[k][t] = !1), q(this, t, O(1, r));
            };
          return u && H && q(G, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = X),
      (N.f = nt),
      u && !r(30) && f(G, 'propertyIsEnumerable', X, !0),
      (y.f = function(t) {
        return $(v(t));
      })),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var O = String(b[0]), E = a(s(u(b.index), h.length), 0), A = [], I = 1; I < b.length; I++) A.push(void 0 === (S = b[I]) ? S : String(S));
            var N = b.groups;
            if (p) {
              var P = [O].concat(A, E, h);
              void 0 !== N && P.push(N);
              var T = String(n.apply(void 0, P));
            } else T = y(O, h, E, A, N, n);
            E >= w && ((x += h.slice(w, E) + T), (w = E + O.length));
          }
          return x + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                O = f(m, p ? h : h.slice(x));
              if (null === O || (_ = l(c(m.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
    ...
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          (m.constructor = g),
          (m[f] = g.displayName = 'GeneratorFunction'),
          ...
          (N.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: P(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
  ...
  function(t, n) {
    !(function(t) {
      ...
      t.NudgeTool = {
        initializeNudgeTool: function(t) {
          r = t;
          var u = document.createElement('div');
          u.setAttribute('id', 'nudge-diff-tool'),
            (u.innerHTML =
            ...
            (function(t) {
              ...
              Object.keys(r).forEach(function(e) {
                ...
                (i.draggable = !1), i.setAttribute('src', ''.concat(n, '/assets/').concat(r[e])), o && o.appendChild(i);
              });
            })(u),
            (function(t) {
              var e = this,
                u = {
                  rotateCounterClockwise: o.ROTATION_DEC,
                  rotateClockwise: o.ROTATION_INC,
                  translateUp: o.VERTICAL_TRANSLATION_DEC,
                  translateLeft: o.HORIZONTAL_TRANSLATION_DEC,
                  translateRight: o.HORIZONTAL_TRANSLATION_INC,
                  translateDown: o.VERTICAL_TRANSLATION_INC,
                  scaleOut: o.SCALE_OUT,
                  scaleIn: o.SCALE_IN,
                };
              function c(t) {
                var e = u[t];
              ...
              Object.keys(u).forEach(function(n) {
                var r = t.getElementsByClassName(n)[0];
                (r.onmousedown = c.bind(e, n)),
                  (r.onmouseup = f),
