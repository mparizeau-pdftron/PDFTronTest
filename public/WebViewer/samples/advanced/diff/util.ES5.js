!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : S('values'), keys: g ? F : S('keys'), entries: M }), d)) for (m in b) m in O || i(O, m, b[m]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
  ...
  function(t, n) {
    !(function(t) {
      t.Util = {
        createCanvas: function(t, n, r) {
          var e = document.createElement('canvas'),
            o = e.getContext('2d');
          return (e.width = t), (e.height = n), (e.style.width = ''.concat(t / r, 'px')), (e.style.height = ''.concat(n / r, 'px')), (e.style.backgroundColor = 'white'), (o.fillStyle = 'white'), e;
        },
        base64ToBlob: function(n) {
          for (var r = t.atob(n), e = r.length, o = new Uint8Array(e), i = 0; i < e; ++i) o[i] = r.charCodeAt(i);
          return new Blob([o], { type: 'application/pdf' });
        },
        convertToWebViewerRotationEnum: function(t) {
          switch (t) {
            case 90:
              return 1;
            case 180:
        ...
        decomposeMatrix: function(n) {
          var r = n.toTransform(),
            e = new t.paper.Matrix(r[0], r[1], r[2], r[3], r[4], r[5]).decompose();
          return { translateX: e.translation.x, translateY: e.translation.y, scaleX: e.scaling.x, scaleY: e.scaling.y, rotation: (e.rotation * Math.PI) / 180 };
        },
      };
    })(window);
  },
