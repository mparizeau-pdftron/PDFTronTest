!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && c > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(a.length), o = Ot(this, r); r > n; n++) o[n] = l ? f(a[n], n) : a[n];
          return o;
        },
        Nt = function() {
        ...
        Ct = {
          ...
          subarray: function(t, n) {
            var r = Mt(this),
              e = r.length,
              o = m(t, e);
            return new (R(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, y((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Dt = function(t, n) {
      ...
      v(Xt, kt),
        p(Xt, gt, kt.values),
        v(Xt, { slice: Dt, set: Lt, constructor: function() {}, toString: pt, toLocaleString: jt }),
        At(Xt, 'buffer', 'b'),
        At(Xt, 'byteOffset', 'o'),
        At(Xt, 'byteLength', 'l'),
        At(Xt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                if (S(r)) {
                  ...
                  } else if ((u = y(o) * n) + h > g) throw G('Wrong length!');
                  a = u / n;
                } else (a = d(r)), (i = new Z((u = a * n)));
                for (p(t, '_d', { b: i, o: h, l: u, e: a, v: new q(i) }); s < a; ) P(t, s++);
              })),
              (_ = v.prototype = E(Xt)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, g, y, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : w('values'), keys: y ? O : w('keys'), entries: T }), d)) for (b in m) b in E || i(E, b, m[b]);
  ...
  function(t, n, r) {
      ...
      for (
        (t = M(t)) != t || t === P
          ...
          : ((e = T(F(t) / A)),
            ...
            e + f >= c ? ((o = 0), (e = c)) : e + f >= 1 ? ((o = (t * i - 1) * O(2, n)), (e += f)) : ((o = t * O(2, f - 1) * O(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var a = t[I]._b, c = u + t[R], f = e(+o), s = 0; s < n; s++) a[c + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (x = function(t) {
        ...
        (w = function(t, n, r) {
          ...
          (this[I] = t), (this[R] = o), (this[N] = r);
        }),
        o && (X(x, 'byteLength', '_l'), X(w, 'buffer', '_b'), X(w, 'byteLength', '_l'), X(w, 'byteOffset', '_o')),
        c(w[m], {
          getInt8: function(t) {
          ...
          getInt32: function(t) {
            return D(V(this, 4, t, arguments[1]));
          },
          getUint32: function(t) {
            return D(V(this, 4, t, arguments[1])) >>> 0;
          },
    ...
    d(x, 'ArrayBuffer'), d(w, 'DataView'), a(w[m], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = w);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t) {
        ...
        return !(this === V && i(B, t) && !i(X, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, L) && this[L][t])) || n);
      },
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== V || !i(B, n) || i(X, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === V, e = R(r ? X : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(V, n)) || o.push(B[n]);
        return o;
      };
    G ||
      (c(
        (j = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(X, r), i(this, L) && i(this[L], t) && (this[L][t] = !1), H(this, t, P(1, r));
            };
          ...
          ''.split(/.?/).length
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = f.call(v, o)) &&
                  !((u = v.lastIndex) > l && (c.push(o.slice(l, i.index)), i.length > 1 && i.index < o.length && h.apply(c, i.slice(1)), (a = i[0].length), (l = u), c.length >= p));
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                P = c(m, p ? h : h.slice(w));
              if (null === P || (_ = l(a(m.lastIndex + (p ? 0 : w)), h.length)) === x) w = u(h, w, y);
              else {
    ...
    (function(t) {
      ...
      var r = (function(t) {
            ...
            (i._invoke = (function(t, n, r) {
              ...
              return function(o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var c = s(t, n, r);
                  if ('normal' === c.type) {
                    if (((e = r.done ? v : h), c.arg === g)) continue;
        ...
        function E(t, n) {
          ...
          return i
            ? i.done
              ? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = r)), (n.delegate = null), g)
              : i
        ...
        return (
          ...
          (T.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), g;
            },
          }),
          t
        );
        ...
        f = {
            ...
            return (
              ...
              Promise.all(
                ...
                (function() {
                  var n = c(
                    regeneratorRuntime.mark(function n(r) {
                      var i, a, c, l, h, v, y, w, P, E, M, O;
                      return regeneratorRuntime.wrap(function(n) {
                        for (;;)
                          switch ((n.prev = n.next)) {
                            case 0:
                              (i = t.Core.getCanvasMultiplier()),
                                (a = p(r, i)),
                                (c = e.getDocumentsToCompare()),
                                ...
                                (v = s(c, l, h)),
                                (y = new Core.Math.TransformationBuilder().scale(m * i).getFinalTransform()),
                                (w = _.map(function(t) {
                                  return t.renderRect;
                                })),
                                (P = d(a, v, S, w, h, y)),
                      ...
                      switch ((n.prev = n.next)) {
                        case 0:
                          if (
                            ...
                            (u = this.filesToCompare[t.BASE_DOCUMENT_INDEX].document),
                            (f = this.filesToCompare[t.DOCUMENT_TO_TRANSFORM_INDEX].document),
                          ...
                          for (a = Math.max(u.getPageCount(), f.getPageCount()), s = 1; s <= a; s++)
                            (h = u.getPageInfo(s)),
                              (p = f.getPageInfo(s)),
                              (v = void 0),
                              (g = void 0),
                              this.alignmentPageStates.setTransformationStateForPageNumber(s, t.DEFAULT_TRANSFORM_STATE),
                              this.nudgePageStates.setTransformationStateForPageNumber(s, t.DEFAULT_NUDGE_STATE),
                              h && p
                                ? ((y = Math.max(h.width, p.width)), (d = Math.max(h.height, p.height)), (g = u.getPages()[s - 1]), ((v = l(s, g)).width = y), (v.height = d))
                                : h
                                ? ((g = u.getPages()[s - 1]), (v = l(s, g)))
                                : ((g = f.getPages()[s - 1]), (v = l(s, g))),
                              this.addPage(v);
                                      ...
                                      return regeneratorRuntime.wrap(function(t) {
                                        for (;;)
                                          switch ((t.prev = t.next)) {
                                            ...
                                            case 5:
                                              return e.setOptions({ enableAnnotations: !0 }), (o = e.getAnnotationManager()), (t.next = 9), n.extractXFDF();
                                            case 9:
          ...
          updatePageSizeFromTransformationState: function(n, r, e) {
            var o = this.getDocumentsToCompare(),
              ...
              a = s(o, i, [t.Core.Math.Matrix.Identity, u]),
              c = Math.ceil(a.width),
              f = Math.ceil(a.height),
              l = window.Core.getPageMatrix(1, e, { width: c, height: f }, 0, !0, t.Core.getCanvasMultiplier()),
              h = new t.Core.PageInfo();
            h.setFromPageData({ width: c, height: f, rotation: e, id: this.getPage(r).id, matrix: l, pageNum: r }),
              (h.contentChanged = !0),
              this.setPage(h, r),
              (this.maxViewportZoom = this.calculateMaxViewportZoom()),
              this.forwardEvent({ type: 'pagesUpdated', data: [h] });
          },
          constructRenderSettingsForDocuments: function(n, r, e, o, u) {
            var a = this.getSourcePageNumberForAlignedPage(n),
              c = u.map(function(n) {
                return t.Util.decomposeMatrix(n).scaleX;
              }),
              f = [
                { pageNumberToRender: n, pageRotation: e, zoom: r * c[t.BASE_DOCUMENT_INDEX], transformationMatrixToApply: u[t.BASE_DOCUMENT_INDEX], renderRect: null },
                { pageNumberToRender: a, pageRotation: e, zoom: r * c[t.DOCUMENT_TO_TRANSFORM_INDEX], transformationMatrixToApply: u[t.DOCUMENT_TO_TRANSFORM_INDEX], renderRect: null },
              ],
              l =
                (function(t, n, r, e) {
                  if (!t) return;
                  for (var o = s(n, r, e), i = [], u = y(t), a = 0; a < n.length; a++) {
                    var c = n[a],
                      f = r[a],
                      l = c.getPageInfo(f),
                      h = l.width,
                      ...
                      g = v(h, p, e[a]),
                      d = m(o, u, g, e[a]);
                    d && (d = { width: (b = d).width, height: b.height, x1: b.minX, y1: b.minY, x2: b.maxX, y2: b.maxY, rect: [b.minX, b.minY, b.maxX, b.maxY] }), i.push(d);
                  }
                  var b;
                  return i;
                })(
          ...
          promise: new Promise(function(s, l) {
            try {
              f = t.loadCanvasAsync({
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              ...
                              return (t.next = 3), a.drawAnnotations(n, r);
                            case 3:
                              s(r);
                            case 4:
                            case 'end':
                ...
                renderRect: u ? i({}, u, { rect: r(u.rect) }) : void 0,
              });
            } catch (t) {
              console.error(t), l('Error occured while loading '.concat(document.filename, ' for page ').concat(n));
            }
            var h;
          }),
          cancel: function() {
            t.cancelLoadCanvas(f);
          },
        };
      }
      function p(n, r) {
