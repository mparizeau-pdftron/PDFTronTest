!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), b = o(d), m = e(c, v, 3), x = u(b.length), S = 0, w = r ? p(n, x) : f ? p(n, 0) : void 0; x > S; S++)
          if ((h || S in b) && ((g = m((y = b[S]), S, d)), t))
            if (r) w[S] = g;
            else if (g)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = g(c.length), o = Mt(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Rt = function() {
        ...
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (N(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : b(n, e)) - o));
          },
        },
        kt = function(t, n) {
        ...
        Gt = function(t, n) {
          return Bt(t, (n = m(n, !0))) ? h(2, t[n]) : V(t, n);
        },
        Wt = function(t, n, r) {
          return !(Bt(t, (n = m(n, !0))) && w(r) && x(r, 'value')) || x(r, 'get') || x(r, 'set') || r.configurable || (x(r, 'writable') && !r.writable) || (x(r, 'enumerable') && !r.enumerable)
            ? U(t, n, r)
            : ((t[n] = r.value), t);
        };
      mt || ((W.f = Gt), (G.f = Wt)),
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        jt(Ut, 'buffer', 'b'),
        jt(Ut, 'byteOffset', 'o'),
        jt(Ut, 'byteLength', 'l'),
        jt(Ut, 'length', 'e'),
        ...
        (t.exports = function(t, n, r, e) {
          ...
          m
            ...
            : (u(function() {
              ...
              J(b !== Function.prototype ? M(y).concat(M(b)) : M(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (i(d)) {
        for (p = c(t.length); p > m; m++) if ((g = n ? b(u((v = t[m]))[0], v[1]) : b(t[m])) === a || g === s) return g;
      } else for (y = d.call(t); !(v = y.next()).done; ) if ((g = o(y, b, v.value, n)) === a || g === s) return g;
    }).BREAK = a),
      (n.RETURN = s);
  },
  function(t, n, r) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      } else (m = y.getConstructor(n, t, g, x)), u(m.prototype, r), (c.NEED = !0);
      return p(m, t), (w[t] = m), o(o.G + o.W + o.F * (m != b), w), d || y.setStrong(m, t, g), m;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: _ ? M : S('values'), keys: g ? M : S('keys'), entries: F }), d)) for (m in b) m in O || i(O, m, b[m]);
  ...
  function(t, n, r) {
    ...
    function T(t, n, r) {
      ...
      for (
        (t = P(t)) != t || t === E
          ...
          : ((e = F(A(t) / j)),
            t * (i = M(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + a >= 1 ? s / i : s * M(2, 1 - a)) * i >= 2 && (e++, (i /= 2)),
            e + a >= f ? ((o = 0), (e = f)) : e + a >= 1 ? ((o = (t * i - 1) * M(2, n)), (e += a)) : ((o = t * M(2, a - 1) * M(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[R]) throw _(m);
      for (var c = t[I]._b, f = u + t[N], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
    ...
    d(x, 'ArrayBuffer'), d(S, 'DataView'), c(S[b], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = S);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = R(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
    ...
    var o = r(1),
      ...
      $ =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(V, n);
              e && delete V[n], R(t, n, r), e && t !== V && R(V, n, e);
            }
          : R,
      K = function(t) {
        var n = (W[t] = O(T.prototype));
        return (n._k = t), n;
      },
      H =
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(W, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || R(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : R(t, n, r)
        );
      },
      X = function(t, n) {
        m(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(W, t) && !i(U, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(W, n) || i(U, n))) {
          var r = I(t, n);
          return !r || !i(W, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(V, n)) || o.push(W[n]);
        return o;
      };
    z ||
      (f(
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            b = s(h);
          if ((g && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == b || (p == Array && c(b)))) for (r = new p((n = f(h.length))); n > d; d++) a(r, d, g ? y(h[d], d) : h[d]);
          else for (l = b.call(h), r = new p(); !(o = l.next()).done; d++) a(r, d, g ? u(l, y, [o.value, d], !0) : o.value);
          return (r.length = d), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = a(s(u(m.index), h.length), 0), P = [], M = 1; M < m.length; M++) P.push(void 0 === (x = m[M]) ? x : String(x));
            var F = m.groups;
            if (p) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = f(b, p ? h : h.slice(S));
              if (null === E || (_ = l(c(b.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, g);
              else {
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, f, a, s, l, h, p) {
      for (var v, y, g = s, d = 0, b = !!h && u(h, p, 3); d < a; ) {
        if (d in f) {
          if (((v = b ? b(f[d], d, r) : f[d]), (y = !1), o(v) && (y = void 0 !== (y = v[c]) ? !!y : e(v)), y && l > 0)) g = t(n, r, v, i(v.length), g, l - 1) - 1;
          else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        m = u[d],
        x = m && m.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, d), (f[d] = h), b)) for (g in e) x[g] || i(x, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
            ...
            (i._invoke = (function(t, n, r) {
              ...
              return function(o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var f = s(t, n, r);
                  if ('normal' === f.type) {
                    if (((e = r.done ? v : h), f.arg === y)) continue;
        ...
        var x = Object.getPrototypeOf,
          S = x && x(x(A([])));
        S && S !== e && o.call(S, u) && (m = S);
        var w = (b.prototype = g.prototype = Object.create(m));
        function _(t) {
        ...
        return (
          (d.prototype = w.constructor = b),
          (b.constructor = d),
          (b[f] = d.displayName = 'GeneratorFunction'),
          (t.isGeneratorFunction = function(t) {
            var n = 'function' == typeof t && t.constructor;
            return !!n && (n === d || 'GeneratorFunction' === (n.displayName || n.name));
          }),
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, b) : ((t.__proto__ = b), f in t || (t[f] = 'GeneratorFunction')), (t.prototype = Object.create(w)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
  ...
  function(t, n) {
    ...
    !(function(t) {
      var n = { R: 0, G: 1, B: 2, A: 3 },
        r = Object.keys(n).length,
        o = 255;
      function i(t, n, r, e) {
        return null == e || 0 === e || (t === o && n === o && r === o);
      }
      function u(t, n) {
        return (t.y * n + t.x) * r;
      }
      ...
      function f(t, r, e) {
        var o = e.r,
          ...
          u = e.b,
          c = e.a;
        return (t[r + n.R] = o), (t[r + n.G] = i), (t[r + n.B] = u), (t[r + n.A] = c), t;
      }
      function a(t, r) {
        return [t[r + n.R], t[r + n.G], t[r + n.B], t[r + n.A]];
      }
      var s = {
        transformImageData: function(t, n, r, e) {
          var o = e.toTransform(),
            i = this.getImageDataByDocumentCanvas(r),
            u = document.createElement('canvas'),
            c = u.getContext('2d');
          (u.width = t), (u.height = n), c.setTransform(1, 0, 0, 1, 0, 0), c.clearRect(0, 0, u.width, u.height);
          var f = document.createElement('canvas'),
            a = f.getContext('2d');
          return (
            (f.width = i.width),
            (f.height = i.height),
            a.putImageData(i.imageData, 0, 0),
            c.setTransform(o[0], o[1], o[2], o[3], o[4], o[5]),
            c.drawImage(f, 0, 0),
            c.setTransform(1, 0, 0, 1, 0, 0),
            c.getImageData(0, 0, u.width, u.height)
          );
        },
        getImageDataByDocumentCanvas: function(t) {
          return { imageData: t.getContext('2d').getImageData(0, 0, t.width, t.height), width: t.width, height: t.height };
        },
        handleDifferentPixelColor: function(t, r, e, i, u) {
          if (e) {
            var f = c([t[n.R], t[n.G], t[n.B]]),
              a = c([r[n.R], r[n.G], r[n.B]]),
              s = c([f, a]),
              l = s * ((Math.abs(r[n.R] - t[n.R]) + Math.abs(r[n.G] - t[n.G]) + Math.abs(r[n.B] - t[n.B])) / (3 * o)),
              h = s + l;
            return { r: h, g: s - l, b: h, a: Math.max(Math.round(o * u), Math.round(o * i)) };
          }
          if (i > u) {
            var p = u;
            return { r: t[n.R] * p + r[n.R] * (1 - p), g: t[n.G] * p + r[n.G] * (1 - p), b: t[n.B] * p + r[n.B] * (1 - p), a: Math.round(255 * i) };
          }
          return { r: r[n.R], g: r[n.G], b: r[n.B], a: Math.round(255 * u) };
        },
        combinePixels: function(s, l, h, p, v, y) {
          var g,
            d,
            b,
            m,
            ...
            S = s ? s.data : void 0,
            w = l ? l.data : void 0,
            _ = t.Util.createCanvas(Math.max(l.width, s.width), Math.max(l.height, s.height), v),
            E = _.getContext('2d').createImageData(_.width, _.height);
          E.data.set(S);
          for (var O = 0; O < S.length; O += r) {
            var P = ((b = O), (m = s.width), (x = void 0), { x: (x = Math.floor(b / r)) % m, y: Math.floor(x / m) }),
              M = u(P, l.width),
              F = a(S, O),
              A = a(w, M),
              j = { r: F[n.R], g: F[n.G], b: F[n.B], a: F[n.A] };
            if (i(A[n.R], A[n.G], A[n.B], A[n.A]) && i(F[n.R], F[n.G], F[n.B], F[n.A])) j = e({}, j, { a: 0 });
            else if (
              y &&
              ((g = { r: A[n.R], g: A[n.G], b: A[n.B], a: A[n.A] }), (d = { r: F[n.R], g: F[n.G], b: F[n.B], a: F[n.A] }), g && d && g.r === d.r && g.g === d.g && g.b === d.b && g.a === d.a)
            ) {
              var I = c([F[n.R], F[n.G], F[n.B]]) / 2;
              j = e({}, j, { r: Math.ceil(o / 2) + I, g: Math.ceil(o / 2) + I, b: Math.ceil(o / 2) + I });
            } else if (P.y <= l.height && P.x <= l.width)
              if (i(A[n.R], A[n.G], A[n.B], A[n.A])) {
                var R = Math.round(o * p),
                  N = c([F[n.R], F[n.G], F[n.B]]);
                j = { r: y ? N : F[n.R], g: y ? N : F[n.G], b: y ? o : F[n.B], a: R };
              } else if (i(F[n.R], F[n.G], F[n.B], F[n.A])) {
                var T = Math.round(o * h),
                  L = c([A[n.R], A[n.G], A[n.B]]);
                j = { r: y ? o : A[n.R], g: y ? L : A[n.G], b: y ? L : A[n.B], a: T };
              } else j = this.handleDifferentPixelColor(A, F, y, p, h);
            f(E.data, O, j);
          }
          return _.getContext('2d').putImageData(E, 0, 0), _;
        },
      };
      t.CanvasHelper = s;
    })(window);
