!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? h(n, S) : a ? h(n, 0) : void 0; S > x; x++)
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = function() {
          return vt.apply(Lt ? pt.call(Pt(this)) : Pt(this), arguments);
        },
        jt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = m(t, e);
            return new (L(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : m(n, e)) - o));
          },
        },
        Dt = function(t, n) {
      ...
      bt || ((W.f = Vt), (V.f = Wt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Vt, defineProperty: Wt }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
      ...
      v(Ut, Ct),
        h(Ut, yt, Ct.values),
        v(Ut, { slice: Dt, set: kt, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        Mt(Ut, 'buffer', 'b'),
        Mt(Ut, 'byteOffset', 'o'),
        Mt(Ut, 'byteLength', 'l'),
        Mt(Ut, 'length', 'e'),
            ...
            _ = function(t, r) {
              U(t, r, {
                get: function() {
                  return (function(t, r) {
                    var e = t._d;
                    return e.v[s](r * n + e.o, Et);
                  })(this, r);
                },
                set: function(t) {
                  return (function(t, r, o) {
                    var i = t._d;
                    e && (o = (o = Math.round(o)) < 0 ? 0 : o > 255 ? 255 : 255 & o), i.v[p](r * n + i.o, o, Et);
                  })(this, r, t);
                },
                enumerable: !0,
              });
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return St in r ? Nt(v, r) : Tt.call(v, r);
                  (i = r), (p = At(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new K(i) }); s < c; ) _(t, s++);
              })),
              (E = v.prototype = A(Ut)),
              h(E, 'constructor', v))
            : (u(function() {
              ...
              o || (E.constructor = v));
          var I = E[yt],
            N = !!I && ('values' == I.name || null == I.name),
            M = Ct.values;
          h(v, gt, !0),
            h(E, St, f),
            h(E, xt, !0),
            h(E, mt, v),
            (e ? new v(1)[dt] == f : dt in E) ||
              U(E, dt, {
                get: function() {
                  return f;
                },
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        O = P || x(y),
        I = y ? (E ? x('entries') : O) : void 0,
        N = ('Array' == n && A.entries) || P;
      if (
        (N && (S = s(N.call(new t()))) !== Object.prototype && S.next && (f(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        E &&
          P &&
          'values' !== P.name &&
          ((_ = !0),
        ...
        if (((m = { values: E ? O : x('values'), keys: d ? O : x('keys'), entries: I }), g)) for (b in m) b in A || i(A, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function Y(t, n, r, e, o, i) {
      var u = h(+r);
      if (u + n > t[F]) throw E(b);
      for (var c = t[T]._b, a = u + t[L], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (S = function(t) {
        ...
        (x = function(t, n, r) {
          ...
          if (o + (r = void 0 === r ? e - o : p(r)) > e) throw E('Wrong length!');
          (this[T] = t), (this[L] = o), (this[F] = r);
        }),
        o && (U(S, 'byteLength', '_l'), U(x, 'buffer', '_b'), U(x, 'byteLength', '_l'), U(x, 'byteOffset', '_o')),
        a(x[m], {
          getInt8: function(t) {
    ...
    g(S, 'ArrayBuffer'), g(x, 'DataView'), c(x[m], u.VIEW, !0), (n.ArrayBuffer = S), (n.DataView = x);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      T = !!(function() {
        try {
          ...
          return (I || 'function' == typeof PromiseRejectionEvent) && t.then(N) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      F = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && D(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(E('Promise-chain cycle')) : (i = F(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
      ...
      R = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                I ? _.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = I || j(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      D = function(t) {
        g.call(a, function() {
          var n;
          I ? _.emit('rejectionHandled', t) : (n = a.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      k = function(t) {
        var n = this;
    ...
    T ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = f(C, t, 1)), (this.reject = f(k, t, 1));
      }),
      (b.f = M = function(t) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = E(n, !0)),
          b(r),
          i(W, n) ? (r.enumerable ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = A(r, { enumerable: _(0, !1) }))) : (i(t, k) || F(t, k, _(1, {})), (t[k][n] = !0)), H(t, n, r)) : F(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(W, t) && !i(U, t)) && (!(n || !i(this, t) || !i(W, t) || (i(this, k) && this[k][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = E(n, !0)), t !== G || !i(W, n) || i(U, n))) {
          var r = T(t, n);
          return !r || !i(W, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = L(w(t)), e = [], o = 0; r.length > o; ) i(W, (n = r[o++])) || n == k || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = L(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(W, (n = e[u++])) || (r && !i(G, n)) || o.push(W[n]);
        return o;
      };
    Y ||
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, k) && i(this[k], t) && (this[k][t] = !1), H(this, t, _(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, E = 0; E < m.length; E++) {
            b = m[E];
            for (var _ = String(b[0]), A = f(s(u(b.index), p.length), 0), P = [], O = 1; O < b.length; O++) P.push(void 0 === (S = b[O]) ? S : String(S));
            var I = b.groups;
            if (h) {
              var N = [_].concat(P, A, p);
              void 0 !== I && N.push(I);
              var M = String(n.apply(void 0, N));
            } else M = y(_, p, A, P, I, n);
            A >= w && ((x += p.slice(w, A) + M), (w = A + _.length));
          }
          return x + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              ...
              var E,
                _ = a(m, h ? p : p.slice(x));
              if (null === _ || (E = l(c(m.lastIndex + (h ? 0 : x)), p.length)) === S) x = u(p, x, d);
              else {
                if ((w.push(p.slice(S, x)), w.length === b)) return w;
                for (var A = 1; A <= _.length - 1; A++) if ((w.push(_[A]), w.length === b)) return w;
                x = S = E;
              }
            }
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, p), S[l] || c(S, l, g), (a[g] = p), m)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
        ...
        function A(t, n) {
          ...
          if (e === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = r), A(t, n), 'throw' === n.method)) return y;
        ...
        return (
          ...
          (I.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: N(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    !(function(t) {
      ...
      var n,
        ...
        l = [],
        p = {},
        h = { BASE_PANEL: 'basePanel', MIDDLE_PANEL: 'resultPanel', OVERLAY_PANEL: 'overlayPanel' },
        v = [{ panel: h.BASE_PANEL }, { panel: h.MIDDLE_PANEL }, { panel: h.OVERLAY_PANEL }],
        y = 1,
        d = 50;
      function g(t) {
        return p[t].instance.Core.documentViewer.getDocument();
      }
      function m(t) {
        return p[t].instance.Core.documentViewer;
      }
      function b() {
        var n = 1,
          r = 1;
        ...
        var o = g(h.MIDDLE_PANEL),
          i = m(h.BASE_PANEL).getCurrentPage(),
          u = m(h.OVERLAY_PANEL).getCurrentPage();
        o.setDocumentPageOpacity(a, i, n), o.setDocumentPageOpacity(f, u, r);
      }
      function S(n) {
        var r = g(h.MIDDLE_PANEL),
          e = m(h.MIDDLE_PANEL).getCurrentPage();
        switch (n) {
          case t.NudgeTool.TRANSFORMATION_TYPE.HORIZONTAL_TRANSLATION_INC:
            r.translate('right', y, e);
            break;
          case t.NudgeTool.TRANSFORMATION_TYPE.HORIZONTAL_TRANSLATION_DEC:
            r.translate('left', y, e);
            break;
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), m(n).loadDocument(r);
                  case 2:
                  case 'end':
                    return t.stop();
                }
      ...
      function _(t, n, r, e, o, i) {
        g(h.MIDDLE_PANEL).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function A(e) {
        return new Promise(function(u) {
          var c,
            a,
            f,
            v = document.getElementById(e.panel);
          WebViewer(
            {
              path: '../../../lib',
              css: './nudge-tool.css',
              workerTransportPromise:
                ((c = e.pdf),
                (a = 'object' === o(c) ? c.name : c || ''),
                (f = a.endsWith('docx') || a.endsWith('pptx') || a.endsWith('xlsx')),
                f && i
                  ? i
                  : !f && r
                  ? r
                  : Core.getDefaultBackendType().then(function(t) {
                      return c && f ? (i = Core.initOfficeWorkerTransports(t, {}, void 0)) : (r = Core.initPDFWorkerTransports(t, {}, void 0));
                    })),
            ...
            samplesSetup(r);
            var o = r.UI,
              i = r.Core.documentViewer,
              c = o.Feature,
              a = o.LayoutMode,
              f = o.FitMode;
            o.disableFeatures([c.Annotations]), o.setToolMode('AnnotationEdit');
            var y = v.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
            i.addEventListener('documentLoaded', function() {
              o.setLayoutMode(a.Single), o.setFitMode(f.FitWidth);
            }),
              (y.onscroll = function() {
                var r, e;
                t.DiffAlignmentTool.isInAlignmentMode() ||
                  ...
                  l.forEach(function(t) {
                    var n = p[t.panel].documentContainer;
                    n && (n.scrollLeft !== r && (n.scrollLeft = r), n.scrollTop !== e && (n.scrollTop = e));
                  }),
                  clearTimeout(n),
              ...
              i.addEventListener('zoomUpdated', function(r) {
                s ||
                  ((s = y),
                  clearTimeout(n),
                  (n = setTimeout(function() {
                  ...
                  t.DiffAlignmentTool.isInAlignmentMode() ||
                    (function(t) {
                      l.forEach(function(n) {
                        var r = p[n.panel].instance;
                        r.UI.getZoomLevel() !== t && r.UI.setZoomLevel(t);
                      });
                    })(r);
              }),
              i.addEventListener('rotationUpdated', function(t) {
                !(function(t) {
                  l.forEach(function(n) {
                    var r = m(n.panel);
              ...
              i.addEventListener('pageNumberUpdated', function(n) {
                t.DiffAlignmentTool.isInAlignmentMode()
                  ? e.panel !== h.OVERLAY_PANEL &&
                    l.forEach(function(t) {
                      m(t.panel).getCurrentPage() !== n && t.panel !== h.OVERLAY_PANEL && m(t.panel).setCurrentPage(n);
                    })
                  : E(n);
              }),
              l.push(e),
              (p[e.panel] = { instance: r, documentContainer: y }),
              u();
          });
        });
      }
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), Promise.all([x(h.BASE_PANEL, r), x(h.OVERLAY_PANEL, e)]);
                  case 2:
                    t.DiffAlignmentTool.initializeDiffAlignmentToolHandlers(
                      p[h.BASE_PANEL].instance,
                      p[h.OVERLAY_PANEL].instance,
                      _,
                      function() {},
                      function() {
                        E(m(h.MIDDLE_PANEL).getCurrentPage());
                      ...
                      (o = p[h.BASE_PANEL].instance.Core.documentViewer.getDocument()),
                      (i = p[h.OVERLAY_PANEL].instance.Core.documentViewer.getDocument()),
                      (u = [
                        { document: o, Core: p[h.BASE_PANEL].instance.Core },
                        { document: i, Core: p[h.OVERLAY_PANEL].instance.Core },
                      ]),
                      t.CompareDocumentManager.initialize(p[h.MIDDLE_PANEL].instance.Core, u, {
      ...
      (u = v),
          ...
          regeneratorRuntime.mark(function n() {
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), P(''.concat(window.location.href, '../../../samples/files/test_doc_1.pdf'), ''.concat(window.location.href, '../../../samples/files/test_doc_2.pdf'));
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      S(t);
                    }),
                      (document.getElementById('enable-snap-mode').disabled = !p[h.BASE_PANEL].instance.Core.isFullPDFEnabled() && !p[h.OVERLAY_PANEL].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(u.map(A)).then(function() {
          return p[h.MIDDLE_PANEL].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), c();
        }),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (t.next = 7),
                        P(window.location.href + e, window.location.href + i)
                      );
                    case 7:
                    case 'end':
                      return t.stop();
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.getElementById('url').value), (e = document.getElementById('url2').value), (t.next = 5), P(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
            ...
            regeneratorRuntime.mark(function t(n) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (r = document.forms['file-picker-form'][0].files[0]), (e = document.forms['file-picker-form'][1].files[0]), (t.next = 5), P(r, e);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
        ...
        document.getElementById('enable-opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+r / 100), b();
        }),
        document.getElementById('opacity-slider').addEventListener('change', function() {
          ...
          t.DiffOverlaySlider.setValue(+n / 100), b();
        });
    })(window);
  },
]);
