!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
        ...
        Rt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (T(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : b(n, e)) - o));
          },
        },
        kt = function(t, n) {
      ...
      mt || ((G.f = Vt), (V.f = Gt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Vt, defineProperty: Gt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === B && i(G, t) && !i(U, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== B || !i(G, n) || i(U, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === B, e = T(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(B, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
          return u && q && $(B, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
    ...
    window.DiffOverlaySlider = {
      ...
      setValue: function(t) {
        if (!(t >= 0 && t <= 1)) throw new Error('value must be a decimal between 0 - 1 (inclusive)');
        e = t;
      },
      getValue: function() {
        return e;
