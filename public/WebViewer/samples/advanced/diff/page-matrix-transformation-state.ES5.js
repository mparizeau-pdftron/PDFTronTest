!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), b = o(d), m = e(c, v, 3), S = u(b.length), x = 0, w = r ? p(n, S) : f ? p(n, 0) : void 0; S > x; x++)
          if ((h || x in b) && ((g = m((y = b[x]), x, d)), t))
            if (r) w[x] = g;
            else if (g)
              switch (t) {
                case 3:
        ...
        (t.exports = function(t, n, r, e) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new J(i) }); s < c; ) O(t, s++);
              })),
              (_ = v.prototype = E(Ut)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      } else (m = y.getConstructor(n, t, g, S)), u(m.prototype, r), (c.NEED = !0);
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : x('values'), keys: g ? F : x('keys'), entries: M }), d)) for (m in b) m in E || i(E, m, b[m]);
  ...
  function(t, n, r) {
    ...
    d(S, 'ArrayBuffer'), d(x, 'DataView'), c(x[b], u.VIEW, !0), (n.ArrayBuffer = S), (n.DataView = x);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, D) || T(t, D, O(1, {})), (t[D][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, O(1, r));
            };
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                O = f(b, p ? h : h.slice(x));
              if (null === O || (_ = l(c(b.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, g);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        m = u[d],
        S = m && m.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, d), (f[d] = h), b)) for (g in e) S[g] || i(S, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
        ...
        return (
          ...
          (M.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: j(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    !(function(t) {
      function n(t) {
        this.pageIndexTransformationStates = t || [];
      }
      (n.prototype.setTransformationStateForPageNumber = function(t, n) {
        this.pageIndexTransformationStates[t - 1] = n;
      }),
        (n.prototype.getTransformationStateForPageNumber = function(t) {
          return e({}, this.pageIndexTransformationStates[t - 1]);
        }),
        (n.prototype.getPageMatrixFromPageNumber = function(n) {
          var r = e({}, this.pageIndexTransformationStates[n - 1]),
            o = new t.Core.Math.TransformationBuilder();
          return (
            o
              .scale(0 === r.scaling ? 1 : r.scaling)
              .rotate(r.rotation, !0)
              .translate(r.horizontalTranslation, r.verticalTranslation),
            o.getFinalTransform()
          );
        }),
        (t.PageMatrixTransformationState = n);
    })(window);
  },
]);
