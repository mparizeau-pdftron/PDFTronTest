!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (x = function(t) {
        ...
        o && (V(x, 'byteLength', '_l'), V(S, 'buffer', '_b'), V(S, 'byteLength', '_l'), V(S, 'byteOffset', '_o')),
        f(S[m], {
          getInt8: function(t) {
    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && q && $(G, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', webviewerServerURL: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/legal-contract.pdf' }, r).then(function(t) {
      samplesSetup(t);
      var n = t.Core,
        r = n.documentViewer,
        ...
        i = function(t, n) {
          var i = r.getDocument();
          i.loadPageText(n).then(function(r) {
            for (var u, c = 0, f = []; (u = r.indexOf(t, c)) > -1; ) {
              c = u + t.length;
              var a = i.getTextPosition(n, u, u + t.length).then(function(t) {
                var r = new o.TextHighlightAnnotation();
                return (r.Author = e.getCurrentUser()), (r.PageNumber = n), (r.Quads = t), (r.StrokeColor = new o.Color(0, 255, 255)), r;
              });
              f.push(a);
            }
            Promise.all(f).then(function(t) {
              e.addAnnotations(t), e.selectAnnotations(t);
            });
          });
        },
        u = function(t) {
          var n = e.getAnnotationsList().filter(function(n) {
            return n.PageNumber === t;
          });
          e.deleteAnnotations(n);
        };
      r.addEventListener('documentLoaded', function() {
        var t = document.getElementById('text'),
          n = (function(t) {
            var n,
              r = document.getElementById('pages'),
              e = [];
            for (n = 1; n <= t; n++) {
              var o = document.createElement('input');
              (o.id = 'page-'.concat(n)), (o.type = 'checkbox'), (o.checked = !1), (o.value = n), e.push(o);
              var i = document.createElement('label');
              (i.htmlFor = 'page-'.concat(n)), (i.innerHTML = 'Page '.concat(n));
              var u = document.createElement('br');
              r.appendChild(o), r.appendChild(i), r.appendChild(u);
            }
            return e;
          })(r.getPageCount());
        n.forEach(function(n) {
          n.addEventListener('change', function() {
            ...
            n.checked && t.value ? i(t.value, r) : u(r);
          });
        }),
          t.addEventListener(
            'input',
            debounce(function() {
              n.forEach(function(n) {
                var r = Number(n.value);
                n.checked && (u(r), t.value && i(t.value, r));
              });
            }, 200)
          ),
          (n[0].checked = !0),
