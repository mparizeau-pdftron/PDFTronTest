!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), w = 0, S = r ? p(n, x) : a ? p(n, 0) : void 0; x > w; w++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(c.length), o = Pt(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Tt = function() {
        ...
        Rt = {
          ...
          filter: function(t) {
            return At(this, J(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          subarray: function(t, n) {
            var r = Ft(this),
              e = r.length,
              o = m(t, e);
            return new (L(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, y((void 0 === n ? e : m(n, e)) - o));
          },
        },
        kt = function(t, n) {
          return At(this, ht.call(Ft(this), t, n));
        },
        Ct = function(t) {
          Ft(this);
      ...
      v(Ut, Dt),
        p(Ut, dt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        jt(Ut, 'buffer', 'b'),
        jt(Ut, 'byteOffset', 'o'),
        jt(Ut, 'byteLength', 'l'),
        jt(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
                    if (d % n) throw z('Wrong length!');
                    if ((u = d - h) < 0) throw z('Wrong length!');
                  } else if ((u = y(o) * n) + h > d) throw z('Wrong length!');
                  c = u / n;
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, f),
                  S(r)
                    ? r instanceof X || 'ArrayBuffer' == (i = w(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new d(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new d(r, Ot(e, n))
              ...
              K(m !== Function.prototype ? P(d).concat(P(m)) : P(d), function(t) {
                t in v || p(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
      ...
      if (!p || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var d = /./[h],
          y = r(u, h, ''[t], function(t, n, r, e, o) {
            return n.exec === a ? (p && !o ? { done: !0, value: d.call(n, r, e) } : { done: !0, value: t.call(r, n, e) }) : { done: !1 };
          }),
          g = y[0],
          m = y[1];
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : w('values'), keys: y ? P : w('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[L], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (x = function(t) {
        ...
        (w = function(t, n, r) {
          ...
          (this[I] = t), (this[L] = o), (this[T] = r);
        }),
        o && (U(x, 'byteLength', '_l'), U(w, 'buffer', '_b'), U(w, 'byteLength', '_l'), U(w, 'byteOffset', '_o')),
        a(w[m], {
          getInt8: function(t) {
    ...
    g(x, 'ArrayBuffer'), g(w, 'DataView'), c(w[m], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = w);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== F.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
    ...
    t.exports = {
      ...
      def: function(t, n, r) {
        var e,
          o,
          i = y(t, n);
        return i ? (i.v = r) : ((t._l = i = { i: (o = p(n, !0)), k: n, v: r, p: (e = t._l), n: void 0, r: !1 }), t._f || (t._f = i), e && (e.n = i), t[d]++, 'F' !== o && (t._i[o] = i)), t;
      },
      getEntry: y,
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), Y(t, n, r)) : T(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
        for (var r, e = g((n = S(n))), o = 0, i = e.length; i > o; ) K(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
        var n = W.call(this, (t = _(t, !0)));
        return !(this === G && i(B, t) && !i(U, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== G || !i(B, n) || i(U, n))) {
          var r = I(t, n);
          return !r || !i(B, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = L(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = L(r ? U : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(G, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          return u && q && Y(G, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    for (var ot = j(v.store), it = 0; ot.length > it; ) y(ot[it++]);
    c(c.S + c.F * !z, 'Symbol', {
      for: function(t) {
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            m = s(h);
          if ((y && (d = e(d, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (r = new p((n = a(h.length))); n > g; g++) f(r, g, y ? d(h[g], g) : h[g]);
          else for (l = m.call(h), r = new p(); !(o = l.next()).done; g++) f(r, g, y ? u(l, d, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, w = '', S = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), F = [], P = 1; P < b.length; P++) F.push(void 0 === (x = b[P]) ? x : String(x));
            var A = b.groups;
            if (p) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, w = 0, S = []; w < h.length; ) {
              ...
              var _,
                E = a(m, p ? h : h.slice(w));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : w)), h.length)) === x) w = u(h, w, y);
              else {
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, g), (a[g] = h), m)) for (y in e) x[y] || i(x, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        function O(t, n) {
          ...
          return i
            ? i.done
              ? ((n[t.resultName] = i.value), (n.next = t.nextLoc), 'return' !== n.method && ((n.method = 'next'), (n.arg = r)), (n.delegate = null), d)
              : i
        ...
        return (
          ...
          (m.constructor = g),
          (m[a] = g.displayName = 'GeneratorFunction'),
          ...
          (A.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: M(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), d;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    WebViewer({ path: 'lib', css: 'styles.css', disabledElements: ['searchButton', 'pageNavOverlay', 'viewControlsButton', 'panToolButton'] }, c).then(
      (function() {
        var t = u(
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      ...
                      (c = o.iframeWindow),
                      n.UI.setTheme('dark'),
                      (a = i.getAnnotationManager()),
                      '---- Insert commercial license key here after purchase ----',
                      (t.next = 8),
                      WebViewer.Video.registerDocument(n, '---- Insert commercial license key here after purchase ----')
                    );
                  case 8:
                    'https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4',
                      'https://pdftron.s3.amazonaws.com/downloads/pl/video/thumbnail.jpg',
                      WebViewer.Video.loadDocument('https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4', 'https://pdftron.s3.amazonaws.com/downloads/pl/video/thumbnail.jpg'),
                      o.setHeaderItems(function(t) {
                        var n;
                        t.push({
                          type: 'actionButton',
                          img:
                                        ...
                                        return (
                                          (n = function(t, n) {
                                            return new Promise(function(r) {
                                              fetch('/server/annotationHandler.js?documentId='.concat(t), { method: 'POST', body: n }).then(function(t) {
                                                200 === t.status && r();
                                              });
                                            });
                                          }),
                                          (r = i
                                            ...
                                            .getAllAnnotations()),
                                          (t.next = 4),
                                          a.exportAnnotations({ links: !1, widgets: !1, annotList: r })
                                        );
                                      case 4:
                                        return (e = t.sent), (t.next = 7), n('video', e);
                                      case 7:
                      ...
                      i.addEventListener('documentLoaded', function() {
                        i.zoomTo(1.25);
                        i.getDocument();
                        var t,
                          n = i.getDocument().getVideo();
                        ((t = 'video'),
                        new Promise(function(n) {
                          fetch('/server/annotationHandler.js?documentId='.concat(t), { method: 'GET' }).then(function(r) {
                            200 === r.status
                              ? r.text().then(function(t) {
                                  console.log(t), n(t);
                                })
                              : 204 === r.status
                              ? (console.warn('Found no content in xfdf file /server/annotationHandler.js?documentId='.concat(t)), n(''))
                              : (console.warn('Something went wrong trying to load xfdf file /server/annotationHandler.js?documentId='.concat(t)),
                                console.warn('Response status '.concat(r.status)),
                                n(''));
                          });
                        }))
                          .then(function(t) {
                            return i.getAnnotationManager().importAnnotations(t);
                          })
                          .then(function() {
                            n.updateAnnotationsToTime(0);
                          });
                      }),
                      (f = !1),
                      i.addEventListener('pageComplete', function(t, n) {
                        if (!f) {
                          f = !0;
                          var r = function(t) {
                          ...
                          n.appendChild(l);
                          var h = l.querySelector('#play'),
                            p = l.querySelector('#pause'),
                            v = l.querySelector('#volume'),
                            d = l.querySelector('#muted'),
                            y = l.querySelector('#progress'),
                            g = l.querySelector('.markers'),
                            m = l.querySelector('#current-time'),
                            b = l.querySelector('#tooltip'),
                            x = s.getElement(),
                            w = function(t) {
                              for (; g.firstChild; ) g.removeChild(g.firstChild);
                              t.forEach(function(t) {
                                if (t.startTime <= s.duration) {
                                  var n = document.createElement('div');
                                  n.className = 'marker';
                                  var r = t.startTime / s.duration;
                                  n.onclick = function() {
                                    j(t.startTime);
                                  };
                                  var e = Math.floor(r * y.clientWidth) - 1;
                                  (n.style = 'left: '.concat(e, 'px')), g.appendChild(n);
                                }
                              });
                            };
                          a.addEventListener('annotationChanged', function() {
                            w(s.getAllAnnotations());
                          }),
                            w(s.getAllAnnotations()),
                            h.setAttribute('data-state', 'visible'),
                            p.setAttribute('data-state', 'hidden'),
                            x.addEventListener('play', function() {
                              h.setAttribute('data-state', 'hidden'), p.setAttribute('data-state', 'visible');
                            }),
                            x.addEventListener('pause', function() {
                              h.setAttribute('data-state', 'visible'), p.setAttribute('data-state', 'hidden');
                            }),
                            h.addEventListener('click', function() {
                              (x.paused || x.ended) && x.play();
                            }),
                            p.addEventListener('click', function() {
                              x.pause();
                            }),
                            v.setAttribute('data-state', 'visible'),
                            d.setAttribute('data-state', 'hidden'),
                            x.addEventListener('volumechange', function(t) {
                              x.muted
                                ? (v.setAttribute('data-state', 'hidden'), d.setAttribute('data-state', 'visible'))
                                : (v.setAttribute('data-state', 'visible'), d.setAttribute('data-state', 'hidden'));
                            }),
                                      ...
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          return (
                                            ...
                                            (r = n.x),
                                            (o = n.width),
                                            (i = Array.from(S.getElementsByClassName('innerFrame')).filter(function(t) {
                                              var n = t.getBoundingClientRect(),
                                                e = n.x,
                                                i = e + n.width > r && e < r + o;
                                              return 0 === t.children.length && i;
                                            })),
                                            (u = i
                                              .map(function(t) {
                                        ...
                                        case 9:
                                          (t.t4 = t.sent),
                                            (E = (0, t.t0)(t.t1, t.t2, t.t3, t.t4)),
                                            i.forEach(function(t) {
                                              var n = E[t.frameNumber];
                                              n ? t.appendChild(n) : console.warn('Failed to get canvas for frame: '.concat(t.frameNumber));
                                            });
                                        case 12:
                                        case 'end':
                                          return t.stop();
                          ...
                          S.addEventListener('scroll', _.debounce(O, 250));
                          var F,
                            P = 770 / i.getZoom(),
                            A = s.getTotalFrames();
                          HyperList.create(S, {
                            ...
                            generate: function(t) {
                              ...
                              (e.id = 'frame'.concat(n)), (e.className = 'frame');
                              var o = document.createElement('div');
                              (o.id = 'innerFrame'.concat(n)),
                                (o.frameNumber = n),
                                (o.className = 'innerFrame'),
                                (o.style = 'min-width: '.concat(88, 'px; min-height: ', 50, 'px;')),
                                (e.onclick = function() {
                                  j(s.getTimeFromFrame(n));
                                });
                              var i = r(
                                  '\n            <div class="frameFooter">\n              <div class="frameNumber">\n                <span>'.concat(
                                    s.getFormattedTime(s.getTimeFromFrame(n)),
                                    '</span>\n              </div>\n            </div>\n          '
                                  )
                                ),
                                u = E[n];
                              u && 'inprogress' !== u && o.appendChild(u), e.appendChild(o), e.appendChild(i);
                              var c = s.getFrameFromTime(x.currentTime);
                              return n === c && (e.setAttribute('data-state', 'selected'), (F = e)), e;
                            },
                          }),
                            l.appendChild(S),
                            x.addEventListener(
                                ...
                                regeneratorRuntime.mark(function t() {
                                  ...
                                  return regeneratorRuntime.wrap(function(t) {
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          o.getVideo().updateAnnotationsToTime(x.currentTime),
                                            F && F.removeAttribute('data-state'),
                                            (n = s.getFrameFromTime(x.currentTime)),
                                            (F = c.document.getElementById('frame'.concat(n))) && F.setAttribute('data-state', 'selected');
                                        case 5:
                                        case 'end':
                                          return t.stop();
                                      }
                          ...
                          var M,
                            j = function(t) {
                              (x.currentTime = t), (y.value = x.currentTime), (m.innerHTML = ''.concat(s.getFormattedCurrentTime()));
                              var n = 100.5 * (s.getFrameFromTime(x.currentTime) - 1) - S.clientWidth / 2 + 46.25;
                              Math.abs(S.scrollLeft - n) < 800 ? S.scroll({ left: n, behavior: 'smooth' }) : (S.scrollLeft = n);
                            };
                          y.addEventListener('click', function(t) {
                            ...
                            y.addEventListener('mousemove', function(t) {
                              var n = y.getBoundingClientRect().width,
                                r = ((t.offsetX * i.getZoom()) / n) * y.max;
                              (M = r), b.setAttribute('data-state', 'visible'), (b.style = 'left: '.concat(t.offsetX, 'px;')), (b.innerHTML = ''.concat(s.getFormattedTime(r)));
                            }),
                            y.addEventListener('mouseout', function(t) {
                              b.setAttribute('data-state', 'hidden');
                            }),
                            O();
                        }
