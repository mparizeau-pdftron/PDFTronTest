!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof J || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? It(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && K && q(U, t, { configurable: !0, set: n }), J(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Q),
      (M.f = nt),
      u && !r(30) && f(U, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return J(v(t));
      })),
  ...
  function(t, n) {
    ...
    function u() {
      var t,
        n = document.getElementsByClassName('autofill-initial-hidden');
      for (t = 0; t < n.length; t++) n[t].className = '';
      document.getElementById('doc-title').innerText = 'Sample Document';
    }
    WebViewer({ path: '../../../lib', preloadWorker: 'office', initialDoc: '../../files/SYH_Letter_red.docx', fullAPI: !1 }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core.documentViewer,
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    if (!(r = document.getElementById('file-picker').files[0])) {
                      n.next = 5;
                      break;
                    }
                    return (n.next = 4), t.loadDocument(r);
                  case 4:
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    for (e = document.getElementById('autofill-form').elements, o = {}, i = 0; (u = e[i++]); )
                      if ('value-field' === u.className && u.value.length > 0)
                        try {
                          (c = JSON.parse(u.value)), (o[u.name] = c);
                        } catch (t) {
                          o[u.name] = u.value;
                        }
                    for (f in o) o[f].hasOwnProperty('image_url') && 'http' != (a = o[f].image_url).substr(0, 4) && (o[f].image_url = r + a);
                    return (t.next = 6), n.getDocument().applyTemplateValues(o);
                  case 6:
                  case 'end':
                    return t.stop();
                }
      ...
      n.addEventListener(
          ...
          regeneratorRuntime.mark(function t() {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), n.getDocument().documentCompletePromise();
                  case 2:
                    if (
                      (n.updateView(),
                      (r = n.getDocument()),
                      (e = r.getTemplateKeys()),
                      (document.getElementById('current-status').innerText = 'Submit to populate the document preview'),
                      o ? u() : (document.getElementById('doc-title').innerText = r.getFilename()),
                      (document.getElementById('key-val-title').innerText = 'Key values :'),
                      e)
                    ) {
                      for (c = document.getElementById('autofill-form'); c.hasChildNodes(); ) c.removeChild(c.lastChild);
                      for (f in e)
                        ((a = document.createElement('span')).className = 'tag-label'),
                          a.appendChild(document.createTextNode(''.concat(e[f], ':'))),
                          c.appendChild(a),
                          ((s = document.createElement('textarea')).rows = 1.4),
                          (s.className = 'value-field'),
                          (s.type = 'text'),
                          (s.name = e[f]),
                          o && s.name in i && ((s.value = i[s.name].val), (s.rows = i[s.name].rows + 0.4)),
                          c.appendChild(s),
                          c.appendChild(document.createElement('br'));
                      ((l = document.createElement('input')).type = 'submit'), (l.name = 'Autofill'), c.appendChild(l), c.appendChild(document.createElement('br'));
                    }
                  case 10:
                  case 'end':
                    return t.stop();
        ...
        (document.getElementById('file-picker').onchange = function(t) {
          if (t.target.files[0]) {
            o = !1;
            for (var n = document.getElementById('autofill-form'); n.hasChildNodes(); ) n.removeChild(n.lastChild);
            !(function() {
              c.apply(this, arguments);
            })();
          }
        }),
        (document.getElementById('autofill-form').onsubmit = function(t) {
          t.preventDefault(),
            (function() {
