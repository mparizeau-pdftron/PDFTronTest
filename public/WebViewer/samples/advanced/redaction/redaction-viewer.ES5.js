        ...
        (document.getElementById('select').onchange = function(n) {
          ...
          n.addEventListener('documentLoaded', function() {
            document.getElementById('apply-redactions').onclick = function() {
              t.UI.showWarningMessage({
                title: 'Apply redaction?',
                message: 'This action will permanently remove all items selected for redaction. It cannot be undone.',
                onConfirm: function() {
                  return n.getAnnotationManager().applyRedactions(), Promise.resolve();
                },
              });
            };
          }),
          t.UI.setToolbarGroup('toolbarGroup-Edit'),
          t.UI.setToolMode('AnnotationCreateRedaction');
      }
    );
  },
]);
