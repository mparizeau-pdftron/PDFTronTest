        ...
        var e = t.Core,
          ...
          f = r.map(function(t) {
            var n = t.box.x,
              ...
              a = [n, r + i],
              s = [n + e, r + i];
            return o(c.Quad, a.concat(s, f, u));
          }),
          a = new i.RedactionAnnotation({ Quads: f });
        (a.Author = u.getCurrentUser()), (a.PageNumber = n), (a.StrokeColor = new i.Color(255, 0, 0, 1)), u.addAnnotation(a, !1), u.redrawAnnotation(a);
      }
    }
    function c(t, n) {
                    ...
                    return regeneratorRuntime.wrap(function(e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            (i = e.sent), (f = faceapi.resizeResults(i, c)), u(t, n, f), r();
                          case 6:
                          case 'end':
                            return e.stop();
                        }
