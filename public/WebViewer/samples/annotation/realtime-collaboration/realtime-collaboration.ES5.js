!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (F && (x = s(F.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
    ...
    function L(t, n, r) {
      ...
      for (
        (t = P(t)) != t || t === E
          ...
          : ((e = A(F(t) / M)),
            t * (i = I(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + f >= 1 ? s / i : s * I(2, 1 - f)) * i >= 2 && (e++, (i /= 2)),
            e + f >= a ? ((o = 0), (e = a)) : e + f >= 1 ? ((o = (t * i - 1) * I(2, n)), (e += f)) : ((o = t * I(2, f - 1) * I(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else M = y(E, h, O, P, A, n);
            O >= w && ((S += h.slice(w, O) + M), (w = O + E.length));
          }
          return S + h.slice(w);
        },
      ];
        ...
        return (
          ...
          (A.prototype = {
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', webviewerServerURL: 'https://demo.pdftron.com/', initialDoc: u, documentId: o[u] }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core,
        r = n.documentViewer,
        u = n.annotationManager,
        c = null,
        a = document.getElementById('url'),
        f = document.getElementById('copy');
      t.UI.openElements(['notesPanel']);
      var s = !1;
      if ('http://localhost:3000' === window.location.origin) {
        var l = new XMLHttpRequest();
        (l.onreadystatechange = function() {
          4 === l.readyState && 200 === l.status && (a.value = 'http://'.concat(l.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          l.open('GET', '/ip', !0),
          l.send();
      } else (a.value = 'https://pdftron.com/samples/web/samples/annotation/realtime-collaboration/'), (a.value = 'https://pdfjs.express/samples/annotation/realtime-collaboration/');
      (f.onclick = function() {
        a.select(), document.execCommand('copy'), document.getSelection().empty();
      }),
        r.addEventListener('documentLoaded', function() {
          ...
          var n = (function() {
            ...
            f = function(t) {
              s || (u.setCurrentUser(t), window.alert('Welcome back '.concat(t)), (s = !0));
            },
            l = function() {
              var t,
                n = window.prompt('Welcome! Tell us your name :)');
              n && ((t = n), u.setCurrentUser(t), i.updateAuthor(c, { authorName: t }));
            };
          i.bind('onAuthStateChanged', function(t) {
            t ? ((c = t.uid), i.checkAuthor(c, f, l), i.bind('onAnnotationCreated', n), i.bind('onAnnotationUpdated', o), i.bind('onAnnotationDeleted', a)) : i.signInAnonymously();
          });
        }),
        u.addEventListener(
          'annotationChanged',
                      ...
                      case 4:
                        (o = t.sent),
                          n.forEach(function(t) {
                            var n = null;
                            'add' === r
                              ? (t.InReplyTo && (n = u.getAnnotationById(t.InReplyTo).authorId || 'default'),
                                c && (t.authorId = c),
                                i.createAnnotation(t.Id, { authorId: c, parentAuthorId: n, xfdf: o }))
                              : 'modify' === r
                              ? (t.InReplyTo && (n = u.getAnnotationById(t.InReplyTo).authorId || 'default'), i.updateAnnotation(t.Id, { authorId: c, parentAuthorId: n, xfdf: o }))
                              : 'delete' === r && i.deleteAnnotation(t.Id);
                          });
                      case 6:
                      case 'end':
                        return t.stop();
        ...
        u.setPermissionCheckCallback(function(t, n) {
          return n.authorId === c;
        }),
