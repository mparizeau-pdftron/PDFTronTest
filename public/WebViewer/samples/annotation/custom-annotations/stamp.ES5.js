!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function() {
          return ht.apply(jt ? vt.call(Ot(this)) : Ot(this), arguments);
        },
        Dt = {
          copyWithin: function(t, n) {
            return X.call(Ot(this), t, n, arguments.length > 2 ? arguments[2] : void 0);
          },
          every: function(t) {
          ...
          filter: function(t) {
            return Mt(this, Q(Ot(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          some: function(t) {
            return _(Ot(this), t, arguments.length > 1 ? arguments[1] : void 0);
          },
          sort: function(t) {
        ...
        kt = function(t, n) {
          return Mt(this, vt.call(Ot(this), t, n));
        },
        Rt = function(t) {
          Ot(this);
      ...
      h(Ct, Bt),
        p(Ct, yt, Bt.values),
        h(Ct, { slice: kt, set: Rt, constructor: function() {}, toString: pt, toLocaleString: It }),
        Nt(Ct, 'buffer', 'b'),
        Nt(Ct, 'byteOffset', 'o'),
        Nt(Ct, 'byteLength', 'l'),
        Nt(Ct, 'length', 'e'),
          ...
          m
            ? ((h = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  v = 0;
                if (x(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return wt in r ? Lt(h, r) : zt.call(h, r);
                  (i = r), (v = Ft(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, h, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: P ? E : S('values'), keys: g ? E : S('keys'), entries: M }), d)) for (m in b) m in F || i(F, m, b[m]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[T]) throw P(m);
      for (var c = t[z]._b, f = u + t[j], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
      ...
      (w = function(t) {
        ...
        (S = function(t, n, r) {
          ...
          if (o + (r = void 0 === r ? e - o : v(r)) > e) throw P('Wrong length!');
          (this[z] = t), (this[j] = o), (this[T] = r);
        }),
        o && (C(w, 'byteLength', '_l'), C(S, 'buffer', '_b'), C(S, 'byteLength', '_l'), C(S, 'byteOffset', '_o')),
        f(S[b], {
          getInt8: function(t) {
    ...
    d(w, 'ArrayBuffer'), d(S, 'DataView'), c(S[b], u.VIEW, !0), (n.ArrayBuffer = w), (n.DataView = S);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      z = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(L) instanceof n && 0 !== O.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(P('Promise-chain cycle')) : (i = T(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
    ...
    z ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = a(B, t, 1)), (this.reject = a(R, t, 1));
      }),
      (m.f = N = function(t) {
        return t === E || t === u ? new i(t) : o(t);
      })),
      l(l.G + l.W + l.F * !z, { Promise: E }),
      r(38)(E, 'Promise'),
      r(41)('Promise'),
      (u = r(7).Promise),
      l(l.S + l.F * !z, 'Promise', {
    ...
    var o = r(1),
      ...
      q = function(t, n, r) {
        return (
          ...
          (n = P(n, !0)),
          m(r),
          i(H, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (r = F(r, { enumerable: A(0, !1) }))) : (i(t, R) || T(t, R, A(1, {})), (t[R][n] = !0)), Z(t, n, r)) : T(t, n, r)
        );
      },
      Q = function(t, n) {
        m(t);
      ...
      _ = function(t) {
        ...
        return !(this === V && i(H, t) && !i(C, t)) && (!(n || !i(this, t) || !i(H, t) || (i(this, R) && this[R][t])) || n);
      },
      $ = function(t, n) {
        if (((t = x(t)), (n = P(n, !0)), t !== V || !i(H, n) || i(C, n))) {
          var r = z(t, n);
          return !r || !i(H, n) || (i(t, R) && t[R][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = j(x(t)), e = [], o = 0; r.length > o; ) i(H, (n = r[o++])) || n == R || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (f(
        (I = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(C, r), i(this, R) && i(this[R], t) && (this[R][t] = !1), Z(this, t, A(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var w, S = '', x = 0, P = 0; P < b.length; P++) {
            m = b[P];
            for (var A = String(m[0]), F = a(s(u(m.index), v.length), 0), O = [], E = 1; E < m.length; E++) O.push(void 0 === (w = m[E]) ? w : String(w));
            var M = m.groups;
            if (p) {
              var L = [A].concat(O, F, v);
              void 0 !== M && L.push(M);
              var N = String(n.apply(void 0, L));
            } else N = y(A, v, F, O, M, n);
            F >= x && ((S += v.slice(x, F) + N), (x = F + A.length));
          }
          return S + v.slice(x);
        },
      ];
          ...
          ''.split(/.?/).length
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = a.call(h, o)) &&
                  !((u = h.lastIndex) > l && (f.push(o.slice(l, i.index)), i.length > 1 && i.index < o.length && v.apply(f, i.slice(1)), (c = i[0].length), (l = u), f.length >= p));

                )
                  h.lastIndex === i.index && h.lastIndex++;
                return l === o.length ? (!c && h.test('')) || f.push('') : f.push(o.slice(l)), f.length > p ? f.slice(0, p) : f;
              }
        ...
        [
          ...
          function(t, n) {
            ...
            for (var w = 0, S = 0, x = []; S < v.length; ) {
              ...
              var P,
                A = f(b, p ? v : v.slice(S));
              if (null === A || (P = l(c(b.lastIndex + (p ? 0 : S)), v.length)) === w) S = u(v, S, g);
              else {
                if ((x.push(v.slice(w, S)), x.length === m)) return x;
                for (var F = 1; F <= A.length - 1; F++) if ((x.push(A[F]), x.length === m)) return x;
                S = w = P;
              }
            }
    ...
    (function(t) {
      ...
      var r = (function(t) {
            ...
            (i._invoke = (function(t, n, r) {
              ...
              return function(o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var f = s(t, n, r);
                  if ('normal' === f.type) {
                    if (((e = r.done ? h : v), f.arg === y)) continue;
                    return { value: f.arg, done: r.done };
                  }
                  'throw' === f.type && ((e = h), (r.method = 'throw'), (r.arg = f.arg));
                }
              };
            })(t, r, u)),
            i
        ...
        function F(t, n) {
          ...
          if (e === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = r), F(t, n), 'throw' === n.method)) return y;
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, b) : ((t.__proto__ = b), f in t || (t[f] = 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
          ...
          (M.prototype = {
            constructor: M,
            reset: function(t) {
              if (((this.prev = 0), (this.next = 0), (this.sent = this._sent = r), (this.done = !1), (this.delegate = null), (this.method = 'next'), (this.arg = r), this.tryEntries.forEach(E), !t))
            ...
            delegateYield: function(t, n, e) {
              return (this.delegate = { iterator: L(t), resultName: n, nextLoc: e }), 'next' === this.method && (this.arg = r), y;
            },
          }),
          t
        );
      ...
      return new ((function(t) {
        function n() {
          ...
          return (
            ...
            delete (t = o(this, u(n).call(this, r, a.StampAnnotation))).defaults.StrokeColor,
        ...
        return (
          (function(t, n) {
            ...
            (t.prototype = Object.create(n && n.prototype, { constructor: { value: t, writable: !0, configurable: !0 } })), n && c(t, n);
          })(n, t),
          (l = n),
          (v = [
            {
            ...
            },
            {
              ...
              value: function(t) {
                var r;
                if ((i(u(n.prototype), 'mouseLeftDown', this).call(this, t), this.annotation)) {
                  var e = 212,
                    o = 60,
                    c = 90 * this.documentViewer.getCompleteRotation(this.annotation.PageNumber);
                  if (((this.annotation.Rotation = c), 270 === c || 90 === c)) {
                    var a = o;
                    (o = e), (e = a);
                  }
                  this.annotation.setImageData(
                    ...
                    (this.annotation.Width = e),
                    (this.annotation.Height = o),
                    (this.annotation.X -= e / 2),
                    (this.annotation.Y -= o / 2),
                    (this.annotation.MaintainAspectRatio = !0),
                    (r = this.annotation);
                }
                i(u(n.prototype), 'mouseLeftUp', this).call(this, t), r && f.redrawAnnotation(r);
              },
            },
          ]) && e(l.prototype, v),
          p && e(l, p),
