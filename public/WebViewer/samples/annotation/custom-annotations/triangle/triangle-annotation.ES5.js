  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : x('values'), keys: g ? F : x('keys'), entries: M }), d)) for (m in b) m in O || i(O, m, b[m]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : T(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(b, p ? h : h.slice(x));
              if (null === E || (_ = l(c(b.lastIndex + (p ? 0 : x)), h.length)) === S) x = u(h, x, g);
              else {
    ...
    !(function(t) {
      ...
      t.TriangleAnnotationFactory = {
        initialize: function(f, a) {
          var s = (function(s) {
            function l() {
              ...
              !(function(t, n) {
                ...
                ((e = o(this, u(l).call(this, 'triangle'))).Subject = 'Triangle'),
                (e[r] = n),
                (e.vertices = []);
              for (var i = 0; i < 3; ++i) e.vertices.push(new a.Point());
              return (e.selectionModel = t.TriangleSelectionModelFactory.initialize(f, a)), e;
            }
            var h, p, v;
            return (
              (function(t, n) {
              ...
              (p = [
                ...
                },
                {
                  key: 'serialize',
                  value: function(t, n) {
                    var r = i(u(l.prototype), 'serialize', this).call(this, t, n);
                    return r.setAttribute('vertices', f.XfdfUtils.serializePointArray(this.vertices, n)), r;
                  },
                },
                {
                  key: 'deserialize',
                  value: function(t, n) {
                    i(u(l.prototype), 'deserialize', this).call(this, t, n), (this.vertices = f.XfdfUtils.deserializePointArray(t.getAttribute('vertices'), n));
                  },
                },
              ]) && e(h.prototype, p),
              v && e(h, v),
          ...
          return (s.SerializationType = f.CustomAnnotation.SerializationTypes.CUSTOM), (s.prototype.elementName = 'triangle'), s;
        },
        TRIANGLE_ANNOT_ID: n,
        ANNOT_TYPE: r,
      };
