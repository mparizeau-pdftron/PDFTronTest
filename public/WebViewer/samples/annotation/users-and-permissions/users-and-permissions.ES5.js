!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          copyWithin: function(t, n) {
            return U.call(Pt(this), t, n, arguments.length > 2 ? arguments[2] : void 0);
          },
          every: function(t) {
      ...
      bt || ((B.f = Wt), (W.f = Bt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Wt, defineProperty: Bt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
  ...
  function(t, n) {
    WebViewer(
      ...
      samplesSetup(t);
      var n = t.Core.annotationManager,
        r = t.UI.openElements,
        e = !0,
        o = function() {
          var t = n.getCurrentUser(),
            r = n.getAnnotationsList().filter(function(t) {
              return t.Listable;
            }),
            o = r;
          n.hideAnnotations(r),
      ...
      n.setCurrentUser('Justin'),
        n.promoteUserToAdmin(),
        r(['notesPanel']),
        (document.getElementById('justin').onchange = function() {
          n.setCurrentUser('Justin'), n.promoteUserToAdmin(), n.disableReadOnlyMode(), o();
        }),
        (document.getElementById('sally').onchange = function() {
          n.setCurrentUser('Sally'), n.demoteUserFromAdmin(), n.disableReadOnlyMode(), o();
        }),
        (document.getElementById('brian').onchange = function() {
          n.setCurrentUser('Brian'), n.demoteUserFromAdmin(), n.enableReadOnlyMode(), o();
        }),
        (document.getElementById('display').onchange = function(t) {
          (e = t.target.checked), o();
        });
    });
  },
]);
