!(function(t) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: '../../../samples/files/demo-annotated.xod' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t),
        (document.getElementById('select').onchange = function(n) {
          'https://pdftron.s3.amazonaws.com/downloads/pl/encrypted-foobar12.xod' === n.target.value
