!(function(t) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', fullAPI: !0, initialDoc: '../../../samples/files/op-blend-test.pdf', enableFilePicker: !0 }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core.documentViewer,
        r = t.UI,
        e = r.openElements,
        o = r.closeElements,
        i = document.getElementById('colors'),
        u = !1;
      n.addEventListener('documentLoaded', function() {
        i.innerHTML = '';
        var t = n.getDocument();
        (u = !1),
          t.enableColorSeparations(!0),
          e(['loadingModal']),
          t.addEventListener('colorSeparationAdded', function(r) {
            u = !0;
            ...
            (c.id = r.name),
              ...
              (c.onchange = function(o) {
                e(['loadingModal']), t.enableSeparation(r.name, o.target.checked), n.refreshAll(), n.updateView();
              });
            var f = document.createElement('label');
            (f.id = ''.concat(r.name, ' label')), (f.htmlFor = r.name), (f.style.color = 'rgb('.concat(r.rgb.join(','), ')')), (f.innerHTML = r.name);
            var a = document.createElement('br');
            i.appendChild(c), i.appendChild(f), i.appendChild(a), o(['loadingModal']);
          });
      }),
        ...
        n.addEventListener('pageComplete', function() {
          u && o(['loadingModal']);
        });
    });
  },
