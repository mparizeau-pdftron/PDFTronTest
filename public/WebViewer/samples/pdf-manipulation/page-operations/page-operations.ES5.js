!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Wt = function(t, n) {
          return Bt(t, (n = b(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Vt = function(t, n, r) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? It(v, r) : jt.call(v, r);
                  (i = r), (h = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (I && (x = s(I.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: M }), g)) for (b in m) b in P || i(P, b, m[b]);
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== O.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      nt = function(t) {
        for (var n, r = t === G, e = T(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = a(s(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var I = [E].concat(O, P, h);
              void 0 !== M && I.push(M);
              var A = String(n.apply(void 0, I));
            } else A = y(E, h, P, O, M, n);
        ...
        function P(t, n) {
          ...
          if (e === r) {
            if (((n.delegate = null), 'throw' === n.method)) {
              if (t.iterator.return && ((n.method = 'return'), (n.arg = r), P(t, n), 'throw' === n.method)) return y;
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', useDownloader: !1, initialDoc: '../../../samples/files/demo.pdf' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core,
        r = n.documentViewer,
        o = n.PageRotation,
      ...
      r.addEventListener('documentLoaded', function() {
        var t = r.getDocument(),
          ...
          c = document.getElementById('move-from'),
          f = document.getElementById('move-to'),
          a = document.getElementById('insert-at'),
          s = document.getElementById('extract-list'),
          l = document.getElementById('rotate'),
          h = document.getElementById('crop'),
          p = document.getElementById('delete'),
          v = document.getElementById('move'),
          y = document.getElementById('insert'),
          d = document.getElementById('extract'),
          g = document.getElementById('file-picker'),
          m = function(t) {
            var r, e;
            for (n.innerHTML = '', c.innerHTML = '', f.innerHTML = '', a.innerHTML = '', s.value = t > 1 ? '1-'.concat(t) : 1, r = 0; r < t; r++)
              ((e = document.createElement('option')).innerHTML = r + 1), n.appendChild(e), c.appendChild(e.cloneNode(!0)), f.appendChild(e.cloneNode(!0)), a.appendChild(e.cloneNode(!0));
            var o = e.cloneNode(!0);
            (o.innerHTML = r + 1), a.appendChild(o);
          };
        (l.onclick = function() {
          t.rotatePages([Number(n.value)], o.E_90);
        }),
          (h.onclick = function() {
            t.cropPages([Number(n.value)], 40, 40, 40, 40);
          }),
          (p.onclick = function() {
            var r = t.getPageCount() - 1;
            t.removePages([Number(n.value)]), m(r);
          }),
          (v.onclick = function() {
            var n = Number(c.value),
              r = Number(f.value);
            n < r && r++, t.movePages([n], r);
          }),
          (y.onclick = function() {
            var n = t.getPageInfo(1),
              r = n.width,
              e = n.height,
              o = t.getPageCount() + 1;
            t.insertBlankPages([Number(a.value)], r, e), m(o);
          }),
          (d.onclick = e(
              ...
              return regeneratorRuntime.wrap(function(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      if ((s.setCustomValidity(''), s.checkValidity())) {
                        n.next = 4;
                        break;
                      }
                      return s.reportValidity(), n.abrupt('return');
                    case 4:
                      return (
                        (r = []),
                        (e = t.getPageCount()),
                        s.value.split(',').forEach(function(t) {
                          var n = t.split('-'),
                            o = Number(n[0]),
                            i = Number(1 === n.length ? n[0] : n[1]);
                          i > e && (i = e);
                          for (var u = o; u <= i; u++) r.push(u);
                        }),
                        (o = i.getAnnotationsList().filter(function(t) {
                          return r.indexOf(t.PageNumber) > -1;
                        })),
                        (n.next = 10),
                        i.exportAnnotations({ annotList: o })
                      );
                    case 10:
                      return (u = n.sent), (n.next = 13), t.extractPages(r, u);
                    case 13:
                      (c = n.sent), (f = new Uint8Array(c)), (a = new Blob([f], { type: 'application/pdf' })), saveAs(a, 'extracted.pdf');
                    case 17:
                    case 'end':
                      return n.stop();
                  }
          ...
          (s.oninvalid = function() {
            s.setCustomValidity('Should only contain valid page numbers, commas, or dashes ex 1,2,3-5');
          }),
          (g.onchange = function(n) {
            var r = n.target.files[0];
            u(r, {}).then(function(n) {
              for (var r = [], e = 0; e < n.getPageCount(); e++) r.push(e + 1);
              var o = t.getPageCount() + n.getPageCount();
              t.insertPages(n, r, t.getPageCount() + 1), m(o);
            });
          }),
          m(t.getPageCount());
      });
