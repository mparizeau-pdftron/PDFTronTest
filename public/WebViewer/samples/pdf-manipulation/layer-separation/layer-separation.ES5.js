!(function(t) {
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: '../../../samples/files/construction-drawing-final.pdf' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.Core.documentViewer;
      t.UI.openElements(['leftPanel']),
        t.UI.setActiveLeftPanel('layersPanel'),
        n.addEventListener('pageComplete', function() {
          t.UI.closeElements(['loadingModal']);
        });
    });
  },
]);
