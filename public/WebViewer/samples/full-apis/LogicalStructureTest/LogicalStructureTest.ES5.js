!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), x = o(d), b = e(c, v, 3), _ = u(x.length), m = 0, S = r ? h(n, _) : a ? h(n, 0) : void 0; _ > m; m++)
          if ((p || m in x) && ((g = b((y = x[m]), m, d)), t))
            if (r) S[m] = g;
            else if (g)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Ft = function(t, n) {
          if (!(S(t) && dt in t)) throw K('It is not a typed array constructor!');
          return new t(n);
        },
        Mt = function(t, n) {
          return It(k(t, t[xt]), n);
        },
        It = function(t, n) {
        ...
        Nt = function() {
          return vt.apply(kt ? pt.call(Pt(this)) : Pt(this), arguments);
        },
        Rt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = x(t, e);
            return new (k(r, r[xt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, g((void 0 === n ? e : x(n, e)) - o));
          },
        },
        Lt = function(t, n) {
        ...
        Wt = function(t, n) {
          return S(t) && t[_t] && 'symbol' != e(n) && n in t && String(+n) == String(n);
        },
        Vt = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? p(2, t[n]) : U(t, n);
        },
        Bt = function(t, n, r) {
          return !(Wt(t, (n = b(n, !0))) && S(r) && _(r, 'value')) || _(r, 'get') || _(r, 'set') || r.configurable || (_(r, 'writable') && !r.writable) || (_(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((B.f = Vt), (V.f = Bt)),
              ...
              G(t, r, {
                ...
                set: function(t) {
                  return (function(t, r, o) {
                    var i = t._d;
                    e && (o = (o = Math.round(o)) < 0 ? 0 : o > 255 ? 255 : 255 & o), i.v[p](r * n + i.o, o, wt);
                  })(this, r, t);
                },
                enumerable: !0,
              });
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (S(r)) {
                  if (!(r instanceof q || 'ArrayBuffer' == (a = m(r)) || 'SharedArrayBuffer' == a)) return _t in r ? It(v, r) : At.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, f),
                  S(r)
                    ? r instanceof q || 'ArrayBuffer' == (i = m(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
              ...
              $(x !== Function.prototype ? F(y).concat(F(x)) : F(y), function(t) {
                t in v || h(v, t, y[t]);
              }),
              (v.prototype = w),
              o || (w.constructor = v));
    ...
    t.exports = function(t, n, r, y, g, d) {
      ...
      if (
        ...
        F ||
          ...
          (m.constructor = b)),
          (P || M) && (w('delete'), w('has'), g && w('get')),
          (M || O) && w(_),
          d && m.clear && delete m.clear;
      } else (b = y.getConstructor(n, t, g, _)), u(b.prototype, r), (c.NEED = !0);
      return h(b, t), (S[t] = b), o(o.G + o.W + o.F * (b != x), S), d || y.setStrong(b, t, g), b;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      var x,
        ...
        F = P || m(y),
        M = y ? (w ? m('entries') : F) : void 0,
        I = ('Array' == n && O.entries) || P;
      if (
        (I && (_ = s(I.call(new t()))) !== Object.prototype && _.next && (f(_, S, !0), e || 'function' == typeof _[l] || u(_, l, h)),
        w &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((x = { values: w ? F : m('values'), keys: g ? F : m('keys'), entries: M }), d)) for (b in x) b in O || i(O, b, x[b]);
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      var u = h(+r);
      if (u + n > t[j]) throw w(b);
      for (var c = t[A]._b, a = u + t[k], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (_ = function(t) {
        ...
        (m = function(t, n, r) {
          s(this, m, 'DataView'), s(t, _, 'DataView');
          var e = t[j],
            o = l(n);
          if (o < 0 || o > e) throw w('Wrong offset!');
          if (o + (r = void 0 === r ? e - o : p(r)) > e) throw w('Wrong length!');
          (this[A] = t), (this[k] = o), (this[j] = r);
        }),
        o && (G(_, 'byteLength', '_l'), G(m, 'buffer', '_b'), G(m, 'byteLength', '_l'), G(m, 'byteOffset', '_o')),
        a(m[x], {
          getInt8: function(t) {
    ...
    d(_, 'ArrayBuffer'), d(m, 'DataView'), c(m[x], u.VIEW, !0), (n.ArrayBuffer = _), (n.DataView = m);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
    ...
    var e,
      ...
      A = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === m.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && L(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(w('Promise-chain cycle')) : (i = j(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      $ = function(t, n, r) {
        return (
          ...
          (n = w(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || j(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : j(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== U || !i(B, n) || i(G, n))) {
          var r = A(t, n);
          return !r || !i(B, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = k(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = k(r ? G : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
    ...
    for (var ot = T(v.store), it = 0; ot.length > it; ) g(ot[it++]);
    c(c.S + c.F * !z, 'Symbol', {
      for: function(t) {
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            x = s(p);
          if ((g && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == x || (h == Array && c(x)))) for (r = new h((n = a(p.length))); n > d; d++) f(r, d, g ? y(p[d], d) : p[d]);
          else for (l = x.call(p), r = new h(); !(o = l.next()).done; d++) f(r, d, g ? u(l, y, [o.value, d], !0) : o.value);
          return (r.length = d), r;
        },
      }
    );
    ...
    r(55)('replace', 2, function(t, n, r, v) {
      return [
        ...
        function(t, n) {
          ...
          for (var _, m = '', S = 0, w = 0; w < x.length; w++) {
            b = x[w];
            for (var E = String(b[0]), O = f(s(u(b.index), p.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (_ = b[F]) ? _ : String(_));
            var M = b.groups;
            if (h) {
              var I = [E].concat(P, O, p);
              void 0 !== M && I.push(M);
              var T = String(n.apply(void 0, I));
            } else T = y(E, p, O, P, M, n);
            O >= S && ((m += p.slice(S, O) + T), (S = O + E.length));
          }
          return m + p.slice(S);
        },
      ];
      ...
      return (
        ...
        [
          ...
          function(t, n) {
            ...
            for (var _ = 0, m = 0, S = []; m < p.length; ) {
              x.lastIndex = h ? m : 0;
              var w,
                E = a(x, h ? p : p.slice(m));
              if (null === E || (w = l(c(x.lastIndex + (h ? 0 : m)), p.length)) === _) m = u(p, m, g);
              else {
                if ((S.push(p.slice(_, m)), S.length === b)) return S;
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      b = (t.exports = r(58)('WeakMap', d, x, f, !0, !0));
    p &&
      h &&
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, a, f, s, l, p, h) {
      for (var v, y, g = s, d = 0, x = !!p && u(p, h, 3); d < f; ) {
        if (d in a) {
          if (((v = x ? x(a[d], d, r) : a[d]), (y = !1), o(v) && (y = void 0 !== (y = v[c]) ? !!y : e(v)), y && l > 0)) g = t(n, r, v, i(v.length), g, l - 1) - 1;
          else {
  ...
  function(t, n, r) {
    for (
      ...
      var g,
        ...
        b = u[d],
        _ = b && b.prototype;
      if (_ && (_[s] || c(_, s, p), _[l] || c(_, l, d), (a[d] = p), x)) for (g in e) _[g] || i(_, g, e[g], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        return (
          ...
          (t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, x) : ((t.__proto__ = x), a in t || (t[a] = 'GeneratorFunction')), (t.prototype = Object.create(S)), t;
          }),
          (t.awrap = function(t) {
            return { __await: t };
          }),
    ...
    var e = r(85),
      ...
      a = function t(n, r, a) {
        var f,
          ...
          x = h ? o : o[r] || (o[r] = {}),
          b = x.prototype,
          _ = h ? e : v ? e[r] : (e[r] || {}).prototype;
        for (f in (h && (a = r), a))
          ((s = !p && _ && void 0 !== _[f]) && c(x, f)) ||
            ((l = s ? _[f] : a[f]),
            (x[f] =
    ...
    !(function(t) {
      t.runLogicalStructureTest = function() {
        var n = t.Core.PDFNet,
          r = function(t, n) {
            if (t.str) {
              for (var r = '', e = t.indent, o = 0; o < e; ++o) r += '  ';
              console.log(r + t.str);
            }
            (t.str = ''), (t.indent = n);
          },
          o = (function() {
            var t = e(
              regeneratorRuntime.mark(function t(e, i, u) {
                var c, a, f, s, l, p;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.next = 2), e.isValid();
                      case 2:
                        if (t.sent) {
                          t.next = 4;
                          break;
                      ...
                      case 4:
                        return r(u, i++), (t.t0 = u.str), (t.next = 8), e.getType();
                      case 8:
                        return (t.t1 = t.sent), (u.str = t.t0 += 'Type: ' + t.t1), (t.next = 12), e.hasTitle();
                      case 12:
                        if (!t.sent) {
                          t.next = 18;
                          break;
                        }
                        return (t.t2 = u.str), (t.next = 16), e.getTitle();
                      case 16:
                        (t.t3 = t.sent), (u.str = t.t2 += '. Title: ' + t.t3);
                      case 18:
                        return (t.next = 20), e.getNumKids();
                      case 20:
                        (c = t.sent), (a = 0);
                      case 22:
                        if (!(a < c)) {
                        ...
                        return (t.next = 25), e.isContentItem(a);
                      case 25:
                        if (!t.sent) {
                          t.next = 60;
                          break;
                        }
                        return (t.next = 28), e.getAsContentItem(a);
                      case 28:
                        return (f = t.sent), (t.next = 31), f.getType();
                      case 31:
                        return (s = t.sent), (t.next = 34), f.getPage();
                      case 34:
                        return (l = t.sent), r(u, i), (t.t4 = u.str), (t.next = 39), l.getIndex();
                      case 39:
                        (t.t5 = t.sent),
                          (u.str = t.t4 += 'Content Item. Part of page #' + t.t5),
                          r(u, i),
                          (t.t6 = s),
                          (t.next = t.t6 === n.ContentItem.Type.e_MCID ? 45 : t.t6 === n.ContentItem.Type.e_MCR ? 45 : t.t6 === n.ContentItem.Type.e_OBJR ? 51 : 57);
                        break;
                      case 45:
                        return (t.t7 = u.str), (t.next = 48), f.getMCID();
                      case 48:
                        return (t.t8 = t.sent), (u.str = t.t7 += 'MCID: ' + t.t8), t.abrupt('break', 58);
                      case 51:
                        return (u.str += 'OBJR '), (t.next = 54), f.getRefObj();
                      case 54:
                        return (p = t.sent) && (u.str += '- Referenced Object#: ' + p.getObjNum()), t.abrupt('break', 58);
                      case 57:
                      ...
                      case 58:
                        ...
                        break;
                      case 60:
                        return (t.t9 = o), (t.next = 63), e.getAsStructElem(a);
                      case 63:
                        return (t.t10 = t.sent), (t.t11 = i), (t.t12 = u), (t.next = 68), (0, t.t9)(t.t10, t.t11, t.t12);
                      case 68:
                        ++a, (t.next = 22);
                        break;
                      case 71:
          ...
          i = (function() {
            var t = e(
              regeneratorRuntime.mark(function t(r, e) {
                var o, i, u;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        ...
                        return (t.next = 5), o.getType();
                      case 5:
                        if ((i = t.sent) !== n.Element.Type.e_path && i !== n.Element.Type.e_text && i !== n.Element.Type.e_path) {
                          t.next = 52;
                          break;
                        }
                        (t.t0 = i), (t.next = t.t0 === n.Element.Type.e_path ? 10 : t.t0 === n.Element.Type.e_text ? 12 : t.t0 === n.Element.Type.e_form ? 19 : 21);
                        break;
                      case 10:
                        return (e.str += '\nPATH: '), t.abrupt('break', 21);
                      case 12:
                        return (t.t1 = e.str), (t.next = 15), o.getTextString();
                      case 15:
                        return (t.t2 = t.sent), (t.t3 = '\nTEXT: ' + t.t2), (e.str = t.t1 += t.t3 + '\n'), t.abrupt('break', 21);
                      case 19:
                        return (e.str += '\nFORM XObject: '), t.abrupt('break', 21);
                      case 21:
                        return (t.next = 23), o.getParentStructElement();
                      case 23:
                        return (u = t.sent), (t.next = 26), u.isValid();
                      case 26:
                        if (!t.sent) {
                          t.next = 52;
                          break;
                        }
                        return (t.t4 = e.str), (t.next = 30), u.getType();
                      case 30:
                        return (t.t5 = t.sent), (t.t6 = ' Type: ' + t.t5), (t.t7 = t.t6 + ', MCID: '), (t.next = 35), o.getStructMCID();
                      case 35:
                        return (t.t8 = t.sent), (e.str = t.t4 += t.t7 + t.t8), (t.next = 39), u.hasTitle();
                      case 39:
                        if (!t.sent) {
                          t.next = 45;
                          break;
                        }
                        return (t.t9 = e.str), (t.next = 43), u.getTitle();
                      case 43:
                        (t.t10 = t.sent), (e.str = t.t9 += '. Title: ' + t.t10);
                      case 45:
                        return (t.t11 = e.str), (t.next = 48), u.getSDFObj();
                      case 48:
                        return (t.next = 50), t.sent.getObjNum();
                      case 50:
                        (t.t12 = t.sent), (e.str = t.t11 += ', Obj#: ' + t.t12);
                      case 52:
                        t.next = 0;
                        break;
                      case 54:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        ...
                        return (t.next = 5), o.getStructMCID();
                      case 5:
                        if (((i = t.sent), (t.t0 = i >= 0), !t.t0)) {
                          t.next = 13;
                          break;
                        }
                        return (t.next = 10), o.getType();
                      case 10:
                        (t.t1 = t.sent), (t.t2 = n.Element.Type.e_text), (t.t0 = t.t1 === t.t2);
                      case 13:
                        if (!t.t0) {
                          t.next = 18;
                          break;
                        }
                        return (t.next = 16), o.getTextString();
                      case 16:
                        (u = t.sent), i in e ? (e[i] += u) : (e[i] = u);
                      case 18:
                        t.next = 0;
                        break;
                      case 20:
          ...
          c = (function() {
            var t = e(
              regeneratorRuntime.mark(function t(e, o, i, u) {
                var a, f, s, l, p, h;
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 4:
                        return r(u, i), (t.t0 = u.str), (t.next = 8), e.getType();
                      case 8:
                        return (t.t1 = t.sent), (u.str = t.t0 += '<' + t.t1), (t.next = 12), e.hasTitle();
                      case 12:
                        if (!t.sent) {
                          t.next = 19;
                          break;
                        ...
                        return (t.t2 = u.str), (t.next = 16), e.getTitle();
                      case 16:
                        (t.t3 = t.sent), (t.t4 = ' title="' + t.t3), (u.str = t.t2 += t.t4 + '"');
                      case 19:
                        return (u.str += '>'), (t.next = 22), e.getNumKids();
                      case 22:
                        (a = t.sent), (f = 0);
                      case 24:
                        if (!(f < a)) {
                        ...
                        return (t.next = 27), e.isContentItem(f);
                      case 27:
                        if (!t.sent) {
                          t.next = 49;
                          break;
                        }
                        return (t.next = 30), e.getAsContentItem(f);
                      case 30:
                        return (s = t.sent), (t.next = 33), s.getType();
                      case 33:
                        if (((t.t5 = t.sent), (t.t6 = n.ContentItem.Type.e_MCID), t.t5 !== t.t6)) {
                          t.next = 47;
                          break;
                        }
                        return (t.next = 38), s.getPage();
                      case 38:
                        return (t.next = 40), t.sent.getIndex();
                      case 40:
                        if (((l = t.sent), !(p = o[l]))) {
                          t.next = 47;
                          break;
                        }
                        return (t.next = 45), s.getMCID();
                      case 45:
                        (h = t.sent) in p && (u.str += p[h]);
                      case 47:
                        t.next = 58;
                        break;
                      case 49:
                        return (t.t7 = c), (t.next = 52), e.getAsStructElem(f);
                      case 52:
                        return (t.t8 = t.sent), (t.t9 = o), (t.t10 = i + 1), (t.t11 = u), (t.next = 58), (0, t.t7)(t.t8, t.t9, t.t10, t.t11);
                      case 58:
                        ++f, (t.next = 24);
                        break;
                      case 61:
                        return r(u, i), (t.t12 = u.str), (t.next = 65), e.getType();
                      case 65:
                        (t.t13 = t.sent), (t.t14 = '</' + t.t13), (u.str = t.t12 += t.t14 + '>');
                      case 68:
                      case 'end':
                        return t.stop();
                    }
          ...
          a = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var e, a, f, s, l, p, h, v, y, g, d, x, b, _, m;
                return regeneratorRuntime.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return '../TestFiles/', (e = { str: '' }), (t.prev = 2), (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/tagged.pdf');
                        case 5:
                          return (
                            (a = t.sent).initSecurityHandler(),
                            (f = null),
                            (s = null),
                        ...
                        case 13:
                          return (s = t.sent), (t.next = 16), s.isValid();
                        case 16:
                          if (!t.sent) {
                            t.next = 35;
                            break;
                          }
                          return console.log('Document has a StructTree root.'), (l = 0), (t.next = 21), s.getNumKids();
                        case 21:
                          p = t.sent;
                        case 22:
                          if (!(l < p)) {
                          ...
                          return (t.t0 = o), (t.next = 26), s.getKid(l);
                        case 26:
                          return (t.t1 = t.sent), (t.t2 = e), (t.next = 30), (0, t.t0)(t.t1, 0, t.t2);
                        case 30:
                          ++l, (t.next = 22);
                          break;
                        case 33:
                        ...
                        case 36:
                          return (
                            ...
                            (t.next = 43),
                            n.ElementReader.create()
                          );
                        case 43:
                          return (f = t.sent), (t.next = 46), a.getPageIterator();
                        case 46:
                          h = t.sent;
                        case 47:
                          return (t.next = 49), h.hasNext();
                        case 49:
                          if (!t.sent) {
                            t.next = 61;
                            break;
                          }
                          return (t.t3 = f), (t.next = 53), h.current();
                        case 53:
                          return (t.t4 = t.sent), t.t3.beginOnPage.call(t.t3, t.t4), (t.next = 57), i(f, e);
                        case 57:
                          f.end();
                        case 58:
                          h.next(), (t.next = 47);
                        ...
                        case 68:
                          y = t.sent;
                        case 69:
                          return (t.next = 71), y.hasNext();
                        case 71:
                          if (!t.sent) {
                            t.next = 87;
                            break;
                          }
                          return (t.next = 74), y.current();
                        case 74:
                          return (g = t.sent), f.beginOnPage(g), (t.next = 78), g.getIndex();
                        case 78:
                          return (d = t.sent), (x = {}), (v[d] = x), (t.next = 83), u(f, x);
                        case 83:
                          f.end();
                        case 84:
                          y.next(), (t.next = 69);
                          break;
                        case 87:
                          return (t.next = 89), a.getStructTree();
                        case 89:
                          return (s = t.sent), (t.next = 92), s.isValid();
                        case 92:
                          if (!t.sent) {
                            t.next = 109;
                            break;
                          }
                          return (b = 0), (t.next = 96), s.getNumKids();
                        case 96:
                          _ = t.sent;
                        case 97:
                          if (!(b < _)) {
                          ...
                          return (t.t5 = c), (t.next = 101), s.getKid(b);
                        case 101:
                          return (t.t6 = t.sent), (t.t7 = v), (t.t8 = e), (t.next = 106), (0, t.t5)(t.t6, t.t7, 0, t.t8);
                        case 106:
                          ++b, (t.next = 97);
                          break;
                        case 109:
                          return r(e, 0), console.log('Done 3.'), (t.next = 113), a.saveMemoryBuffer(0);
                        case 113:
                          (m = t.sent), saveBufferAsPDFDoc(m, 'bookmark.pdf'), (t.next = 120);
                          break;
                        case 117:
                          (t.prev = 117), (t.t9 = t.catch(2)), console.log(t.t9);
                        case 120:
                        case 'end':
                          return t.stop();
                      }
