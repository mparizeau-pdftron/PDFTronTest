!(function(t) {
  ...
  function(t, n, e) {
    ...
    function R(t, n, e) {
      ...
      for (
        (t = O(t)) != t || t === F
          ...
          : ((r = A(k(t) / D)),
            t * (o = E(2, -r)) < 1 && (r--, (o *= 2)),
            (t += r + s >= 1 ? f / o : f * E(2, 1 - s)) * o >= 2 && (r++, (o /= 2)),
            r + s >= a ? ((i = 0), (r = a)) : r + s >= 1 ? ((i = (t * o - 1) * E(2, n)), (r += s)) : ((i = t * E(2, s - 1) * E(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & i, i /= 256, n -= 8
      );
    ...
    function H(t, n, e, r, i, o) {
      var u = h(+e);
      if (u + n > t[T]) throw _(x);
      for (var c = t[M]._b, a = u + t[j], s = r(+i), f = 0; f < n; f++) c[a + f] = s[o ? f : n - f - 1];
    }
    if (u.ABV) {
      if (
        !s(function() {
      ...
      (b = function(t) {
        ...
        (S = function(t, n, e) {
          ...
          if (i + (e = void 0 === e ? r - i : p(e)) > r) throw _('Wrong length!');
          (this[M] = t), (this[j] = i), (this[T] = e);
        }),
        i && (U(b, 'byteLength', '_l'), U(S, 'buffer', '_b'), U(S, 'byteLength', '_l'), U(S, 'byteOffset', '_o')),
        a(S[m], {
          getInt8: function(t) {
    ...
    y(b, 'ArrayBuffer'), y(S, 'DataView'), c(S[m], u.VIEW, !0), (n.ArrayBuffer = b), (n.DataView = S);
  },
  function(t, n) {
    var e = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = e);
    ...
    (function(t) {
      ...
      var e = (function(t) {
              ...
              return function(i, o) {
                ...
                for (e.method = i, e.arg = o; ; ) {
                  ...
                  if ('next' === e.method) e.sent = e._sent = e.arg;
                    ...
                    if (r === l) throw ((r = g), e.arg);
                    e.dispatchException(e.arg);
                  } else 'return' === e.method && e.abrupt('return', e.arg);
                  r = h;
                  var a = f(t, n, e);
                  if ('normal' === a.type) {
                    if (((r = e.done ? g : p), a.arg === v)) continue;
                    return { value: a.arg, done: e.done };
                  }
                  'throw' === a.type && ((r = g), (e.method = 'throw'), (e.arg = a.arg));
                }
              };
            })(t, e, u)),
            o
        ...
        var b = Object.getPrototypeOf,
          S = b && b(b(k([])));
        S && S !== r && i.call(S, u) && (x = S);
        var w = (m.prototype = d.prototype = Object.create(x));
        function _(t) {
