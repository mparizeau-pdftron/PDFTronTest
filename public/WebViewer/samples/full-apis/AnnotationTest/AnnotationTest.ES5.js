!(function(t) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Rt = function(t) {
          ...
          for (l && a > 2 && (s = f(s, arguments[2], 2)), n = 0, e = d(u.length), o = Ct(this, e); e > n; n++) o[n] = l ? s(u[n], n) : u[n];
          return o;
        },
        It = function() {
        ...
        (t.exports = function(t, n, e, r) {
          ...
          S
            ? ((v = e(function(t, e, r, o) {
                ...
                for (h(t, '_d', { b: i, o: p, l: c, e: u, v: new K(i) }); f < u; ) A(t, f++);
              })),
              (P = v.prototype = _(Ut)),
              h(P, 'constructor', v))
            : (c(function() {
  ...
  function(t, n, e) {
    ...
    function M(t, n, e) {
      ...
      for (
        (t = E(t)) != t || t === A
          ...
          : ((r = O(F(t) / k)),
            t * (i = C(2, -r)) < 1 && (r--, (i *= 2)),
            (t += r + s >= 1 ? f / i : f * C(2, 1 - s)) * i >= 2 && (r++, (i /= 2)),
            r + s >= a ? ((o = 0), (r = a)) : r + s >= 1 ? ((o = (t * i - 1) * C(2, n)), (r += s)) : ((o = t * C(2, s - 1) * C(2, n)), (r = 0)));
        n >= 8;
        c[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, e, r, o, i) {
      var c = h(+e);
      if (c + n > t[I]) throw P(S);
      for (var u = t[R]._b, a = c + t[L], s = r(+o), f = 0; f < n; f++) u[a + f] = s[i ? f : n - f - 1];
    }
    if (c.ABV) {
      if (
        !s(function() {
      ...
      (b = function(t) {
        ...
        (m = function(t, n, e) {
          ...
          if (o + (e = void 0 === e ? r - o : p(e)) > r) throw P('Wrong length!');
          (this[R] = t), (this[L] = o), (this[I] = e);
        }),
    ...
    g(b, 'ArrayBuffer'), g(m, 'DataView'), u(m[x], c.VIEW, !0), (n.ArrayBuffer = b), (n.DataView = m);
  },
  function(t, n) {
    var e = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = e);
  ...
  function(t, n, e) {
    ...
    var o = e(1),
      ...
      nt = function(t) {
        for (var n, e = t === G, r = L(e ? U : w(t)), o = [], c = 0; r.length > c; ) !i(V, (n = r[c++])) || (e && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (M = function() {
          ...
          return c && Y && H(G, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (e(45).f = Q),
      (O.f = nt),
      c && !e(30) && a(G, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return $(v(t));
      })),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, m = '', w = 0, P = 0; P < x.length; P++) {
            S = x[P];
            for (var A = String(S[0]), _ = s(f(c(S.index), p.length), 0), E = [], C = 1; C < S.length; C++) E.push(void 0 === (b = S[C]) ? b : String(b));
            var O = S.groups;
            if (h) {
          ...
          ''.split(/.?/).length
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = s.call(v, o)) &&
                  !((c = v.lastIndex) > l && (a.push(o.slice(l, i.index)), i.length > 1 && i.index < o.length && p.apply(a, i.slice(1)), (u = i[0].length), (l = c), a.length >= h));

                )
                  v.lastIndex === i.index && v.lastIndex++;
                return l === o.length ? (!u && v.test('')) || a.push('') : a.push(o.slice(l)), a.length > h ? a.slice(0, h) : a;
              }
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, m = 0, w = []; m < p.length; ) {
              ...
              var P,
                A = a(x, h ? p : p.slice(m));
              if (null === A || (P = l(u(x.lastIndex + (h ? 0 : m)), p.length)) === b) m = c(p, m, d);
              else {
    ...
    (function(t) {
      ...
      var e = (function(t) {
        ...
        var b = Object.getPrototypeOf,
          m = b && b(b(F([])));
        m && m !== r && o.call(m, c) && (S = m);
        var w = (x.prototype = d.prototype = Object.create(S));
        function P(t) {
        ...
        return (
          ...
          (O.prototype = {
            ...
            abrupt: function(t, n) {
              ...
              return (c.type = t), (c.arg = n), i ? ((this.method = 'next'), (this.next = i.finallyLoc), y) : this.complete(c);
            },
            ...
            finish: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                ...
                if (e.finallyLoc === t) return this.complete(e.completion, e.afterLoc), C(e), y;
              }
            },
            catch: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = e), y;
            },
          }),
          t
        );
                ...
                case 0:
                  (e = t.Core.PDFNet),
                            ...
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  ...
                                  case 18:
                                    return (c = t.sent), (t.next = 21), c.put('Annots', i);
                                  case 21:
                                    return (t.next = 23), n.createIndirectDict();
                                  case 23:
                                    return (u = t.sent), (t.next = 26), u.putName('Subtype', 'Text');
                                  case 26:
                                    return (t.next = 28), u.putBool('Open', !0);
                                  case 28:
                                    return (t.next = 30), u.putString('Contents', 'The quick brown fox ate the lazy mouse.');
                                  case 30:
                                    return (t.next = 32), u.putRect('Rect', 266, 116, 430, 204);
                                  case 32:
                                    return (t.next = 34), i.pushBack(u);
                                  case 34:
                    ...
                    (i = (function() {
                      var t = r(
                        regeneratorRuntime.mark(function t(n) {
                          var r, o, i, c, u, a, s, f, l, p, h, v, y, d, g, x, S, b, m, w, P, A, _, E, C, O, F, k, R, I, L, M, T;
                          return regeneratorRuntime.wrap(function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                ...
                                case 18:
                                  return (c = t.sent), (t.next = 21), c.getNumAnnots();
                                case 21:
                                  (u = t.sent), (a = 0);
                                case 23:
                                  if (!(a < u)) {
                              ...
                              switch ((t.prev = t.next)) {
                                ...
                                case 10:
                                  return (
                                    (c = t.sent),
                                    n.pagePushBack(c),
                                    r.beginOnPage(c, e.ElementWriter.WriteMode.e_overlay, !1),
                                    r.end(),
                                    (t.next = 16),
                                ...
                                case 21:
                                  return (a = t.sent), (t.next = 24), u.setBorderStyle(a, !0);
                                case 24:
                                  return (t.next = 26), u.setQuaddingFormat(0);
                                case 26:
                                  return (t.next = 28), c.annotPushBack(u);
                                case 28:
                                  return (t.next = 30), u.refreshAppearance();
                                case 30:
                                ...
                                case 53:
                                  return (t.next = 55), c.annotPushBack(s);
                                case 55:
                                ...
                                case 76:
                                  return (t.next = 78), c.annotPushBack(p);
                                case 78:
                                ...
                                case 601:
                                  return (ct = t.sent), (t.t66 = ct), (t.next = 605), e.ColorPt.init(1, 1, 0);
                                case 605:
                                  return (
                                    (t.t67 = t.sent),
                                    t.t66.setColor.call(t.t66, t.t67),
                                    ct.setIcon(e.SoundAnnot.Icon.e_Mic),
                                ...
                                case 612:
                                  (ut = t.sent), r.beginOnPage(ut), r.end(), n.pagePushBack(ut), (at = 0);
                                case 617:
                                  if (!(at < 2)) {
                                    t.next = 641;
                                    break;
                                ...
                                case 629:
                                  (t.t69 = t.sent),
                                    ...
                                    0 === at || (ut.annotPushBack(pt), pt.refreshAppearance());
                                case 635:
                                  lt++, (t.next = 621);
                                  break;
                                case 638:
                                ...
                                case 643:
                                  return (
                                    (ht = t.sent).setIconName('UserStamp'), ht.setContents('User defined stamp'), ut.annotPushBack(ht), ht.refreshAppearance(), (t.next = 650), e.endDeallocateStack()
                                  );
                                case 650:
                                case 'end':
                                  return t.stop();
                            ...
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  ...
                                  case 12:
                                    return (u = t.sent), saveBufferAsPDFDoc(u, 'annotation_test1.pdf'), console.log('Done. Results saved in annotation_test1.pdf'), (t.next = 17), r.getPage(1);
                                  case 17:
                                  ...
                                  case 27:
                                    return (s = t.sent).lock(), (t.next = 31), c(s);
                                  case 31:
