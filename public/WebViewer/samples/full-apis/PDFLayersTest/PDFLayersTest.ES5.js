!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), x = r(c, v, 3), b = u(m.length), S = 0, w = e ? p(n, b) : a ? p(n, 0) : void 0; b > S; S++)
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Wt = function(t, n) {
          return Bt(t, (n = x(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Gt = function(t, n, e) {
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: kt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
        ...
        (t.exports = function(t, n, e, r) {
          ...
          x
            ? ((v = e(function(t, e, r, o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new $(i) }); s < c; ) O(t, s++);
              })),
              (_ = v.prototype = E(Vt)),
              p(_, 'constructor', v))
            : (u(function() {
      ...
      if (!p || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var y = /./[h],
          g = e(u, h, ''[t], function(t, n, e, r, o) {
            return n.exec === a ? (p && !o ? { done: !0, value: y.call(n, e, r) } : { done: !0, value: t.call(e, n, r) }) : { done: !1 };
          }),
          d = g[0],
          m = g[1];
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, g, d) {
      ...
      if (
        (A && (b = s(A.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), r || 'function' == typeof b[l] || u(b, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((O = !0),
  ...
  function(t, n, e) {
    ...
    function z(t, n, e, r, o, i) {
      ...
      for (var c = t[I]._b, a = u + t[T], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      e(2)(function() {
        ...
        ? function(t, n) {
            for (var e = c(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s; )
              for (var p, v = a(arguments[s++]), y = l ? o(v).concat(l(v)) : o(v), g = y.length, d = 0; g > d; ) (p = y[d++]), (r && !h.call(v, p)) || (e[p] = v[p]);
            return e;
          }
        : f;
  },
    ...
    t.exports = {
      ...
      def: function(t, n, e) {
        var r,
          o,
          i = g(t, n);
        return i ? (i.v = e) : ((t._l = i = { i: (o = p(n, !0)), k: n, v: e, p: (r = t._l), n: void 0, r: !1 }), t._f || (t._f = i), r && (r.n = i), t[y]++, 'F' !== o && (t._i[o] = i)), t;
      },
      getEntry: g,
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            d = 0,
            m = s(h);
          if ((g && (y = r(y, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (e = new p((n = a(h.length))); n > d; d++) f(e, d, g ? y(h[d], d) : h[d]);
          else for (l = m.call(h), e = new p(); !(o = l.next()).done; d++) f(e, d, g ? u(l, y, [o.value, d], !0) : o.value);
          return (e.length = d), e;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var O = String(x[0]), E = f(s(u(x.index), h.length), 0), P = [], F = 1; F < x.length; F++) P.push(void 0 === (b = x[F]) ? b : String(b));
            var M = x.groups;
            if (p) {
              var A = [O].concat(P, E, h);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(O, h, E, P, M, n);
            E >= w && ((S += h.slice(w, E) + j), (w = E + O.length));
          }
          return S + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                O = a(m, p ? h : h.slice(S));
              if (null === O || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === b) S = u(h, S, g);
              else {
  ...
  function(t, n, e) {
    for (
      ...
      var g,
        ...
        x = u[d],
        b = x && x.prototype;
      if (b && (b[s] || c(b, s, h), b[l] || c(b, l, d), (a[d] = h), m)) for (g in r) b[g] || i(b, g, r[g], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
            ...
            (i._invoke = (function(t, n, e) {
              ...
              return function(o, i) {
                ...
                for (e.method = o, e.arg = i; ; ) {
                  ...
                  var a = s(t, n, e);
                  if ('normal' === a.type) {
                    if (((r = e.done ? v : h), a.arg === y)) continue;
          ...
          (M.prototype = {
            ...
            finish: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                ...
                if (e.finallyLoc === t) return this.complete(e.completion, e.afterLoc), F(e), y;
              }
            },
            catch: function(t) {
              for (var n = this.tryEntries.length - 1; n >= 0; --n) {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = e), y;
            },
          }),
          t
        );
                ...
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 36:
                        return (h = t.sent).putName('Subtype', 'Form'), h.put('OC', r), h.putRect('BBox', 0, 0, 1e3, 1e3), (t.next = 42), n.endDeallocateStack();
                      case 42:
                ...
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 43:
                        return (h = t.sent).putName('Subtype', 'Form'), h.put('OC', r), h.putRect('BBox', 0, 0, 1e3, 1e3), (t.next = 49), n.endDeallocateStack();
                      case 49:
                        return t.abrupt('return', h);
                      case 50:
                      case 'end':
          ...
          c = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, c, a, f, s, l, h, p, v, y, g, d, m, x, b, S, w, _, O, E, P, F, M, A, j;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 26:
                          return (h = t.sent).beginOnPage(s), (t.t0 = r), (t.t1 = o), (t.next = 32), c.getSDFObj();
                        case 32:
                          return (t.t2 = t.sent), (t.next = 35), (0, t.t0)(t.t1, t.t2);
                        case 35:
                          return (p = t.sent), (t.next = 38), l.createFormFromStream(p);
                        case 38:
                          return (v = t.sent), h.writeElement(v), (t.t3 = i), (t.t4 = o), (t.next = 44), f.getSDFObj();
                        case 44:
                          return (t.t5 = t.sent), (t.next = 47), (0, t.t3)(t.t4, t.t5);
                        case 47:
                          return (y = t.sent), (t.next = 50), l.createFormFromStream(y);
                        case 50:
                          (v = t.sent), h.writeElement(v), (t.next = 86);
                          break;
                        case 57:
                        ...
                        case 97:
                          v = t.sent;
                        case 98:
                          return h.writeElement(v), (t.t22 = l), (t.next = 102), s.getPageWidth();
                        case 102:
                        ...
                        case 113:
                          return t.sent.setLineWidth(40), h.writeElement(v), h.end(), o.pagePushBack(s), (t.next = 120), o.getViewPrefs();
                        case 120:
