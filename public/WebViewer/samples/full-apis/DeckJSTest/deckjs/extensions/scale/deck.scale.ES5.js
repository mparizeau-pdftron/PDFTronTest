          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || k(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : k(t, n, r)
        );
      },
      X = function(t, n) {
        m(t);
      ...
      (f(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
          return u && q && H(V, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        f = function(t, n) {
          var r = t.children();
          r.hasClass('loading') || r.hasClass(n.classes.scaleSlideWrapper) || r.wrapAll('<div class="' + n.classes.scaleSlideWrapper + '"/>');
        },
        a = function() {
          var n = t.deck('getOptions'),
            r = n.baseHeight,
            e = t.deck('getContainer'),
            o = r || e.height();
          t.each(i, function(r, i) {
            f(i, n);
            var u = i.innerHeight(),
              c = i.find('.' + n.classes.scaleSlideWrapper),
              a = e.hasClass(n.classes.scale) ? o / u : 1;
            t.each('Webkit Moz O ms Khtml'.split(' '), function(t, n) {
              1 === a ? c.css(n + 'Transform', '') : c.css(n + 'Transform', 'scale(' + a + ')');
            });
          });
        };
      t.extend(!0, t.deck.defaults, { classes: { scale: 'deck-scale', scaleSlideWrapper: 'deck-slide-scaler' }, keys: { scale: 83 }, baseHeight: null, scaleDebounce: 200 }),
        t.deck('extend', 'disableScale', function() {
          t.deck('getContainer').removeClass(t.deck('getOptions').classes.scale), a();
        }),
        t.deck('extend', 'enableScale', function() {
          t.deck('getContainer').addClass(t.deck('getOptions').classes.scale), a();
        }),
        t.deck('extend', 'toggleScale', function() {
          var n = t.deck('getContainer');
          t.deck(n.hasClass(t.deck('getOptions').classes.scale) ? 'disableScale' : 'enableScale');
        }),
        u.bind('deck.init', function() {
          var n = t.deck('getOptions'),
            e = t
              ...
              .join(', ');
          (i = []),
            t.each(t.deck('getSlides'), function(t, r) {
              r.parentsUntil(n.selectors.container, e).length || i.push(r);
            }),
            t.each(i, function(t, r) {
              f(r, n);
            }),
            c
              .unbind('resize.deckscale')
              .bind('resize.deckscale', function() {
                r.clearTimeout(o), (o = r.setTimeout(a, n.scaleDebounce));
              })
              .unbind('load.deckscale')
              .bind('load.deckscale', a),
            u.unbind('keydown.deckscale').bind('keydown.deckscale', function(r) {
              (r.which === n.keys.scale || t.inArray(r.which, n.keys.scale) > -1) && (t.deck('toggleScale'), r.preventDefault());
            }),
            t.deck('enableScale');
        });
    })(jQuery, 0, this);
