    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || k(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : k(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        c = function(n) {
          ...
          t.each(e, function(n, e) {
            if (e.attr('id') === r) return t.deck('go', n), !1;
          }),
            t
              .deck('getContainer')
              .scrollLeft(0)
      ...
      t.extend(!0, t.deck.defaults, { selectors: { hashLink: '.deck-permalink' }, hashPrefix: 'slide-', preventFragmentScroll: !0 }),
        i
          .bind('deck.init', function() {
            var n = t.deck('getOptions');
            (o = t()),
              (slides = t.deck('getSlides')),
              t.each(slides, function(e, i) {
                var u;
                (i.attr('id') && i.data('deckAssignedId') !== i.attr('id')) || (i.attr('id', n.hashPrefix + e), i.data('deckAssignedId', n.hashPrefix + e)),
                  (u = '#' + i.attr('id')) === r.location.hash && t.deck('go', e),
                  (o = o.add('a[href="' + u + '"]'));
              }),
              Modernizr.hashchange ||
                o.unbind('click.deckhash').bind('click.deckhash', function(n) {
                  c(t(this).attr('href'));
                }),
              slides.length && t.deck('getContainer').addClass(n.classes.onPrefix + t.deck('getSlide').attr('id'));
          })
          .bind('deck.change', function(n, e, o) {
            var i = '#' + t.deck('getSlide', o).attr('id'),
              u = r.location.href.replace(/#.*/, '') + i,
              c = t.deck('getOptions'),
              f = c.classes.onPrefix,
              a = t.deck('getContainer');
            a.removeClass(f + t.deck('getSlide', e).attr('id')),
              a.addClass(f + t.deck('getSlide', o).attr('id')),
              t(c.selectors.hashLink).attr('href', u),
              Modernizr.history && r.history.replaceState({}, '', u);
          }),
        u
          .bind('hashchange.deckhash', function(t) {
            t.originalEvent && t.originalEvent.newURL ? c(t.originalEvent.newURL) : c(r.location.hash);
          })
          .bind('load', function() {
            t.deck('getOptions').preventFragmentScroll &&
              t
                .deck('getContainer')
                .scrollLeft(0)
                .scrollTop(0);
