!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
...
*/
    ...
    (r = jQuery),
      ...
      (o = function(t, n, e) {
        ...
        r(o.selectors.statusCurrent).text(o.countNested ? e + 1 : r.deck('getSlide', e).data('rootSlide'));
      }),
      r.extend(!0, r.deck.defaults, { selectors: { statusCurrent: '.deck-status-current', statusTotal: '.deck-status-total' }, countNested: !0 }),
      e
        .bind('deck.init', function() {
          var t,
            ...
            e = r.deck('getSlides'),
            i = r.deck('getSlide');
          if (n.countNested) r(n.selectors.statusTotal).text(e.length);
          else {
            var u = 1,
              c = r
                ...
                .join(', ');
            r.each(e, function(t, r) {
              var e = r.parentsUntil(n.selectors.container, c);
              r.data('rootSlide', e.length ? e.last().data('rootSlide') : u++);
            }),
              r(n.selectors.statusTotal).text(u - 1);
          }
