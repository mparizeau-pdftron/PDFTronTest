!(function(t) {
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, f = u + t[N], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || k(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : k(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
...
*/
    ...
    (r = jQuery),
      (e = r(document)),
      r.extend(!0, r.deck.defaults, {
        classes: { goto: 'deck-goto' },
        selectors: { gotoDatalist: '#goto-datalist', gotoForm: '.goto-form', gotoInput: '#goto-slide' },
        keys: { goto: 71 },
        countNested: !0,
      }),
      r.deck('extend', 'showGoTo', function() {
        r.deck('getContainer').addClass(r.deck('getOptions').classes.goto), r(r.deck('getOptions').selectors.gotoInput).focus();
      }),
      r.deck('extend', 'hideGoTo', function() {
        r(r.deck('getOptions').selectors.gotoInput).blur(), r.deck('getContainer').removeClass(r.deck('getOptions').classes.goto);
      }),
      r.deck('extend', 'toggleGoTo', function() {
        r.deck(r.deck('getContainer').hasClass(r.deck('getOptions').classes.goto) ? 'hideGoTo' : 'showGoTo');
      }),
      e.bind('deck.init', function() {
        var t = r.deck('getOptions'),
          n = r(t.selectors.gotoDatalist),
          o = r
            .map([t.classes.before, t.classes.previous, t.classes.current, t.classes.next, t.classes.after], function(t, n) {
              return '.' + t;
            })
            .join(', '),
          i = 1;
        e.unbind('keydown.deckgoto').bind('keydown.deckgoto', function(t) {
          var n = r.deck('getOptions').keys.goto;
          (t.which === n || r.inArray(t.which, n) > -1) && (t.preventDefault(), r.deck('toggleGoTo'));
        }),
          r.each(r.deck('getSlides'), function(r, e) {
            var u = e.attr('id'),
              c = e.parentsUntil(t.selectors.container, o);
            u && n.append('<option value="' + u + '">'), c.length ? e.removeData('rootIndex') : t.countNested || (e.data('rootIndex', i), ++i);
          }),
          r(t.selectors.gotoForm)
            .unbind('submit.deckgoto')
            .bind('submit.deckgoto', function(t) {
              var n = r(r.deck('getOptions').selectors.gotoInput),
                e = parseInt(n.val(), 10);
              if (!r.deck('getOptions').countNested) {
                if (e >= i) return !1;
                r.each(r.deck('getSlides'), function(t, n) {
                  if (n.data('rootIndex') === e) return (e = t + 1), !1;
                });
              }
              r.deck('go', isNaN(e) ? n.val() : e - 1), r.deck('hideGoTo'), n.val(''), t.preventDefault();
            }),
          r(t.selectors.gotoInput)
            .unbind('keydown.deckgoto')
            .bind('keydown.deckgoto', function(t) {
              t.stopPropagation();
            });
      });
  },
