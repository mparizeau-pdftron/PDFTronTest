!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Ct),
        p(Bt, yt, Ct.values),
        v(Bt, { slice: Rt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || k(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : k(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      Q = function(t) {
        ...
        return !(this === V && i(U, t) && !i(B, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, D) && this[D][t])) || n);
      },
      Z = function(t, n) {
      ...
      (f(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
...
*/
    ...
    (r = jQuery),
      (e = r(document)),
      (o = function(t, n, e) {
        var o = r.deck('getOptions'),
          i = r.deck('getSlides').length - 1,
          u = r.deck('getSlide', e - 1),
          c = r.deck('getSlide', e + 1),
          f = window.location.href.replace(/#.*/, ''),
          a = u ? u.attr('id') : void 0,
          s = c ? c.attr('id') : void 0;
        r(o.selectors.previousLink)
          .toggleClass(o.classes.navDisabled, !e)
          .attr('href', f + '#' + (a || '')),
          r(o.selectors.nextLink)
            .toggleClass(o.classes.navDisabled, e === i)
            .attr('href', f + '#' + (s || ''));
      }),
      r.extend(!0, r.deck.defaults, { classes: { navDisabled: 'deck-nav-disabled' }, selectors: { nextLink: '.deck-next-link', previousLink: '.deck-prev-link' } }),
      e
        .bind('deck.init', function() {
          var t,
            ...
            e = r.deck('getSlides'),
            i = r.deck('getSlide');
          r(n.selectors.previousLink)
            .unbind('click.decknavigation')
            .bind('click.decknavigation', function(t) {
              r.deck('prev'), t.preventDefault();
            }),
            r(n.selectors.nextLink)
              .unbind('click.decknavigation')
              .bind('click.decknavigation', function(t) {
                r.deck('next'), t.preventDefault();
              }),
