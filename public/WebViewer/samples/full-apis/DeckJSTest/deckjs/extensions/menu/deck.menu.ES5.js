!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : kt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[k]._b, f = u + t[N], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && R(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = I(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || I(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : I(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (S = b[M]) ? S : String(S));
            var F = b.groups;
            if (p) {
...
*/
    ...
    (r = jQuery),
      (o = r(document)),
      r.extend(!0, r.deck.defaults, { classes: { menu: 'deck-menu' }, keys: { menu: 77 }, touch: { doubletapWindow: 400 } }),
      r.deck('extend', 'showMenu', function() {
        var t = r.deck('getContainer'),
          n = r.deck('getOptions');
        t.hasClass(n.classes.menu) ||
          (t.addClass([n.classes.loading, n.classes.menu].join(' ')),
          Modernizr.csstransforms &&
            r.each(e, function(t, n) {
              n.data('oldStyle', n.attr('style')), n.css({ position: 'absolute', left: (t % 4) * 25 + '%', top: 25 * Math.floor(t / 4) + '%' });
            }),
          window.setTimeout(function() {
            t.removeClass(n.classes.loading).scrollTop(r.deck('getSlide').offset().top);
          }, 0));
      }),
      r.deck('extend', 'hideMenu', function() {
        var t = r.deck('getContainer'),
          n = r.deck('getOptions');
        t.hasClass(n.classes.menu) &&
          (t.removeClass(n.classes.menu),
          t.addClass(n.classes.loading),
          Modernizr.csstransforms &&
            r.each(e, function(t, n) {
              var r = n.data('oldStyle');
              n.attr('style', r || '');
            }),
          window.setTimeout(function() {
            t.removeClass(n.classes.loading).scrollTop(0);
          }, 0));
      }),
      r.deck('extend', 'toggleMenu', function() {
        r.deck('getContainer').hasClass(r.deck('getOptions').classes.menu) ? r.deck('hideMenu') : r.deck('showMenu');
      }),
      o
        .bind('deck.init', function() {
          var t,
            ...
            i = 0,
            u = r
              .map([n.classes.before, n.classes.previous, n.classes.current, n.classes.next, n.classes.after], function(t, n) {
                return '.' + t;
              })
              .join(', ');
          (e = []),
            r.each(r.deck('getSlides'), function(t, r) {
              r.parentsUntil(n.selectors.container, u).length || e.push(r);
            }),
            o.unbind('keydown.deckmenu').bind('keydown.deckmenu', function(t) {
              (t.which === n.keys.menu || r.inArray(t.which, n.keys.menu) > -1) && (r.deck('toggleMenu'), t.preventDefault());
            }),
            r
              .deck('getContainer')
              .unbind('touchstart.deckmenu')
              .bind('touchstart.deckmenu', function(n) {
                t = r.deck('getSlide');
              })
              .unbind('touchend.deckmenu')
              .bind('touchend.deckmenu', function(e) {
                var o = Date.now();
                t === r.deck('getSlide') && (o - i < n.touch.doubletapWindow && (r.deck('toggleMenu'), e.preventDefault()), (i = o));
              }),
            r.each(r.deck('getSlides'), function(t, e) {
              e.unbind('click.deckmenu').bind('click.deckmenu', function(e) {
                r.deck('getContainer').hasClass(n.classes.menu) && (r.deck('go', t), r.deck('hideMenu'), e.stopPropagation(), e.preventDefault());
              });
            });
        })
        .bind('deck.change', function(t, n, e) {
          var o = r.deck('getContainer');
          o.hasClass(r.deck('getOptions').classes.menu) && o.scrollTop(r.deck('getSlide', e).offset().top);
        });
  },
]);
