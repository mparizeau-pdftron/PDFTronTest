!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = P(t)) != t || t === E
          ...
          : ((e = M(A(t) / j)),
            t * (i = F(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + a >= 1 ? s / i : s * F(2, 1 - a)) * i >= 2 && (e++, (i /= 2)),
            e + a >= f ? ((o = 0), (e = f)) : e + a >= 1 ? ((o = (t * i - 1) * F(2, n)), (e += a)) : ((o = t * F(2, a - 1) * F(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function Y(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[k]) throw _(m);
      for (var c = t[I]._b, f = u + t[T], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
      ...
      (x = function(t) {
        ...
        (S = function(t, n, r) {
          ...
          (this[I] = t), (this[T] = o), (this[k] = r);
        }),
        o && (B(x, 'byteLength', '_l'), B(S, 'buffer', '_b'), B(S, 'byteLength', '_l'), B(S, 'byteOffset', '_o')),
        f(S[b], {
          getInt8: function(t) {
    ...
    g(x, 'ArrayBuffer'), g(S, 'DataView'), c(S[b], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = S);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && R(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = k(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || k(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : k(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      (f(
        (N = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = f(b, p ? h : h.slice(S));
              if (null === E || (_ = l(c(b.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
  ...
  function(t, n, r) {
    (function(t) {
      ...
      var r = (function(t) {
        ...
        var w = (b.prototype = d.prototype = Object.create(m));
        function _(t) {
        ...
        return (
          (g.prototype = w.constructor = b),
          (b.constructor = g),
          (b[f] = g.displayName = 'GeneratorFunction'),
...
*/
    !(function(t, n, r, e) {
      var o,
        ...
        h = function() {
          var n = s.classes,
            r = s.selectors.container,
            e = u.data('onSlide'),
            c = t();
          u
            .removeClass(n.onPrefix + e)
            .addClass(n.onPrefix + i)
            .data('onSlide', i),
            t('.' + n.current)
              .parentsUntil(r)
              .removeClass(n.childCurrent),
            o[i].parentsUntil(r).addClass(n.childCurrent),
            t.each(o, function(t, n) {
              c = c.add(n);
            }),
            c.removeClass([n.before, n.previous, n.current, n.next, n.after].join(' ')),
            o[i].addClass(n.current),
            i > 0 && o[i - 1].addClass(n.previous),
            i + 1 < o.length && o[i + 1].addClass(n.next),
            i > 1 &&
              t.each(o.slice(0, i - 1), function(t, r) {
                r.addClass(n.before);
              }),
            i + 2 < o.length &&
              t.each(o.slice(i + 2), function(t, r) {
                r.addClass(n.after);
              });
        },
        p = {
          init: function(n, r) {
            ...
            (s = t.extend(!0, {}, t.deck.defaults, r)),
              (o = []),
              (i = 0),
              (u = t(s.selectors.container)),
              (c = s.touch.swipeTolerance),
              l.trigger(f),
              u.addClass(s.classes.loading),
              t.isArray(n)
              ...
              l
                .unbind('keydown.deck')
                .bind('keydown.deck', function(n) {
                  n.which === s.keys.next || t.inArray(n.which, s.keys.next) > -1
                    ? (p.next(), n.preventDefault())
                    : (n.which === s.keys.previous || t.inArray(n.which, s.keys.previous) > -1) && (p.prev(), n.preventDefault());
                })
                .undelegate('input, textarea, select, button, meter, progress, [contentEditable]', 'keydown', v)
                .delegate('input, textarea, select, button, meter, progress, [contentEditable]', 'keydown', v),
              u
                .unbind('touchstart.deck')
                .bind('touchstart.deck', function(n) {
                  e || (e = t.extend({}, n.originalEvent.targetTouches[0]));
                })
                .unbind('touchmove.deck')
                .bind('touchmove.deck', function(n) {
                  t.each(n.originalEvent.changedTouches, function(n, r) {
                    if (e && r.identifier === e.identifier)
                      return (
                        r.screenX - e.screenX > c || r.screenY - e.screenY > c
                          ? (t.deck('prev'), (e = void 0))
                          : (r.screenX - e.screenX < -1 * c || r.screenY - e.screenY < -1 * c) && (t.deck('next'), (e = void 0)),
                        !1
                      );
                  }),
                    n.preventDefault();
                ...
                .bind('touchend.deck', function(n) {
                  t.each(n.originalEvent.changedTouches, function(t, n) {
                    e && n.identifier === e.identifier && (e = void 0);
                  });
                })
                .scrollLeft(0)
                .scrollTop(0),
              t.each(o, function(n, r) {
                r.unbind('webkitTransitionEnd.deck').bind('webkitTransitionEnd.deck', function(n) {
                  if (r.hasClass(t.deck('getOptions').classes.current)) {
                    var e = t(this)
                      .find('iframe')
                      .css('opacity', 0);
              ...
              o.length && h(),
              u.removeClass(s.classes.loading),
              l.trigger(a);
          },
          go: function(n) {
            var r,
            ...
            'number' == typeof n && n >= 0 && n < o.length
              ...
              : 'string' == typeof n &&
                t.each(o, function(t, e) {
                  if (e.attr('id') === n) return (r = t), !1;
                }),
              void 0 !== r && (l.trigger(e, [i, r]), e.isDefaultPrevented() ? l.trigger(c, [r, i]) : ((i = r), h()));
          },
          next: function() {
            p.go(i + 1);
          },
          ...
          getSlide: function(t) {
            var n = void 0 !== t ? t : i;
            return 'number' != typeof n || n < 0 || n >= o.length ? null : o[n];
          },
          getSlides: function() {
            return o;
          },
      ...
      (t.deck = function(t, n) {
        return p[t] ? p[t].apply(this, Array.prototype.slice.call(arguments, 1)) : p.init(t, n);
      }),
        (t.deck.defaults = {
          classes: {
            after: 'deck-after',
          ...
          selectors: { container: '.deck-container' },
          keys: { next: [13, 32, 34, 39, 40], previous: [8, 33, 37, 38] },
          touch: { swipeTolerance: 60 },
        }),
        l.ready(function() {
          t('html').addClass('ready');
        }),
        l.bind('deck.change', function(n, r, e) {
          var o = t.deck('getSlide', r).find('iframe'),
            i = t.deck('getSlide', e).find('iframe');
          o.each(function() {
            var n = t(this),
              r = n.attr('src');
            r && n.data('deck-src', r).attr('src', '');
          }),
            i.each(function() {
              var n = t(this),
                r = n.data('deck-src');
