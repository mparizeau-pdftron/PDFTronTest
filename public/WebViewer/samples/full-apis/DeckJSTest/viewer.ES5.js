          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw $('Wrong length!');
                    if ((u = y - h) < 0) throw $('Wrong length!');
                  } else if ((u = d(o) * n) + h > y) throw $('Wrong length!');
                  c = u / n;
      ...
      (S = function(t) {
        ...
        f(x[m], {
          ...
          setFloat32: function(t, n) {
            $(this, 4, t, B, n, arguments[2]);
          },
          setFloat64: function(t, n) {
            $(this, 8, t, U, n, arguments[2]);
          },
        });
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
    ...
    $ ||
      (f(
        (L = function() {
          ...
          return u && Y && q(V, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
    $(function() {
      var t,
        n = $(document),
        r = 0,
        e = { NOT_STARTED: 0, QUEUED: 1, STARTED: 2, FINISHED: 3 },
        o = [],
        i = [],
        u = function(t) {
          return void 0 === t;
        ...
        c = (function(t) {
          ...
          return {
            getBoolean: function(t, r) {
              var e = n[t];
              return u(e) ? (u(r) ? null : r) : 'true' === (e = e.toLowerCase()) || 'yes' === e || '1' === e || ('false' !== e && 'no' !== e && '0' !== e && !!t);
            },
            getString: function(t, r) {
              var e = n[t];
              return u(e) ? (u(r) ? null : r) : decodeURIComponent(e);
            },
          };
        })().getString('d');
      null !== c &&
        (window.loadDocument(c).then(function(r) {
          (t = r), n.trigger('documentLoaded');
        }),
        n.on('documentLoaded', function() {
          ...
          for (var n = 0; n < r; n++)
            (i = n),
              ...
              (u = $('<section>')
                .attr('id', 'page' + i)
                .addClass('slide')).append($('<div class="loading">')),
              $('body').append(u),
              o.push(e.NOT_STARTED);
          for (var i, u, c = 0; c < Math.min(r, 10); c++) f(c);
          $.deck('.slide');
        }),
        n.on('deck.change', function(t, n, r) {
          f(r - 1), f(r), f(r + 1);
        }));
      function f(n) {
        if (!(n < 0 || n >= r)) {
          o[n] === e.NOT_STARTED &&
            ...
            1 === i.length &&
              (function n() {
                var r = i[0];
                (o[r] = e.STARTED),
                  window.loadCanvasAsync(t, r + 1).then(function(t) {
                    o[r] = e.FINISHED;
                    var u = $(t);
                    u.addClass('canvasPage');
                    var c = $('#page' + r);
                    c.append(u), c.find('.loading').remove(), $.deck('enableScale');
                    var f = parseFloat(u.css('width')) - c.find('.deck-slide-scaler').width();
                    u.css('margin-left', -f / 2 + 'px'),
                      i.length > 1
                        ? setTimeout(function() {
                            i.shift(), n();
                          }, 0)
