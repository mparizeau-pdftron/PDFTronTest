!(function(t) {
  ...
  function(t, n, e) {
    ...
    function k(t, n, e) {
      ...
      for (
        (t = O(t)) != t || t === E
          ...
          : ((r = F(A(t) / M)),
            t * (i = T(2, -r)) < 1 && (r--, (i *= 2)),
            (t += r + f >= 1 ? s / i : s * T(2, 1 - f)) * i >= 2 && (r++, (i /= 2)),
            r + f >= a ? ((o = 0), (r = a)) : r + f >= 1 ? ((o = (t * i - 1) * T(2, n)), (r += f)) : ((o = t * T(2, f - 1) * T(2, n)), (r = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, e, r, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[N], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      (x = function(t) {
        ...
        a(S[m], {
          ...
          getFloat32: function(t) {
            return C(U(this, 4, t, arguments[1]), 23, 4);
          },
          getFloat64: function(t) {
            return C(U(this, 8, t, arguments[1]), 52, 8);
          },
          setInt8: function(t, n) {
            z(this, 1, t, R, n);
          },
    ...
    var o = e(1),
      ...
      K = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          b(e),
          i(V, n) ? (e.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1), (e = P(e, { enumerable: E(0, !1) }))) : (i(t, R) || I(t, R, E(1, {})), (t[R][n] = !0)), Y(t, n, e)) : I(t, n, e)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, e = N(w(t)), r = [], o = 0; e.length > o; ) i(V, (n = e[o++])) || n == R || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
      ...
      (a(
        (k = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === U && n.call(G, e), i(this, R) && i(this[R], t) && (this[R][t] = !1), Y(this, t, E(1, e));
            };
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = a(m, h ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (h ? 0 : S)), p.length)) === x) S = u(p, S, y);
              else {
        ...
        return (
          ...
          (F.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = e), d;
            },
          }),
          t
        );
  ...
  function(t, n) {
     ...
     * http://modernizr.com/download/?-applicationcache-audio-backgroundsize-borderimage-borderradius-boxshadow-canvas-canvastext-cssanimations-csscolumns-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-flexbox-fontface-generatedcontent-generators-geolocation-hashchange-history-hsla-indexeddb-inlinesvg-input-inputtypes-localstorage-multiplebgs-opacity-postmessage-rgba-sessionstorage-smil-svg-svgclippaths-textshadow-video-webgl-websockets-websqldatabase-webworkers-addtest-domprefixes-hasevent-prefixes-testallprops-testprop-teststyles ! */ !(function(
      ...
      var C = c('input'),
        ...
        R = {};
      b.input = (function(n) {
        for (var e = 0, r = n.length; r > e; e++) R[n[e]] = !!(n[e] in C);
          ...
          C.setAttribute('type', (e = t[c])),
            (i = 'text' !== C.type && 'style' in C) &&
              ...
              /^range$/.test(e) && C.style.WebkitAppearance !== r
                ...
                : /^(search|tel)$/.test(e) || (i = /^(url|email|number)$/.test(e) ? C.checkValidity && !1 === C.checkValidity() : ':)' != C.value)),
            (D[t[c]] = !!i);
        return D;
      })(W)),
