!(function(t) {
  ...
  function(t, n) {
    ...
    !(function(t) {
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.prev = 0), (t.next = 3), n.PDFDoc.createFromURL(r);
                      case 3:
                        return (e = t.sent).initSecurityHandler(), e.lock(), (t.next = 8), e.getPageCount();
                      case 8:
                        return (o = t.sent), (t.next = 11), n.PDFDraw.create(100);
                      case 11:
                        return (i = t.sent), t.abrupt('return', { doc: e, pdfdraw: i, pagecount: o });
                      case 15:
                        (t.prev = 15), (t.t0 = t.catch(0)), console.log(t.t0.stack);
                      case 18:
                      case 'end':
                        return t.stop();
                    }
        ...
        o = (function() {
          var t = e(
            regeneratorRuntime.mark(function t(r, e) {
              var o, i, u, c, f, a, s, l, h, p;
              return regeneratorRuntime.wrap(
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.prev = 0), (o = r.doc), (i = r.pdfdraw), (t.next = 5), o.getPage(e);
                      case 5:
                        return (u = t.sent), (t.next = 8), i.getBitmap(u, n.PDFDraw.PixelFormat.e_rgba, !1);
                      case 8:
                        return (
                          (c = t.sent),
                          (f = c.width),
                          (a = c.height),
                          (s = new Uint8ClampedArray(c.buf)),
                          ((l = document.createElement('canvas')).width = f),
                          (l.height = a),
                          (h = l.getContext('2d')),
                          (p = h.createImageData(f, a)).data.set(s),
                          h.putImageData(p, 0, 0),
                          t.abrupt('return', l)
                        );
                      case 22:
                        (t.prev = 22), (t.t0 = t.catch(0)), console.log(t.t0.stack);
                      case 25:
                      case 'end':
                        return t.stop();
                    }
      ...
      (t.loadDocument = function(t) {
        return n.runWithoutCleanup(
          e(
          ...
          window.parent.sampleL
        );
      }),
        (t.loadCanvasAsync = function(t, r) {
          return n.runWithoutCleanup(
            e(
              regeneratorRuntime.mark(function n() {
                return regeneratorRuntime.wrap(function(n) {
