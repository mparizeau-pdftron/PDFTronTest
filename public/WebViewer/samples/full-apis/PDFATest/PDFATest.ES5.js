    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = g(c.length), o = Ot(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        Rt = {
          ...
          filter: function(t) {
            return At(this, H(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: g ? O : S('keys'), entries: A }), d)) for (b in m) b in P || i(P, b, m[b]);
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== F.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
        for (var r, e = d((n = w(n))), o = 0, i = e.length; i > o; ) X(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = a(s(u(b.index), h.length), 0), F = [], O = 1; O < b.length; O++) F.push(void 0 === (x = b[O]) ? x : String(x));
            var A = b.groups;
            if (p) {
              var M = [E].concat(F, P, h);
              void 0 !== A && M.push(A);
              var j = String(n.apply(void 0, M));
            } else j = y(E, h, P, F, A, n);
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, g, d, m, b, x;
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (e = '../TestFiles/' + (r = 'newsletter.pdf')),
                              (t.next = 11),
                              n.PDFACompliance.createFromUrl(!1, e, '', n.PDFACompliance.Conformance.e_Level1B, void 0, 10, !1)
                            );
                          case 11:
                            return (o = t.sent), (t.next = 14), o.getErrorCount();
                          case 14:
                            if (0 !== (i = t.sent)) {
                              t.next = 19;
                              break;
                            }
                            console.log(r + ' is a valid PDFA.'), (t.next = 46);
                            break;
                          case 19:
                            console.log(r + ' is NOT a valid PDFA.'), (u = 0);
                          case 21:
                            if (!(u < i)) {
                              t.next = 46;
                              break;
                            }
                            return (t.next = 24), o.getError(u);
                          case 24:
                            return (c = t.sent), (t.next = 27), n.PDFACompliance.getPDFAErrorMessage(c);
                          case 27:
                            return (f = t.sent), (t.next = 30), o.getRefObjCount(c);
                          case 30:
                            if (!((a = t.sent) > 0)) {
                              t.next = 43;
                              break;
                          ...
                          case 34:
                            ...
                            return (t.next = 37), o.getRefObj(c, l);
                          case 37:
                            (h = t.sent), s.push(h);
                          case 39:
                            l++, (t.next = 34);
                            break;
                          case 42:
                            console.log('Error:' + f + '. Objects:' + s.toString());
                          case 43:
                            u++, (t.next = 21);
                            break;
                          case 46:
                            ...
                            break;
                          case 48:
                            (t.prev = 48), (t.t0 = t.catch(0)), console.log(t.t0);
                          case 51:
                            return (
                              (t.prev = 51),
                              ...
                              (y = ''),
                              (g = 10),
                              (d = '../TestFiles/' + (p = 'fish.pdf')),
                              console.log('Converting input document: ' + p),
                              (t.next = 63),
                              n.PDFACompliance.createFromUrl(!0, d, y, n.PDFACompliance.Conformance.e_Level1B, void 0, g)
                            );
                          case 63:
                            return (m = t.sent), (t.next = 66), m.getErrorCount();
                          case 66:
                            return (
                              0 === t.sent ? console.log(p + ' is a valid PDFA.') : console.log(p + ' is NOT a valid PDFA.'),
                              console.log('Save and validate the converted document: ' + v),
                              (t.next = 72),
                              m.saveAsFromBuffer(!0)
                            );
                          case 72:
                            return (b = t.sent), saveBufferAsPDFDoc(b, v), (t.next = 77), n.PDFACompliance.createFromBuffer(!1, b, y, n.PDFACompliance.Conformance.e_Level1B, void 0, g);
                          case 77:
                            return (x = t.sent), (t.next = 80), x.getErrorCount();
                          case 80:
                            0 === t.sent ? console.log(v + ' is a valid PDFA.') : console.log(v + ' is NOT a valid PDFA.'), (t.next = 87);
                            break;
                          case 84:
                            (t.prev = 84), (t.t1 = t.catch(51)), console.log(t.t1);
                          case 87:
                          case 'end':
                            return t.stop();
                        }
