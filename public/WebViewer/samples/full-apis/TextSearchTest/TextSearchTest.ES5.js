!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      mt || ((U.f = Bt), (B.f = Ut)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Bt, defineProperty: Ut }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: kt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? M : S('values'), keys: d ? M : S('keys'), entries: F }), g)) for (m in b) m in O || i(O, m, b[m]);
            ...
            var t,
              r =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, d, g, b, m;
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 10:
                            (e = t.sent), (o = n.TextSearch.Mode.e_whole_word + n.TextSearch.Mode.e_page_stop), (i = 'joHn sMiTh'), e.begin(r, i, o), (u = 0);
                          case 15:
                            return (t.next = 18), e.run();
                          case 18:
                            if (((c = t.sent), (f = void 0), c.code !== n.TextSearch.ResultCode.e_found)) {
                              t.next = 119;
                              break;
                            }
                            if (0 !== u) {
                            ...
                            return console.log(c.out_str + "'s credit card number is: "), (t.next = 25), e.getMode();
                          case 25:
                            (o = t.sent),
                              (o += n.TextSearch.Mode.e_reg_expression + n.TextSearch.Mode.e_highlight),
                              e.setMode(o),
                              (i = '\\d{4}-\\d{4}-\\d{4}-\\d{4}'),
                              e.setPattern(i),
                              ++u,
                          ...
                          case 33:
                            ...
                            console.log('  ' + c.out_str), (f = c.highlights).begin(r);
                          case 37:
                          ...
                          case 42:
                            return (a = t.sent), console.log('The current highlight is from page: ' + a), (t.next = 46), f.next();
                          case 46:
                            t.next = 37;
                            break;
                          case 48:
                            (i = '\\d{4}-\\d{6}-\\d{5}'), e.setPattern(i), ++u, (t.next = 117);
                            break;
                          case 53:
                            if (2 !== u) {
                              t.next = 65;
                            ...
                            return console.log('\nThere is an AMEX card number:\n  ' + c.out_str), (t.next = 57), e.getMode();
                          case 57:
                            (o = t.sent), (o += n.TextSearch.Mode.e_search_up), e.setMode(o), (i = '[A-z]++ [A-z]++'), e.setPattern(i), ++u, (t.next = 117);
                            break;
                          case 65:
                            if (3 !== u) {
                              t.next = 117;
                            ...
                            return console.log("Is the owner's name:\n  " + c.out_str + '?'), (f = c.highlights), (t.next = 70), f.begin(r);
                          case 70:
                          ...
                          case 79:
                            return (s = t.sent), (t.next = 82), f.getCurrentQuads();
                          case 82:
                            (l = t.sent), (h = 0);
                          case 84:
                            if (!(h < l.length)) {
                            ...
                            return (
                              (p = l[h]),
                              (v = Math.min(Math.min(Math.min(p.p1x, p.p2x), p.p3x), p.p4x)),
                              (y = Math.max(Math.max(Math.max(p.p1x, p.p2x), p.p3x), p.p4x)),
                              (d = Math.min(Math.min(Math.min(p.p1y, p.p2y), p.p3y), p.p4y)),
                              (g = Math.max(Math.max(Math.max(p.p1y, p.p2y), p.p3y), p.p4y)),
                              (t.t2 = n.LinkAnnot),
                              (t.t3 = r),
                              (t.next = 94),
                              n.Rect.init(v, d, y, g)
                          ...
                          case 104:
                            return (t.next = 106), s.annotPushBack(b);
                          case 106:
                            ++h, (t.next = 84);
                            break;
                          case 109:
                          ...
                          case 114:
                            return (m = t.sent), saveBufferAsPDFDoc(m, 'credit card numbers_linked.pdf'), t.abrupt('break', 127);
                          case 117:
                            t.next = 125;
                            break;
                          case 119:
                            if (c.code !== n.TextSearch.ResultCode.e_page) {
                              t.next = 123;
                              break;
                            }
                            ...
                            break;
                          case 123:
                            if (c.code !== n.TextSearch.ResultCode.e_done) {
                              t.next = 125;
                              break;
                            }
