!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof J || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    g(x, 'ArrayBuffer'), g(S, 'DataView'), c(S[m], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = S);
  },
  function(t, n) {
    var r = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = r);
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), H(this, t, E(1, r));
            };
          return u && q && H(V, t, { configurable: !0, set: n }), J(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runContentReplacer = function() {
        var n = t.Core.PDFNet,
          e = (function() {
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, d;
                  return regeneratorRuntime.wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 0), (r = '../TestFiles/'), (e = 'BusinessCard.pdf'), (t.next = 6), n.PDFDoc.createFromURL(r + 'BusinessCardTemplate.pdf');
                          case 6:
                            return (o = t.sent).initSecurityHandler(), o.lock(), (t.next = 11), n.ContentReplacer.create();
                          case 11:
                            return (i = t.sent), (t.next = 14), o.getPage(1);
                          case 14:
                            return (u = t.sent), (t.next = 17), n.Image.createFromURL(o, r + 'peppers.jpg');
                          case 17:
                            return (c = t.sent), (t.next = 20), u.getMediaBox();
                          case 20:
                            return (f = t.sent), (t.next = 23), c.getSDFObj();
                          case 23:
                            return (a = t.sent), (t.next = 26), i.addImage(f, a);
                          case 26:
                            return (t.next = 28), i.addString('NAME', 'John Smith');
                          case 28:
                            return (t.next = 30), i.addString('QUALIFICATIONS', 'Philosophy Doctor');
                          case 30:
                            return (t.next = 32), i.addString('JOB_TITLE', 'Software Developer');
                          case 32:
                            return (t.next = 34), i.addString('ADDRESS_LINE1', '#100 123 Software Rd');
                          case 34:
                            return (t.next = 36), i.addString('ADDRESS_LINE2', 'Vancouver, BC');
                          case 36:
                            return (t.next = 38), i.addString('PHONE_OFFICE', '604-730-8989');
                          case 38:
                            return (t.next = 40), i.addString('PHONE_MOBILE', '604-765-4321');
                          case 40:
                            return (t.next = 42), i.addString('EMAIL', 'info@pdftron.com');
                          case 42:
                            return (t.next = 44), i.addString('WEBSITE_URL', 'http://www.pdftron.com');
                          case 44:
                            return (t.next = 46), i.process(u);
                          case 46:
                            return (t.next = 48), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 48:
                            (s = t.sent), saveBufferAsPDFDoc(s, e), console.log('Done. Result saved in ' + e), (t.next = 56);
                            break;
                          case 53:
                            (t.prev = 53), (t.t0 = t.catch(0)), console.log(t.t0);
                          case 56:
                            return (t.prev = 56), (l = 'ContentReplaced.pdf'), (t.next = 62), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                          case 62:
                            return (h = t.sent).initSecurityHandler(), h.lock(), (t.next = 67), n.ContentReplacer.create();
                          case 67:
                            return (p = t.sent), (t.next = 70), h.getPage(1);
                          case 70:
                            return (v = t.sent), (t.next = 73), v.getMediaBox();
                          case 73:
                            return (y = t.sent), (t.next = 76), p.addText(y, 'The quick onyx goblin jumps over the lazy dwarf');
                          case 76:
                            return (t.next = 78), p.process(v);
                          case 78:
                            return (t.next = 80), h.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 80:
                            (d = t.sent), saveBufferAsPDFDoc(d, l), console.log('Done. Result saved in ' + l), console.log('Done.'), (t.next = 89);
                            break;
                          case 86:
                            (t.prev = 86), (t.t1 = t.catch(56)), console.log(t.t1);
                          case 89:
                          case 'end':
                            return t.stop();
                        }
