                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (t.next = 6),
                              n.PDFDoc.createFromURL('../TestFiles/tiger.pdf')
                            );
                          case 6:
                            return (e = t.sent).initSecurityHandler(), e.lock(), console.log('PDF document initialized and locked'), (t.next = 12), e.getPageIterator();
                          case 12:
                            return (o = t.sent), (t.next = 15), o.current();
                          case 15:
                            return (t.next = 17), t.sent.getMediaBox();
                          case 17:
                            return ((i = t.sent).x1 -= 200), (i.x2 -= 200), (t.next = 22), i.update();
                          case 22:
                            return (t.next = 24), e.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 24:
                            (u = t.sent), saveBufferAsPDFDoc(u, 'tiger_shift.pdf'), console.log('Done.'), (t.next = 33);
                            break;
                          case 29:
                            (t.prev = 29), (t.t0 = t.catch(1)), console.log(t.t0), (r = 1);
                          case 33:
