!(function(t) {
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, g, d = i(n), m = o(d), S = r(c, v, 3), x = u(m.length), b = 0, w = e ? h(n, x) : a ? h(n, 0) : void 0; x > b; b++)
          if ((p || b in m) && ((g = S((y = m[b]), b, d)), t))
            if (e) w[b] = g;
            else if (g)
              switch (t) {
                case 3:
    ...
    if (e(8)) {
      var o = e(30),
        ...
        jt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, e = g(c.length), o = Et(this, e); e > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        kt = function() {
        ...
        Tt = function() {
          return vt.apply(Dt ? pt.call(Ot(this)) : Ot(this), arguments);
        },
        Rt = {
          ...
          subarray: function(t, n) {
            var e = Ot(this),
              r = e.length,
              o = m(t, r);
            return new (D(e, e[mt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, g((void 0 === n ? r : m(n, r)) - o));
          },
        },
        Nt = function(t, n) {
      ...
      St || ((U.f = zt), (z.f = Ut)),
        c(c.S + c.F * !St, 'Object', { getOwnPropertyDescriptor: zt, defineProperty: Ut }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
      ...
      v(Wt, Ct),
        h(Wt, yt, Ct.values),
        v(Wt, { slice: Nt, set: Lt, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        It(Wt, 'buffer', 'b'),
        It(Wt, 'byteOffset', 'o'),
        It(Wt, 'byteLength', 'l'),
        It(Wt, 'length', 'e'),
          ...
          S
            ? ((v = e(function(t, e, r, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(e)) {
                  if (!(e instanceof $ || 'ArrayBuffer' == (a = b(e)) || 'SharedArrayBuffer' == a)) return xt in e ? Mt(v, e) : jt.call(v, e);
                  (i = e), (p = Pt(r, n));
                  var y = e.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw G('Wrong length!');
                    if ((u = y - p) < 0) throw G('Wrong length!');
                  } else if ((u = g(o) * n) + p > y) throw G('Wrong length!');
                  c = u / n;
                } else (c = d(e)), (i = new $((u = c * n)));
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new K(i) }); s < c; ) F(t, s++);
              })),
              (_ = v.prototype = P(Wt)),
              h(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, e) {
    ...
    ((n = t.exports = function(t, n, e, l, p) {
      ...
      if (i(d)) {
        for (h = c(t.length); h > S; S++) if ((g = n ? m(u((v = t[S]))[0], v[1]) : m(t[S])) === f || g === s) return g;
    ...
    t.exports = function(t, n, e, y, g, d) {
      ...
      if (
        ...
        E ||
          ...
          (b.constructor = S)),
          (O || A) && (_('delete'), _('has'), g && _('get')),
          (A || P) && _(x),
          d && b.clear && delete b.clear;
      } else (S = y.getConstructor(n, t, g, x)), u(S.prototype, e), (c.NEED = !0);
      return h(S, t), (w[t] = S), o(o.G + o.W + o.F * (S != m), w), d || y.setStrong(S, t, g), S;
    };
  },
  function(t, n, e) {
    for (
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, g, d) {
      ...
      var m,
        ...
        E = O || b(y),
        A = y ? (_ ? b('entries') : E) : void 0,
        M = ('Array' == n && P.entries) || O;
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), r || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          O &&
          'values' !== O.name &&
          ((F = !0),
        ...
        if (((m = { values: _ ? E : b('values'), keys: g ? E : b('keys'), entries: A }), d)) for (S in m) S in P || i(P, S, m[S]);
  ...
  function(t, n, e) {
    ...
    function G(t, n, e, r, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[D], f = r(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    d(x, 'ArrayBuffer'), d(b, 'DataView'), c(b[m], u.VIEW, !0), (n.ArrayBuffer = x), (n.DataView = b);
  },
  function(t, n) {
    var e = (t.exports = 'undefined' != typeof window && window.Math == Math ? window : 'undefined' != typeof self && self.Math == Math ? self : Function('return this')());
    'number' == typeof __g && (__g = e);
    ...
    var r,
      ...
      j = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== O.indexOf('6.6') && -1 === b.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      k = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && N(t), (t._h = 1)),
                        ...
                        e === n.promise ? f(_('Promise-chain cycle')) : (i = k(e)) ? i.call(e, a, f) : a(e))
                      : f(r);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
    ...
    var o = e(1),
      ...
      q =
        ...
        s(function() {
          ...
          : k,
      $ = function(t) {
        var n = (U[t] = P(T.prototype));
        return (n._k = t), n;
      },
      K =
        G && 'symbol' == r(T.iterator)
          ? function(t) {
              return 'symbol' == r(t);
            }
          : function(t) {
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          S(e),
          i(U, n) ? (e.enumerable ? (i(t, L) && t[L][n] && (t[L][n] = !1), (e = P(e, { enumerable: F(0, !1) }))) : (i(t, L) || k(t, L, F(1, {})), (t[L][n] = !0)), q(t, n, e)) : k(t, n, e)
        );
      },
      X = function(t, n) {
        S(t);
      ...
      tt = function(t) {
        for (var n, e = D(w(t)), r = [], o = 0; e.length > o; ) i(U, (n = e[o++])) || n == L || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === V, r = D(e ? W : w(t)), o = [], u = 0; r.length > u; ) !i(U, (n = r[u++])) || (e && !i(V, n)) || o.push(U[n]);
        return o;
      };
    G ||
      (a(
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var m = []; ; ) {
            ...
            if (null === S) break;
            if ((m.push(S), !g)) break;
            '' === String(S[0]) && (l.lastIndex = c(p, i(l.lastIndex), d));
          }
          for (var x, b = '', w = 0, _ = 0; _ < m.length; _++) {
            S = m[_];
            for (var F = String(S[0]), P = f(s(u(S.index), p.length), 0), O = [], E = 1; E < S.length; E++) O.push(void 0 === (x = S[E]) ? x : String(x));
            var A = S.groups;
            if (h) {
              var M = [F].concat(O, P, p);
              void 0 !== A && M.push(A);
              var I = String(n.apply(void 0, M));
            } else I = y(F, p, P, O, A, n);
            P >= w && ((b += p.slice(w, P) + I), (w = P + F.length));
          }
          return b + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, b = 0, w = []; b < p.length; ) {
              ...
              var _,
                F = a(m, h ? p : p.slice(b));
              if (null === F || (_ = l(c(m.lastIndex + (h ? 0 : b)), p.length)) === x) b = u(p, b, g);
              else {
  ...
  function(t, n, e) {
    for (
      ...
      var g,
        ...
        S = u[d],
        x = S && S.prototype;
      if (x && (x[s] || c(x, s, p), x[l] || c(x, l, d), (a[d] = p), m)) for (g in r) x[g] || i(x, g, r[g], !0);
    }
  },
  function(t, n, e) {
    (function(t) {
      ...
      var e = (function(t) {
        ...
        var w = (m.prototype = g.prototype = Object.create(S));
        function _(t) {
          ...
          ((s = !p && x && void 0 !== x[f]) && c(m, f)) ||
            ...
            (m[f] =
              h && 'function' != typeof x[f]
                ...
                ? i(Function.call, l)
                : l),
            y && (((m.virtual || (m.virtual = {}))[f] = l), n & t.R && S && !S[f] && u(S, f, l)));
      };
            ...
            var t,
              r =
                ((t = regeneratorRuntime.mark(function t() {
                  var e, r, o, i, u, c, a, f, s, l, p, h, v, y, g, d, m, S, x, b, w, _, F, P, O, E, A, M, I, j, k, D, T, R, N, L, C, B, z, U, W, V, G, H, Y, q, $, K, J;
                  return regeneratorRuntime.wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (e = 0), (r = '../TestFiles/'), (t.prev = 2), (t.next = 5), n.startDeallocateStack();
                          case 5:
                            return (t.next = 7), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 7:
                            return (o = t.sent).initSecurityHandler(), o.lock(), (t.next = 12), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 12:
                            return (i = t.sent).setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_center, n.Stamper.VerticalAlignment.e_vertical_center), (t.next = 16), n.ColorPt.init(1, 0, 0);
                          case 16:
                            return (u = t.sent), i.setFontColor(u), (t.t0 = n.PageSet), (t.next = 21), o.getPageCount();
                          case 21:
                            return (t.t1 = t.sent), (t.next = 24), t.t0.createRange.call(t.t0, 1, t.t1);
                          case 24:
                            return (c = t.sent), i.stampText(o, 'If you are reading this\nthis is an even page', c), (t.t2 = n.PageSet), (t.next = 29), o.getPageCount();
                          case 29:
                            return (t.t3 = t.sent), (t.t4 = n.PageSet.Filter.e_odd), (t.next = 33), t.t2.createFilteredRange.call(t.t2, 1, t.t3, t.t4);
                          case 33:
                            return (a = t.sent), n.Stamper.deleteStamps(o, a), (t.next = 37), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 37:
                            return (f = t.sent), saveBufferAsPDFDoc(f, 'newsletter.ex1.pdf'), (t.next = 41), n.endDeallocateStack();
                          case 41:
                            t.next = 47;
                            break;
                          case 43:
                            (t.prev = 43), (t.t5 = t.catch(2)), console.log(t.t5.stack), (e = 1);
                          case 47:
                            return (t.prev = 47), (t.next = 50), n.startDeallocateStack();
                          case 50:
                            return (t.next = 52), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 52:
                            return (s = t.sent).initSecurityHandler(), s.lock(), (t.next = 57), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 57:
                            return (l = t.sent), (t.next = 60), n.Image.createFromURL(s, r + 'peppers.jpg');
                          case 60:
                            return (
                              (p = t.sent),
                              l.setSize(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5),
                              l.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_center),
                              (t.next = 65),
                              n.ColorPt.init(0, 0, 0, 0)
                            );
                          case 65:
                            return (h = t.sent), l.setFontColor(h), l.setRotation(180), l.setAsBackground(!1), (t.next = 71), n.PageSet.createRange(1, 2);
                          case 71:
                            return (v = t.sent), l.stampImage(s, p, v), (t.next = 75), s.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 75:
                            return (y = t.sent), saveBufferAsPDFDoc(y, 'newsletter.ex2.pdf'), (t.next = 79), n.endDeallocateStack();
                          case 79:
                            t.next = 85;
                            break;
                          case 81:
                            (t.prev = 81), (t.t6 = t.catch(47)), console.log(t.t6.stack), (e = 1);
                          case 85:
                            return (t.prev = 85), (t.next = 88), n.startDeallocateStack();
                          case 88:
                            return (t.next = 90), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 90:
                            return (g = t.sent).initSecurityHandler(), g.lock(), (t.next = 95), n.PDFDoc.createFromURL(r + 'fish.pdf');
                          case 95:
                            return (d = t.sent).initSecurityHandler(), d.lock(), (t.next = 100), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.5, 0.5);
                          case 100:
                            return (m = t.sent), (t.next = 103), d.getPage(1);
                          case 103:
                            return (S = t.sent), (t.next = 106), S.getCropBox();
                          case 106:
                            return (x = t.sent), (t.t7 = m), (t.t8 = n.Stamper.SizeType.e_absolute_size), (t.next = 111), x.width();
                          case 111:
                            return (
                              (t.t9 = t.sent),
                              (t.t10 = 0.1 * t.t9),
                              (t.t11 = -1),
                              t.t7.setSize.call(t.t7, t.t8, t.t10, t.t11),
                              m.setOpacity(0.4),
                              m.setRotation(-67),
                              m.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_right, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              (t.t12 = n.PageSet),
                              (t.next = 121),
                              g.getPageCount()
                            );
                          case 121:
                            return (t.t13 = t.sent), (t.next = 124), t.t12.createRange.call(t.t12, 1, t.t13);
                          case 124:
                            return (b = t.sent), m.stampPage(g, S, b), (t.next = 128), g.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 128:
                            return (w = t.sent), saveBufferAsPDFDoc(w, 'newsletter.ex3.pdf'), (t.next = 132), n.endDeallocateStack();
                          case 132:
                            t.next = 138;
                            break;
                          case 134:
                            (t.prev = 134), (t.t14 = t.catch(85)), console.log(t.t14.stack), (e = 1);
                          case 138:
                            return (t.prev = 138), (t.next = 141), n.startDeallocateStack();
                          case 141:
                            return (t.next = 143), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 143:
                            return (_ = t.sent).initSecurityHandler(), _.lock(), (t.next = 148), n.Stamper.create(n.Stamper.SizeType.e_absolute_size, 20, 20);
                          case 148:
                            return (F = t.sent).setOpacity(1), F.setRotation(45), F.setAsBackground(!0), F.setPosition(30, 40), (t.next = 155), n.Image.createFromURL(_, r + 'peppers.jpg');
                          case 155:
                            return (P = t.sent), (t.next = 158), n.PageSet.createFilteredRange(1, 20, n.PageSet.Filter.e_odd);
                          case 158:
                            return (O = t.sent), F.stampImage(_, P, O), (t.next = 162), _.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 162:
                            return (E = t.sent), saveBufferAsPDFDoc(E, 'newsletter.ex4.pdf'), (t.next = 166), n.endDeallocateStack();
                          case 166:
                            t.next = 172;
                            break;
                          case 168:
                            (t.prev = 168), (t.t15 = t.catch(138)), console.log(t.t15.stack), (e = 1);
                          case 172:
                            return (t.prev = 172), (t.next = 175), n.startDeallocateStack();
                          case 175:
                            return (t.next = 177), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 177:
                            return (A = t.sent).initSecurityHandler(), A.lock(), (t.next = 182), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.05, 0.05);
                          case 182:
                            return (
                              (M = t.sent).setOpacity(0.7),
                              M.setRotation(90),
                              M.setPosition(0, 0),
                              M.setSize(n.Stamper.SizeType.e_font_size, 80, -1),
                              M.setTextAlignment(n.Stamper.TextAlignment.e_align_center),
                              (t.next = 190),
                              n.PageSet.createFilteredRange(1, 20, n.PageSet.Filter.e_even)
                            );
                          case 190:
                            return (I = t.sent), M.stampText(A, 'Goodbye\nMoon', I), (t.next = 194), A.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 194:
                            return (j = t.sent), saveBufferAsPDFDoc(j, 'newsletter.ex5.pdf'), (t.next = 198), n.endDeallocateStack();
                          case 198:
                            t.next = 204;
                            break;
                          case 200:
                            (t.prev = 200), (t.t16 = t.catch(172)), console.log(t.t16.stack), (e = 1);
                          case 204:
                            return (t.prev = 204), (t.next = 207), n.startDeallocateStack();
                          case 207:
                            return (t.next = 209), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 209:
                            return (k = t.sent).initSecurityHandler(), k.lock(), (t.next = 214), n.PDFDoc.createFromURL(r + 'fish.pdf');
                          case 214:
                            return (D = t.sent).initSecurityHandler(), D.lock(), (t.next = 219), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.3, 0.3);
                          case 219:
                            return (
                              (T = t.sent).setOpacity(1),
                              T.setRotation(270),
                              T.setAsBackground(!0),
                              T.setPosition(0.5, 0.5, !0),
                              T.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              (t.next = 227),
                              D.getPage(1)
                            );
                          case 227:
                            return (R = t.sent), (t.t17 = n.PageSet), (t.next = 231), k.getPageCount();
                          case 231:
                            return (t.t18 = t.sent), (t.t19 = n.PageSet.Filter.e_even), (t.next = 235), t.t17.createFilteredRange.call(t.t17, 1, t.t18, t.t19);
                          case 235:
                            return (N = t.sent), T.stampPage(k, R, N), (t.next = 239), k.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 239:
                            return (L = t.sent), saveBufferAsPDFDoc(L, 'newsletter.ex6.pdf'), (t.next = 243), n.endDeallocateStack();
                          case 243:
                            t.next = 249;
                            break;
                          case 245:
                            (t.prev = 245), (t.t20 = t.catch(204)), console.log(t.t20.stack), (e = 1);
                          case 249:
                            return (t.prev = 249), (t.next = 252), n.startDeallocateStack();
                          case 252:
                            return (t.next = 254), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 254:
                            return (C = t.sent).initSecurityHandler(), C.lock(), (t.next = 259), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.1, 0.1);
                          case 259:
                            return (
                              (B = t.sent).setOpacity(0.8),
                              B.setRotation(135),
                              B.setAsBackground(!1),
                              B.showsOnPrint(!1),
                              B.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_left, n.Stamper.VerticalAlignment.e_vertical_top),
                              B.setPosition(10, 10),
                              (t.next = 268),
                              n.Image.createFromURL(C, r + 'peppers.jpg')
                            );
                          case 268:
                            return (z = t.sent), (t.t21 = n.PageSet), (t.next = 272), C.getPageCount();
                          case 272:
                            return (t.t22 = t.sent), (t.t23 = n.PageSet.Filter.e_all), (t.next = 276), t.t21.createFilteredRange.call(t.t21, 1, t.t22, t.t23);
                          case 276:
                            return (U = t.sent), B.stampImage(C, z, U), (t.next = 280), C.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 280:
                            return (W = t.sent), saveBufferAsPDFDoc(W, 'newsletter.ex7.pdf'), (t.next = 284), n.endDeallocateStack();
                          case 284:
                            t.next = 290;
                            break;
                          case 286:
                            (t.prev = 286), (t.t24 = t.catch(249)), console.log(t.t24.stack), (e = 1);
                          case 290:
                            return (t.prev = 290), (t.next = 293), n.startDeallocateStack();
                          case 293:
                            return (t.next = 295), n.PDFDoc.createFromURL(r + 'newsletter.pdf');
                          case 295:
                            return (V = t.sent).initSecurityHandler(), V.lock(), (t.next = 300), n.Stamper.create(n.Stamper.SizeType.e_relative_scale, 0.07, -0.1);
                          case 300:
                            return (
                              (G = t.sent).setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_right, n.Stamper.VerticalAlignment.e_vertical_bottom),
                              G.setAlignment(n.Stamper.HorizontalAlignment.e_horizontal_center, n.Stamper.VerticalAlignment.e_vertical_top),
                              (t.next = 305),
                              n.Font.create(V, n.Font.StandardType1Font.e_courier)
                            );
                          case 305:
                            return (H = t.sent), G.setFont(H), (t.next = 309), n.ColorPt.init(1, 0, 0, 0);
                          case 309:
                            return (Y = t.sent), G.setFontColor(Y), G.setTextAlignment(n.Stamper.TextAlignment.e_align_right), G.setAsBackground(!0), (t.next = 315), n.PageSet.createRange(1, 2);
                          case 315:
                            return (q = t.sent), G.stampText(V, 'This is a title!', q), (t.next = 319), n.Image.createFromURL(V, r + 'peppers.jpg');
                          case 319:
                            return ($ = t.sent), G.setAsBackground(!1), (t.next = 323), n.PageSet.createRange(1, 1);
                          case 323:
                            return (K = t.sent), G.stampImage(V, $, K), (t.next = 327), V.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 327:
                            return (J = t.sent), saveBufferAsPDFDoc(J, 'newsletter.ex8.pdf'), (t.next = 331), n.endDeallocateStack();
                          case 331:
                            t.next = 337;
                            break;
                          case 333:
                            (t.prev = 333), (t.t25 = t.catch(290)), console.log(t.t25.stack), (e = 1);
                          case 337:
