    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = F(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && X && q(V, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else j = y(E, h, F, O, M, n);
            F >= w && ((S += h.slice(w, F) + j), (w = F + E.length));
          }
          return S + h.slice(w);
        },
      ];
            ...
            (o.onreadystatechange = function() {
              if (this.readyState === this.DONE)
                if (200 === o.status) {
                  ...
                  n.FDFDoc.createFromXFDF(i).then(
                    function(t) {
                      r(t);
                    },
                    function(t) {
                ...
                } else e('Request for URL ' + t + ' received incorrect HTTP response code ' + o.status);
            }),
              o.open('GET', t, !0),
              o.send();
          });
        };
      t.runFDFTest = function() {
        var t = (function() {
          var t,
            o =
              ((t = regeneratorRuntime.mark(function t() {
                var r, o, i, u, c, f, a, s, l, h;
                return regeneratorRuntime.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return console.log('Beginning FDF Test.'), (r = '../TestFiles/'), (t.prev = 2), console.log('Import annotations from XFDF to FDF.'), (t.next = 6), e(r + 'form1_annots.xfdf');
                        case 6:
                          return (o = t.sent), (t.next = 9), n.PDFDoc.createFromURL(r + 'form1.pdf');
                        case 9:
                          return (i = t.sent).initSecurityHandler(), console.log('Update annotations from fdf'), i.fdfUpdate(o), (t.next = 15), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 15:
                          (u = t.sent), saveBufferAsPDFDoc(u, 'form1_with_annots.pdf'), console.log('Done sample'), (t.next = 23);
                          break;
                        case 20:
                          (t.prev = 20), (t.t0 = t.catch(2)), console.log(t.t0);
                        case 23:
                          return (t.prev = 23), console.log('Extract annotations from PDF.'), (t.next = 27), n.PDFDoc.createFromURL(''.concat(r, 'form1.pdf'));
                        case 27:
                          return (c = t.sent).initSecurityHandler(), (t.next = 31), c.fdfExtract(n.PDFDoc.ExtractFlag.e_both);
                        case 31:
                          return (f = t.sent), (t.next = 34), f.saveAsXFDFAsString();
                        case 34:
                          (a = t.sent), console.log('XFDF extracted from form1.pdf'), console.log(a), console.log('Done sample'), (t.next = 43);
                          break;
                        case 40:
                          (t.prev = 40), (t.t1 = t.catch(23)), console.log(t.t1);
                        case 43:
                          return (t.prev = 43), console.log('Extract existing fields from PDF.'), (t.next = 47), n.PDFDoc.createFromURL(''.concat(r, 'form1.pdf'));
                        case 47:
                          return (s = t.sent).initSecurityHandler(), (t.next = 51), s.getFieldIteratorBegin();
                        case 51:
                          l = t.sent;
                        case 52:
                          return (t.next = 54), l.hasNext();
                        case 54:
                          if (!t.sent) {
                            t.next = 66;
                            break;
                          }
                          return (t.next = 57), l.current();
                        case 57:
                          return (h = t.sent), (t.t2 = console), (t.next = 61), h.getName();
                        case 61:
                        ...
                        case 63:
                          ...
                          break;
                        case 66:
                          console.log('Done sample'), (t.next = 72);
                          break;
                        case 69:
                          (t.prev = 69), (t.t4 = t.catch(43)), console.log(t.t4);
                        case 72:
                        case 'end':
                          return t.stop();
                      }
