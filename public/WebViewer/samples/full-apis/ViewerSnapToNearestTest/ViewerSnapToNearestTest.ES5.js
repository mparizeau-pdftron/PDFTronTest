  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? M : S('values'), keys: d ? M : S('keys'), entries: F }), g)) for (b in m) b in P || i(P, b, m[b]);
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = a(s(u(b.index), h.length), 0), O = [], M = 1; M < b.length; M++) O.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var A = [E].concat(O, P, h);
              void 0 !== F && A.push(F);
              var I = String(n.apply(void 0, A));
            } else I = y(E, h, P, O, F, n);
            P >= w && ((S += h.slice(w, P) + I), (w = P + E.length));
          }
          return S + h.slice(w);
        },
      ];
    ...
    window,
      ...
      window.addEventListener('documentLoaded', function() {
        ...
        (t = {
          ...
          instance.UI.setCustomPanel(t),
          instance.UI.openElements(['snapModesPanel']);
        var n = new Annotations.LineAnnotation();
        n.setStartPoint(0, 0), n.setEndPoint(0, 0), (n.PageNumber = 1);
        var o = instance.Core.documentViewer.getAnnotationManager();
        o.addAnnotation(n),
          instance.Core.documentViewer.addEventListener('mouseMove', function(t) {
            var i = e(t),
              u = i.point,
              c = i.pageNumber,
              f = n.PageNumber;
            (n.PageNumber = c),
              n.setStartPoint(u.x, u.y),
              c !== f && o.drawAnnotations(f),
              instance.Core.documentViewer.snapToNearest(c, u.x, u.y, r).then(function(t) {
                n.setEndPoint(t.x, t.y), o.redrawAnnotation(n);
              });
          });
      });
  },
