!(function(t) {
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, f = u + t[R], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
            ...
            switch ((t.prev = t.next)) {
              case 0:
                (e = n.Core.PDFNet),
                  (i = null),
                  (u = null),
                  (c = window.parent.window.document),
                  (f = [null, null]),
                  (a = (function() {
                    var t = o(
                      regeneratorRuntime.mark(function t() {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (n = new u.Color(200, 0, 0, 1)), (r = new u.Color(0, 200, 200, 1)), (t.next = 4), e.createDiffOptions();
                              case 4:
                                return (o = t.sent).setColorA(n), o.setColorB(r), o.setBlendMode(5), t.abrupt('return', o);
                              case 9:
                              case 'end':
                                return t.stop();
                            }
                      ...
                      regeneratorRuntime.mark(function t(n, i) {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), e.PDFDoc.create();
                              case 2:
                                return (u = t.sent).lock(), (t.next = 6), a();
                              case 6:
                                return (c = t.sent), (f = []), (t.next = 10), n.getPageIterator(1);
                              case 10:
                                return (s = t.sent), (t.next = 13), i.getPageIterator(1);
                              case 13:
                                (l = t.sent), (h = 0);
                              case 16:
                                return (t.next = 18), s.hasNext();
                              case 18:
                                if (!t.sent) {
                                  t.next = 27;
                                  break;
                                }
                                return (t.next = 21), s.current();
                              case 21:
                                (p = t.sent), (f[h] = [p]), h++;
                              case 24:
                                s.next(), (t.next = 16);
                              ...
                              case 27:
                                h = 0;
                              case 29:
                                return (t.next = 31), l.hasNext();
                              case 31:
                                if (!t.sent) {
                                  t.next = 40;
                                  break;
                                }
                                return (t.next = 34), l.current();
                              case 34:
                                (v = t.sent), (f[h] || (f[h] = [null])).push(v), h++;
                              case 37:
                                l.next(), (t.next = 29);
                                break;
                              case 40:
                                        ...
                                        regeneratorRuntime.mark(function t(n) {
                                          ...
                                          return regeneratorRuntime.wrap(function(t) {
                                            for (;;)
                                              switch ((t.prev = t.next)) {
                                                case 0:
                                                  return (o = r(n, 2)), (i = o[0]), (f = o[1]), i || (i = new e.Page(0)), f || (f = new e.Page(0)), (t.next = 5), u.appendVisualDiff(i, f, c);
                                                case 5:
                                                case 'end':
                                                  return t.stop();
                                              }
                      ...
                      regeneratorRuntime.mark(function t() {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                if ((n = c.getElementById('compareButton')).classList.contains('disabled')) {
                                  t.next = 3;
                                  break;
                                }
                      ...
                      regeneratorRuntime.mark(function t(n, r) {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), i.createDocument(n, {});
                              case 2:
                                return (e = t.sent), (t.next = 5), e.getPDFDoc();
                              case 5:
                                (f[r] = t.sent), null !== f[1] && null !== f[0] && l();
                              case 7:
                              case 'end':
                                return t.stop();
                            }
                  ...
                  c.getElementById('fileUpload1').addEventListener('change', function(t) {
                    h(t.target.files[0], 0);
                  }),
                  c.getElementById('fileUpload2').addEventListener('change', function(t) {
                    h(t.target.files[0], 1);
                  }),
                  (p = (function() {
                    var t = o(
                      regeneratorRuntime.mark(function t() {
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (i = window.Core), (u = window.Core.Annotations), i.enableFullPDF(!0), (t.next = 5), e.initialize();
                              case 5:
                              case 'end':
                                return t.stop();
                            }
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), p();
                              case 2:
                                return (t.next = 4), e.PDFDoc.createFromURL('../../samples/files/test_doc_1.pdf');
                              case 4:
                                return (n = t.sent), (t.next = 7), e.PDFDoc.createFromURL('../../samples/files/test_doc_2.pdf');
                              case 7:
                                return (r = t.sent), (t.next = 10), s(n, r);
                              case 10:
                                (c.getElementById('fileUpload1').disabled = !1), (c.getElementById('fileUpload2').disabled = !1);
                              case 12:
                              case 'end':
                                return t.stop();
                            }
