    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), X(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), X(this, t, E(1, r));
            };
              ...
              (t = (function() {
                var t = e(
                  regeneratorRuntime.mark(function t(n) {
                    var r, e, i, u, c, f, a, s, l, h, p, v, y, g, d;
                    return regeneratorRuntime.wrap(function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (r = '../../samples/full-apis/TestFiles/grayscale.tif'), (t.next = 3), o.startDeallocateStack();
                          case 3:
                            return console.log('Traversing all annotations in the document...'), (t.next = 6), o.ElementWriter.create();
                          case 6:
                            return (e = t.sent), (t.next = 9), o.ElementBuilder.create();
                          case 9:
                            return (i = t.sent), (t.next = 12), o.Image.createFromURL(n, r);
                          case 12:
                            return (u = t.sent), (t.next = 15), n.getPageIterator(1);
                          case 15:
                            (c = t.sent), (f = 0);
                          case 18:
                            return (t.next = 20), c.hasNext();
                          case 20:
                            if (!t.sent) {
                              t.next = 81;
                              break;
                            }
                            return (t.next = 23), c.current();
                          case 23:
                            return (a = t.sent), (t.next = 26), a.getNumAnnots();
                          case 26:
                            (s = t.sent), (l = 0);
                          case 28:
                            if (!(l < s)) {
                            ...
                            return (t.next = 31), a.getAnnot(l);
                          case 31:
                            return (h = t.sent), (t.next = 34), h.isValid();
                          case 34:
                            if (t.sent) {
                              t.next = 36;
                              break;
                          ...
                          case 36:
                            return (t.next = 38), h.getType();
                          case 38:
                            (p = t.sent), (t.t0 = p), (t.next = t.t0 === o.Annot.Type.e_Stamp ? 42 : 73);
                            break;
                          case 42:
                            return e.begin(n), (t.next = 45), u.getImageWidth();
                          case 45:
                            return (v = t.sent), (t.next = 48), u.getImageHeight();
                          case 48:
                            return (y = t.sent), (t.next = 51), i.createImageScaled(u, 0, 0, v, y);
                          case 51:
                            return (g = t.sent), e.writePlacedElement(g), (t.next = 55), e.end();
                          case 55:
                            return (d = t.sent).putRect('BBox', 0, 0, v, y), d.putName('Subtype', 'Form'), d.putName('Type', 'XObject'), (t.next = 61), i.createFormFromStream(d);
                          case 61:
                            return (g = t.sent), e.writePlacedElement(g), (t.next = 65), e.end();
                          case 65:
                            return (d = t.sent).putRect('BBox', 0, 0, v, y), d.putName('Subtype', 'Form'), d.putName('Type', 'XObject'), (t.next = 71), h.setAppearance(d);
                          case 71:
                            return (f += 1), t.abrupt('break', 74);
                          case 73:
                          ...
                          case 74:
                            ...
                            break;
                          case 77:
                            return (t.next = 79), c.next();
                          case 79:
                            t.next = 18;
                            break;
                          case 81:
                            return console.log('number of annotation modifications: ' + f), (t.next = 84), o.endDeallocateStack();
                          case 84:
                          case 'end':
                            return t.stop();
                        }
                          ...
                          switch ((n.prev = n.next)) {
                            case 0:
                              return (
                                (r = null),
                                (n.prev = 1),
                                (e = '../../samples/full-apis/TestFiles/fish_stamped.pdf'),
                                console.log('loading document from url: ' + e),
                                (n.next = 8),
                                o.PDFDoc.createFromURL(e)
                              );
                            case 8:
                              return (r = n.sent).initSecurityHandler(), r.lock(), console.log('loaded document from url: ' + e), (n.next = 14), t(r);
                            case 14:
                              return r.flattenAnnotations(), console.log('flattened document from url: ' + e), n.abrupt('return', r);
                            case 19:
                              (n.prev = 19), (n.t0 = n.catch(1)), console.log(n.t0.stack);
                            case 22:
                              return (n.prev = 22), r && r.unlock(), n.finish(22);
                            case 25:
                            case 'end':
                              return n.stop();
                          }
                ...
                regeneratorRuntime.mark(function t(n) {
                  return regeneratorRuntime.wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          instance.UI.loadDocument(n), console.log('finished script');
                        case 2:
                        case 'end':
                          return t.stop();
                      }
