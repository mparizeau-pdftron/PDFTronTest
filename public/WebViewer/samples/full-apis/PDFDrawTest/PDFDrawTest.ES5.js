  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === V && i(B, t) && !i(U, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
                  ...
                  return regeneratorRuntime.wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return console.log('Beginning Test'), (r = 0), (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                        case 5:
                          return (e = t.sent).initSecurityHandler(), e.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 11), n.PDFDraw.create(92);
                        case 11:
                          return (o = t.sent), (t.next = 14), e.getPageIterator(1);
                        case 14:
                          return (i = t.sent), (t.next = 17), i.current();
                        case 17:
                          return (u = t.sent), (t.next = 20), o.exportStream(u, 'PNG');
                        case 20:
                          return (c = t.sent), saveBufferAsPNG(c, 'newsletter.png'), (t.next = 24), o.exportStream(u, 'TIFF');
                        case 24:
                          return (f = t.sent), saveBufferAsPNG(f, 'newsletter.tif'), console.log('Done'), t.abrupt('return', r);
                        case 28:
                        case 'end':
                          return t.stop();
                      }
