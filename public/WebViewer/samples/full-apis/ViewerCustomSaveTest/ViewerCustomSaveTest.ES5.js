  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: g ? P : S('keys'), entries: M }), d)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Z = function(t) {
        ...
        return !(this === U && i(B, t) && !i(G, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(G, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
  ...
  function(t, n) {
    ...
    (e = window.Core.PDFNet),
      (o = function(t, n) {
                  ...
                  function(r) {
                    for (;;)
                      switch ((r.prev = r.next)) {
                        case 0:
                          return (r.next = 2), e.FDFDoc.createFromXFDF(n);
                        case 2:
                          return (o = r.sent), (r.next = 5), t.getPageIterator();
                        case 5:
                          i = r.sent;
                        case 6:
                          return (r.next = 8), i.hasNext();
                        case 8:
                          if (!r.sent) {
                            r.next = 41;
                            break;
                          }
                          return (r.prev = 9), (r.next = 12), i.current();
                        case 12:
                          return (u = r.sent), (r.next = 15), u.getNumAnnots();
                        case 15:
                          f = r.sent;
                        case 16:
                          if (!(f > 0)) {
                          ...
                          return (r.next = 19), u.getAnnot(--f);
                        case 19:
                          return (c = r.sent), (r.next = 22), c.getType();
                        case 22:
                          (r.t0 = r.sent),
                            (r.next =
                              r.t0 === e.Annot.Type.e_Widget
                                ? 25
                                : r.t0 === e.Annot.Type.e_Link
                                ? 25
                                : r.t0 === e.Annot.Type.e_Sound
                                ? 25
                                : r.t0 === e.Annot.Type.e_Movie
                                ? 25
                                : r.t0 === e.Annot.Type.e_FileAttachment
                                ? 25
                                : 26);
                          break;
                        case 25:
                          return r.abrupt('break', 28);
                        case 26:
                          return u.annotRemoveByIndex(f), r.abrupt('break', 28);
                        case 28:
                          r.next = 16;
                          break;
                        case 30:
                          ...
                          break;
                        case 32:
                          return (r.prev = 32), (r.t1 = r.catch(9)), console.log('Error Removing Annotations: ' + r.t1), (r.next = 37), u.getSDFObj();
                        case 37:
                          r.sent.erase('Annots');
                        case 38:
                          i.next(), (r.next = 6);
                          break;
                        case 41:
                          return (r.next = 43), t.fdfMerge(o);
                        case 43:
                          return (r.next = 45), t.flattenAnnotations();
                        case 45:
                          return (r.next = 47), t.saveMemoryBuffer(e.SDFDoc.SaveOptions.e_linearized);
                        case 47:
        ...
        return e.runWithCleanup(o);
      }),
      (i = function(t) {
        var n = instance.Core.documentViewer,
          r = n.getAnnotationManager(),
          i = r.getAnnotationsList(),
          u = n.getDocument();
        return e
          .initialize()
          .then(function() {
          ...
          .then(function(n) {
            return o(n, t.xfdfString);
          })
          .then(function(t) {
            return r.deleteAnnotations(i), n.refreshAll(), n.updateView(), n.getDocument().refreshTextData(), t;
          });
      }),
      window.addEventListener('documentLoaded', function() {
        instance.Core.documentViewer.getDocument().getFileData = i;
      });
  },
]);
