!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Gt, Ct),
        p(Gt, yt, Ct.values),
        v(Gt, { slice: Lt, set: Rt, constructor: function() {}, toString: pt, toLocaleString: Dt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    function z(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[N], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var P = String(b[0]), E = f(s(u(b.index), h.length), 0), F = [], O = 1; O < b.length; O++) F.push(void 0 === (x = b[O]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [P].concat(F, E, h);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = y(P, h, E, F, M, n);
            E >= w && ((S += h.slice(w, E) + I), (w = E + P.length));
          }
          return S + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                P = a(m, p ? h : h.slice(S));
              if (null === P || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, g);
              else {
            ...
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, a, f, s, l, h, p, v, y, g, d, m, b, x, S, w, _, P, E, F, O, M, A;
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 41:
                            (l = t.sent).initSecurityHandler(), l.lock(), console.log('Sample 2, merge several PDF documents into one:'), (h = 1);
                          case 46:
                            if (!(h <= e.length)) {
                              t.next = 55;
                              break;
                            }
                            return (p = e[h - 1]), (t.next = 50), p.getPageCount();
                          case 50:
                            (v = t.sent), l.insertPages(h, p, 1, v, n.PDFDoc.InsertFlag.e_none);
                          case 52:
                            ++h, (t.next = 46);
                            break;
                          case 55:
