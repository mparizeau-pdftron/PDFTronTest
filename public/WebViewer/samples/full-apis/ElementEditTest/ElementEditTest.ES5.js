!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? jt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runElementEditTest = function() {
        ...
        function o() {
          return (o = e(
            regeneratorRuntime.mark(function t(e, o, i) {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      return (t.next = 4), n.ColorSpace.createDeviceRGB();
                    case 4:
                      return (u = t.sent), (t.next = 7), n.ColorPt.init(1, 0, 0, 0);
                    case 7:
                      return (c = t.sent), (t.next = 10), n.ColorPt.init(0, 0, 1, 0);
                    case 10:
                      return (f = t.sent), (t.next = 13), e.next();
                    case 13:
                      a = t.sent;
                    case 14:
                      if (null === a) {
                    ...
                    case 17:
                      (s = t.sent),
                        ...
                        (t.t0 = s),
                        (t.next =
                          t.t0 === n.Element.Type.e_image
                            ? 24
                            : t.t0 === n.Element.Type.e_inline_image
                            ? 24
                            : t.t0 === n.Element.Type.e_path
                            ? 25
                            : t.t0 === n.Element.Type.e_text
                            ? 32
                            : t.t0 === n.Element.Type.e_form
                            ? 39
                            : 59);
                      break;
                    case 24:
                      return t.abrupt('break', 60);
                    case 25:
                      return (t.next = 27), a.getGState();
                    case 27:
                      return (l = t.sent).setFillColorSpace(u), l.setFillColorWithColorPt(c), o.writeElement(a), t.abrupt('break', 60);
                    case 32:
                      return (t.next = 34), a.getGState();
                    case 34:
                      return (l = t.sent).setFillColorSpace(u), l.setFillColorWithColorPt(f), o.writeElement(a), t.abrupt('break', 60);
                    case 39:
                      return o.writeElement(a), (t.next = 42), a.getXObject();
                    case 42:
                      if (((h = t.sent), (p = h.getObjNum()), -1 !== i.indexOf(p))) {
                        t.next = 58;
                        break;
                      }
                      return (t.next = 47), h.getObjNum();
                    case 47:
                      return (v = t.sent), i.includes(v) || i.push(v), (t.next = 51), n.ElementWriter.create();
                    case 51:
                      return (y = t.sent), e.formBegin(), y.beginOnObj(h, !0), (t.next = 56), r(e, y, i);
                    case 56:
                      y.end(), e.end();
                    case 58:
                      return t.abrupt('break', 60);
                    case 59:
                      o.writeElement(a);
                    case 60:
                      return (t.next = 62), e.next();
                    case 62:
                      (a = t.sent), (t.next = 14);
                      break;
                    case 65:
                      return (t.next = 67), n.endDeallocateStack();
                    case 67:
                    case 'end':
                      return t.stop();
                  }
        ...
        var i = (function() {
          var t = e(
            regeneratorRuntime.mark(function t() {
              var e, o, i, u, c, f, a, s, l, h, p, v;
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return console.log('Beginning Test'), (e = 0), '../TestFiles/', (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                    case 5:
                      return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDF document initialized and locked'), (t.next = 11), n.ElementWriter.create();
                    case 11:
                      return (i = t.sent), (t.next = 14), n.ElementReader.create();
                    case 14:
                      return (u = t.sent), (c = []), (t.next = 18), o.getPageCount();
                    case 18:
                      return (f = t.sent), (t.next = 21), o.getPageIterator(1);
                    case 21:
                      a = t.sent;
                    case 23:
                      return (t.next = 25), a.hasNext();
                    case 25:
                      if (!t.sent) {
                        t.next = 49;
                        break;
                      }
                      return (t.next = 28), a.current();
                    case 28:
                      return (s = t.sent), (t.next = 31), s.getIndex();
                    case 31:
                      return (l = t.sent), console.log('Processing elements on page ' + l + '/' + f), (t.next = 35), s.getSDFObj();
                    case 35:
                      return (h = t.sent), (t.next = 38), h.getObjNum();
                    case 38:
                      return (p = t.sent), c.includes(p) || c.push(p), u.beginOnPage(s), i.beginOnPage(s, n.ElementWriter.WriteMode.e_replacement, !1), (t.next = 44), r(u, i, c);
                    case 44:
                      i.end(), u.end();
                    case 46:
                      a.next(), (t.next = 23);
                      break;
                    case 49:
                      return (t.next = 51), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                    case 51:
                      return (v = t.sent), saveBufferAsPDFDoc(v, 'newsletter_edited.pdf'), console.log('Done.'), t.abrupt('return', e);
                    case 55:
                    case 'end':
                      return t.stop();
                  }
