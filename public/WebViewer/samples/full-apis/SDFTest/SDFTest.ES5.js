!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ft(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: g ? P : S('keys'), entries: M }), d)) for (b in m) b in F || i(F, b, m[b]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = F(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), F = a(s(u(b.index), h.length), 0), O = [], P = 1; P < b.length; P++) O.push(void 0 === (x = b[P]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [E].concat(O, F, h);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = y(E, h, F, O, M, n);
            F >= w && ((S += h.slice(w, F) + I), (w = F + E.length));
          }
          return S + h.slice(w);
        },
      ];
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, g);
                ...
                for (var F = 1; F <= E.length - 1; F++) if ((w.push(E[F]), w.length === b)) return w;
                S = x = _;
              }
            }
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runSDFTest = function() {
        var n = t.Core.PDFNet,
          e = (function() {
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v, y, g;
                  return regeneratorRuntime.wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return console.log('Beginning SDF Test.'), (r = '../TestFiles/'), (t.prev = 2), (t.next = 5), n.PDFDoc.createFromURL(r + 'fish.pdf');
                          case 5:
                            return (e = t.sent), (t.next = 8), e.getSDFDoc();
                          case 8:
                            return (
                              (o = t.sent).initSecurityHandler(), o.lock(), console.log('Modifying into dictionary, adding custom properties, embedding a stream...'), (t.next = 14), o.getTrailer()
                            );
                          case 14:
                            return (i = t.sent), (t.next = 17), i.find('Info');
                          case 17:
                            return (u = t.sent), (t.next = 20), u.hasNext();
                          case 20:
                            if (!t.sent) {
                              t.next = 43;
                              break;
                            }
                            return (t.next = 23), u.value();
                          case 23:
                            return (c = t.sent).putString('Producer', 'PDFTron PDFNet'), (t.next = 27), c.find('Author');
                          case 27:
                            return (u = t.sent), (t.next = 30), u.hasNext();
                          case 30:
                            if (!t.sent) {
                              t.next = 40;
                              break;
                            }
                            return (t.next = 33), u.value();
                          case 33:
                            return (f = t.sent), (t.next = 36), f.getAsPDFText();
                          case 36:
                            (a = t.sent), c.putText('Author', a + ' - Modified'), (t.next = 41);
                            break;
                          case 40:
                            c.putString('Author', 'Me, myself, and I');
                          case 41:
                            t.next = 48;
                            break;
                          case 43:
                            return (t.next = 45), i.putDict('Info');
                          case 45:
                            (c = t.sent).putString('Producer', 'PDFTron PDFNet'), c.putString('Title', 'My document');
                          case 48:
                            return (t.next = 50), c.putDict('My Direct Dict');
                          case 50:
                            return (s = t.sent).putNumber('My Number', 100), s.putArray('My Array'), (t.next = 55), o.createIndirectArray();
                          case 55:
                            return (l = t.sent), c.put('My Indirect Array', l), (t.next = 59), i.get('Root');
                          case 59:
                            return (h = t.sent), (t.t0 = l), (t.next = 63), h.value();
                          case 63:
                            return (t.t1 = t.sent), t.t0.pushBack.call(t.t0, t.t1), (t.next = 67), n.Filter.createURLFilter(r + 'my_stream.txt');
                          case 67:
                            return (p = t.sent), (t.next = 70), n.FilterReader.create(p);
                          case 70:
                            return (v = t.sent), (t.next = 73), o.createIndirectStreamFromFilter(v);
                          case 73:
                            return (y = t.sent), l.pushBack(y), (t.next = 77), o.saveMemory(0, '%PDF-1.4');
                          case 77:
                            (g = t.sent), saveBufferAsPDFDoc(g, 'sdftest_out.pdf'), console.log('Done.'), (t.next = 85);
                            break;
                          case 82:
                            (t.prev = 82), (t.t2 = t.catch(2)), console.log(t.t2);
                          case 85:
                          case 'end':
                            return t.stop();
                        }
