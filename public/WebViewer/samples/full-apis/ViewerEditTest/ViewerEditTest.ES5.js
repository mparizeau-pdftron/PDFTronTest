      ...
      window.addEventListener('documentLoaded', function() {
        o.initialize().then(function() {
          instance.Core.documentViewer
            ...
            .getPDFDoc()
            .then(function(t) {
              instance.UI.setHeaderItems(function(n) {
                return (
                  n.push({
                    ...
                    states: {
                                        ...
                                        for (;;)
                                          switch ((r.prev = r.next)) {
                                            ...
                                            case 39:
                                              u.end(),
                                                c.end(),
                                                console.log('page ' + s + ' finished editing'),
                                                instance.Core.documentViewer.refreshPage(s),
                                                instance.Core.documentViewer.updateView([s]),
                                                s++,
                                                (r.next = 16);
                                              break;
                                            case 47:
                      ...
                      disabled: { img: i('lightgray'), onClick: function() {}, className: 'disabled' },
                    },
                    mount: function() {},
                  }),
                  n
