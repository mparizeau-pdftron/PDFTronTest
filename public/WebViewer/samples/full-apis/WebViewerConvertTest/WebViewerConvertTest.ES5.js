!(function(t) {
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runWebViewerConvertTest = function() {
        var n = t.Core.PDFNet,
          e = (function() {
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, f, a, s, l, h, p, v;
                  return regeneratorRuntime.wrap(
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return console.log('Beginning Test'), (r = 0), (t.prev = 3), (t.next = 6), n.PDFDoc.createFromURL('../TestFiles/tiger.pdf');
                          case 6:
                            return (e = t.sent).initSecurityHandler(), e.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 12), e.convertToXod();
                          case 12:
                            return (o = t.sent), saveBufferAsXOD(o, 'from_pdf.xod'), (t.next = 16), e.convertToXodStream();
                          case 16:
                            return (i = t.sent), (t.next = 19), n.FilterReader.create(i);
                          case 19:
                            (u = t.sent), (c = []), (a = f = 1024);
                          case 23:
                            if (f !== a) {
                            ...
                            return (t.next = 26), u.read(f);
                          case 26:
                            (s = t.sent), (a = s.length), c.push(s), (t.next = 23);
                            break;
                          case 31:
                            for (l = new Uint8Array(c.length * f + a), h = 0; h < c.length; h++) (p = h * f), (v = c[h]), l.set(v, p);
                            saveBufferAsXOD(l, 'from_pdf_streamed.xod'), console.log('done.'), (t.next = 41);
                            break;
                          case 37:
                            (t.prev = 37), (t.t0 = t.catch(3)), console.log(t.t0.stack), (r = 1);
                          case 41:
