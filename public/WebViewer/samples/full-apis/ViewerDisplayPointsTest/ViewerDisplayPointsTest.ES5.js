!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Vt = function(t, n) {
          return Wt(t, (n = x(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Bt = function(t, n, r) {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: Lt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        (A && (b = s(A.call(new t()))) !== Object.prototype && b.next && (f(b, w, !0), e || 'function' == typeof b[l] || u(b, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
  ...
  function(t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = O(t)) != t || t === E
          ...
          : ((e = F(A(t) / j)),
            t * (i = M(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + f >= 1 ? s / i : s * M(2, 1 - f)) * i >= 2 && (e++, (i /= 2)),
            e + f >= a ? ((o = 0), (e = a)) : e + f >= 1 ? ((o = (t * i - 1) * M(2, n)), (e += f)) : ((o = t * M(2, f - 1) * M(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function z(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[k]) throw _(x);
      for (var c = t[I]._b, a = u + t[T], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < m.length; _++) {
            x = m[_];
            for (var E = String(x[0]), P = f(s(u(x.index), h.length), 0), O = [], M = 1; M < x.length; M++) O.push(void 0 === (b = x[M]) ? b : String(b));
            var F = x.groups;
            if (p) {
              var A = [E].concat(O, P, h);
              void 0 !== F && A.push(F);
              var j = String(n.apply(void 0, A));
            } else j = y(E, h, P, O, F, n);
            P >= w && ((S += h.slice(w, P) + j), (w = P + E.length));
          }
          return S + h.slice(w);
        },
      ];
        ...
        i.initialize().then(function() {
          ...
          r.getPDFDoc().then(function(a) {
            ...
            var f = function(o) {
              if (!t) {
                t = !0;
                var f = instance.Core.documentViewer.getAnnotationManager();
                if (c.length > 0) {
                              ...
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (u = h.getViewerCoordinates(n, r, e)),
                                        (a = h.getViewerCoordinates(n, o, i)),
                                        (l = new f.RectangleAnnotation()).setPageNumber(n),
                                        l.setRect(new Core.Math.Rect(u.x, Math.min(u.y, a.y), a.x, Math.max(u.y, a.y))),
                                        s.addAnnotation(l),
                                        c.push(l);
                                    case 7:
                                    case 'end':
                            ...
                            regeneratorRuntime.mark(function t(n, r, e) {
                              ...
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (o = h.getViewerCoordinates(n, r, e)),
                                        (i = h.getViewerCoordinates(n, r, e)),
                                        (o.x -= 2),
                                        (o.y -= 2),
                                        (i.x += 2),
                                        (i.y += 2),
                                        ...
                                        u.setRect(new Core.Math.Rect(o.x, Math.min(o.y, i.y), i.x, Math.max(o.y, i.y))),
                                        s.addAnnotation(u),
                                        c.push(u);
                                    case 13:
                                    case 'end':
                        ...
                        y = (function() {
                          var t = e(
                            regeneratorRuntime.mark(function t(n, r, e, o) {
                              var u, c, a, f, l, h, p, y, g, d, m, x, b, S, w, _, E;
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                    ...
                                    case 3:
                                      ...
                                      break;
                                    case 22:
                                      return (a = r[u]), (f = r[++u]), ++u, (t.next = 28), e.mult(a, f);
                                    case 28:
                                      return (b = t.sent), (t.next = 31), v(o, b.x, b.y);
                                    case 31:
                                      return t.abrupt('break', 97);
                                    case 32:
                                      return (a = r[u]), (f = r[++u]), ++u, (t.next = 38), e.mult(a, f);
                                    case 38:
                                      return (b = t.sent), (t.next = 41), v(o, b.x, b.y);
                                    case 41:
                                      return t.abrupt('break', 97);
                                    case 42:
                                      return (a = r[u]), (f = r[++u]), (l = r[++u]), (h = r[++u]), (p = r[++u]), (y = r[++u]), ++u, (t.next = 56), e.mult(p, y);
                                    case 56:
                                      return (b = t.sent), (t.next = 59), v(o, b.x, b.y);
                                    case 59:
                                      return t.abrupt('break', 97);
                                    case 60:
                                      return (a = r[u]), (f = r[++u]), (m = r[++u]), (x = r[++u]), ++u, (h = f), (p = l = a + m), (g = a), (d = y = f + x), (t.next = 76), e.mult(a, f);
                                    case 76:
                                      return (S = t.sent), (t.next = 79), e.mult(l, h);
                                    case 79:
                                      return (w = t.sent), (t.next = 82), e.mult(p, y);
                                    case 82:
                                ...
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 10:
                                      ...
                                      if (((l = n[s]), !((h = l.bbox).x1 < f.x && h.x2 > f.x && h.y1 < f.y && h.y2 > f.y))) {
                                        t.next = 17;
                                        break;
                                      }
                                    ...
                                    case 18:
                                      return (t.next = 20), p(i, h.x1, h.y1, h.x2, h.y2);
                                    case 20:
                                      if ('path' !== l.name) {
                                        t.next = 23;
                                        break;
                              ...
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    ...
                                    case 41:
                                      return (h = t.sent), (t.next = 44), h.getObjNum();
                                    case 44:
                                      return (p = t.sent), (a = { name: 'image', type: u, num: p, ctm: o, bbox: c }), r.push(a), t.abrupt('break', 56);
                                    case 48:
                                    ...
                                    switch ((e.prev = e.next)) {
                                      case 0:
                                        return (
                                          ...
                                          (s = h.getPDFCoordinates(o, f.x, f.y)),
                                          (e.next = 9),
                                          i.ElementReader.create()
                                        );
                                      case 9:
                                        return (p = e.sent), (e.next = 12), i.ElementBuilder.create();
                                      case 12:
                                      ...
                                      case 26:
                                        return (y = e.sent), (b = new i.OCGContext(n)), p.beginOnPage(y, b), (e.next = 31), d(p);
                                      case 31:
                                        (x = e.sent), (u[o] = x), p.end();
                                      case 34:
